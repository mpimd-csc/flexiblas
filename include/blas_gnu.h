...
float complex cdotc_(blasint* n, float complex* cx, blasint* incx, float complex* cy, blasint* incy);
float complex cdotc32_(int32_t* n, float complex* cx, int32_t* incx, float complex* cy, int32_t* incy);
float complex cdotc64_(int64_t* n, float complex* cx, int64_t* incx, float complex* cy, int64_t* incy);

float complex cdotu_(blasint* n, float complex* cx, blasint* incx, float complex* cy, blasint* incy);
float complex cdotu32_(int32_t* n, float complex* cx, int32_t* incx, float complex* cy, int32_t* incy);
float complex cdotu64_(int64_t* n, float complex* cx, int64_t* incx, float complex* cy, int64_t* incy);
...
double complex zdotc_(blasint* n, double complex* zx, blasint* incx, double complex* zy, blasint* incy);
double complex zdotc32_(int32_t* n, double complex* zx, int32_t* incx, double complex* zy, int32_t* incy);
double complex zdotc64_(int64_t* n, double complex* zx, int64_t* incx, double complex* zy, int64_t* incy);

double complex zdotu_(blasint* n, double complex* zx, blasint* incx, double complex* zy, blasint* incy);
double complex zdotu32_(int32_t* n, double complex* zx, int32_t* incx, double complex* zy, int32_t* incy);
double complex zdotu64_(int64_t* n, double complex* zx, int64_t* incx, double complex* zy, int64_t* incy);
