...
*     .. Local Arrays ..
     ...
     $                   RESULT( 500 ), RWORK( LWORK ), S( NMAX*NMAX )
      ...
      COMPLEX*16, DIMENSION(:,:), ALLOCATABLE  :: A, B, C, DC
*      COMPLEX*16        A( NMAX*NMAX, NEED ), B( NMAX*NMAX, 5 ),
*      COMPLEX*16         C( NCMAX*NCMAX, NCMAX*NCMAX ), DC( NMAX, 6 ),
      COMPLEX*16         TAUA( NMAX ), TAUB( NMAX ), WORK( LWORK ),
     $                   X( 5*NMAX )
*     ..
*     .. External Functions ..
      LOGICAL            LSAMEN
...
*
      ALLOCATE(A(1:NMAX*NMAX,1:NEED))
      ALLOCATE(B(1:NMAX*NMAX,1:5))
      ALLOCATE(C(1:NCMAX*NCMAX,1:NCMAX*NCMAX))
      ALLOCATE(DC(1:NMAX, 6)) 
