...
*
      ...
      ALLOCATE(A( NMAX*NMAX, NEED ), B( NMAX*NMAX, 5 ))
      ALLOCATE(C( NCMAX*NCMAX, NCMAX*NCMAX ), DC( NMAX, 6 ))
      ALLOCATE(TAUA( NMAX ), TAUB( NMAX ), WORK( LWORK ))
      ALLOCATE(X( 5*NMAX ))
...
*
  ...
  380 CONTINUE
      ...
      DEALLOCATE(A,B,C,DC,TAUA,TAUB,WORK,X)
