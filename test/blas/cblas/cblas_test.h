...
#define FORTRAN_STRLEN flexiblas_fortran_charlen_t
...
#define F77_sgemmt      FC_GLOBAL(csgemmt,CSGEMMT)
#define F77_sgemmtr     FC_GLOBAL(csgemmtr,CSGEMMTR)
...
#define F77_dgemmt      FC_GLOBAL(cdgemmt,CDGEMMT)
#define F77_dgemmtr     FC_GLOBAL(cdgemmtr,CDGEMMTR)
...
#define F77_cgemmt      FC_GLOBAL(ccgemmt,CCGEMMT)
#define F77_cgemmtr     FC_GLOBAL(ccgemmtr,CCGEMMTR)
...
#define F77_zgemmt      FC_GLOBAL(czgemmt,CZGEMMT)
#define F77_zgemmtr     FC_GLOBAL(czgemmtr,CZGEMMTR)
