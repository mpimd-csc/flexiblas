SET(BLIS_PREFIX "Blis-PThread: ")
SET(BLIS_LIB_NAME PThread)

IF ( EXISTS /etc/debian_version )
    # We are on debian
    MESSAGE(STATUS "${BLIS_PREFIX} ${CMAKE_LIBRARY_ARCHITECTURE} ")
    SET(SEARCH_PATH /usr/lib/${CMAKE_LIBRARY_ARCHITECTURE}/blis-pthread /usr/lib/ /usr/lib64 /usr/local/lib /usr/local/lib64)
    SET(SEARCH_NAME blis)
ELSE()
    SET(SEARCH_PATH /usr/lib/ /usr/lib64 /usr/local/lib /usr/local/lib64)
    SET(SEARCH_NAME blisp blis)
ENDIF()
...
IF (Blis${BLIS_LIB_NAME}_LIBRARY)
    ...
    int main() { assert(bli_info_get_enable_pthreads() == 1 && bli_info_get_enable_openmp()==0)\; return 0\;}
    ")
