SET(BLIS_PREFIX "Blis-OpenMP: ")
SET(BLIS_LIB_NAME OpenMP)

IF ( EXISTS /etc/debian_version )
    # We are on debian
    MESSAGE(STATUS "${BLIS_PREFIX} ${CMAKE_LIBRARY_ARCHITECTURE} ")
    SET(SEARCH_PATH /usr/lib/${CMAKE_LIBRARY_ARCHITECTURE}/blis-openmp /usr/lib/ /usr/lib64 /usr/local/lib /usr/local/lib64)
    SET(SEARCH_NAME blis)
ELSE()
    SET(SEARCH_PATH /usr/lib/ /usr/lib64 /usr/local/lib /usr/local/lib64)
    SET(SEARCH_NAME bliso blis)
ENDIF()
...
IF (Blis${BLIS_LIB_NAME}_LIBRARY)
    ...
    int main() { assert(bli_info_get_enable_pthreads() == 0 && bli_info_get_enable_openmp()==1) \; return 0\;}
    ")
