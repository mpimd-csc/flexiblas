...
FIND_LIBRARY(MKL_FRONTEND_LIBRARY NAMES ${MKL_FRONTEND} HINTS ${SEARCH_PATH}   )
FIND_LIBRARY(MKL_MIDDLE_LIBRARY   NAMES ${MKL_MIDDLE} HINTS ${SEARCH_PATH}   )
FIND_LIBRARY(MKL_CORE_LIBRARY     NAMES ${MKL_CORE} HINTS ${SEARCH_PATH}   )

IF (NOT( MKL_FRONTEND_LIBRARY AND MKL_MIDDLE_LIBRARY AND MKL_CORE_LIBRARY ))
    RETURN()
ENDIF()
