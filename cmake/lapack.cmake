IF (LAPACK)
    SET(FLEXIBLAS_LAPACK TRUE)
    IF (LAPACKE)
        SET (FLEXIBLAS_LAPACKE TRUE)
    ENDIF()

    IF (NOT SYS_LAPACK_LIBRARY)
        IF(NOT LAPACK_API_VERSION)
            SET (LAPACK_API_VERSION "3.12.1")
        ENDIF()
    ELSE()
        IF ( NOT LAPACK_API_VERSION )
...
# LAPACK
#
IF ( LAPACK AND LAPACK_API_VERSION STREQUAL "3.12.1")
    SET ( FLEXIBLAS_LAPACK_3_12_1 TRUE)
    SET ( FLEXIBLAS_LAPACK_VERSION 3.12.1)
ENDIF ()

IF ( LAPACK AND LAPACK_API_VERSION STREQUAL "3.12.1-wodprc")
    SET ( FLEXIBLAS_LAPACK_3_12_1_WODPRC TRUE)
    SET ( FLEXIBLAS_LAPACK_VERSION 3.12.1)
ENDIF ()
...
IF ( LAPACK_API_VERSION VERSION_LESS 3.6.0 AND LAPACKE)
    MESSAGE(WARNING "LAPACKE requires LAPACK_API_VERSION >= 3.6.0")
    SET(LAPACKE OFF)
    SET(FLEXIBLAS_LAPACKE OFF)
ENDIF()
...
IF (LAPACK AND NOT SYS_LAPACK_LIBRARY)
    IF (FLEXIBLAS_LAPACK_3_12_1 OR FLEXIBLAS_LAPACK_3_12_1_WODPRC)
        add_subdirectory(contributed/lapack-3.12.1)
    ELSEIF (FLEXIBLAS_LAPACK_3_12_0 OR FLEXIBLAS_LAPACK_3_12_0_WODPRC)
...
IF (LAPACKE)
    ...
    IF (NOT SYS_LAPACKE_LIBRARY)
        IF ( FLEXIBLAS_LAPACK_3_12_1 OR FLEXIBLAS_LAPACK_3_12_1_WODPRC)
            add_subdirectory(contributed/lapacke-3.12.1/include)
            add_subdirectory(contributed/lapacke-3.12.1)
        ELSEIF ( FLEXIBLAS_LAPACK_3_12_0 OR FLEXIBLAS_LAPACK_3_12_0_WODPRC)
            add_subdirectory(contributed/lapacke-3.12.0/include)
            add_subdirectory(contributed/lapacke-3.12.0)
        ELSEIF ( FLEXIBLAS_LAPACK_3_11_0 OR FLEXIBLAS_LAPACK_3_11_0_WODPRC)
            add_subdirectory(contributed/lapacke-3.11.0/include)
            add_subdirectory(contributed/lapacke-3.11.0)
        ELSEIF ( FLEXIBLAS_LAPACK_3_10_1 OR FLEXIBLAS_LAPACK_3_10_1_WODPRC)
            add_subdirectory(contributed/lapacke-3.10.1/include)
            add_subdirectory(contributed/lapacke-3.10.1)
        ELSEIF ( FLEXIBLAS_LAPACK_3_10_0 OR FLEXIBLAS_LAPACK_3_10_0_WODPRC)
            add_subdirectory(contributed/lapacke-3.10.0/include)
            add_subdirectory(contributed/lapacke-3.10.0)
        ELSEIF ( FLEXIBLAS_LAPACK_3_9_1 OR FLEXIBLAS_LAPACK_3_9_1_WODPRC)
            add_subdirectory(contributed/lapacke-3.9.1/include)
            add_subdirectory(contributed/lapacke-3.9.1)
        ELSEIF ( FLEXIBLAS_LAPACK_3_9_0 OR FLEXIBLAS_LAPACK_3_9_0_WODPRC)
            add_subdirectory(contributed/lapacke-3.9.0/include)
            add_subdirectory(contributed/lapacke-3.9.0)
        ELSEIF ( FLEXIBLAS_LAPACK_3_8_0 OR FLEXIBLAS_LAPACK_3_8_0_WODPRC)
            add_subdirectory(contributed/lapacke-3.8.0/include)
            add_subdirectory(contributed/lapacke-3.8.0)
        ELSEIF ( FLEXIBLAS_LAPACK_3_7_0 OR FLEXIBLAS_LAPACK_3_7_0_WODPRC
                OR FLEXIBLAS_LAPACK_3_7_1 OR FLEXIBLAS_LAPACK_3_7_1_WODPRC )
            add_subdirectory(contributed/lapacke-3.7.0/include)
            add_subdirectory(contributed/lapacke-3.7.0)
        ELSEIF ( FLEXIBLAS_LAPACK_3_6_1 OR FLEXIBLAS_LAPACK_3_6_1_WODPRC)
            add_subdirectory(contributed/lapacke-3.6.1/include)
            add_subdirectory(contributed/lapacke-3.6.1)
        ELSEIF ( FLEXIBLAS_LAPACK_3_6_0 OR FLEXIBLAS_LAPACK_3_6_0_WODPRC)
            add_subdirectory(contributed/lapacke-3.6.0/include)
            add_subdirectory(contributed/lapacke-3.6.0)
        ELSE()
            add_subdirectory(contributed/lapacke-3.12.0/include)
            add_subdirectory(contributed/lapacke-3.12.0)
        ENDIF()
