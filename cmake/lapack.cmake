IF (LAPACK)
    ...
    ELSE()
        ...
        IF(LAPACK AND NOT FLEXIBLAS_LAPACK_VERSION )
            MESSAGE(FATAL_ERROR "No LAPACK API version specified. Use the LAPACK_API_VERSION varaiable.")
        ENDIF()

        IF (LAPACK AND NOT SYS_LAPACK_LIBRARY)
            IF (FLEXIBLAS_LAPACK_3_9_0 OR FLEXIBLAS_LAPACK_3_9_0_WODPRC)
