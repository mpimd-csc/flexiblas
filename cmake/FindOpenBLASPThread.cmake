...
SET(OPENBLAS_LIB_NAME PThread)
SET(OPENBLAS_GET_PARALLEL 1)

IF ( EXISTS /etc/debian_version )
    # We are on debian
    MESSAGE(STATUS "${OPENBLAS_PREFIX} ${CMAKE_LIBRARY_ARCHITECTURE} ")
    SET(SEARCH_PATH /usr/lib/${CMAKE_LIBRARY_ARCHITECTURE}/openblas-pthread)
    SET(SEARCH_NAME openblas)
ELSE()
    SET(SEARCH_PATH /usr/lib/ /usr/lib64)
    SET(SEARCH_NAME openblasp openblas)
ENDIF()

FIND_LIBRARY(OpenBLAS${OPENBLAS_LIB_NAME}_LIBRARY NAMES ${SEARCH_NAME} HINTS ${SEARCH_PATH} NO_CMAKE_PATH NO_CMAKE_ENVIRONMENT_PATH DOC "OpenBLAS-Serial Location")
