...
MACRO(CHECK_ADD_C_FLAG _FLAG OUTPUT)
    STRING(REPLACE "-" "_" _FLAGX ${_FLAG})
    CHECK_C_COMPILER_FLAG(${_FLAG} _TEST_C_${_FLAGX})
    SET(${OUTPUT} FALSE)
    SET(_TEST_C_${_FLAGX} "${_TEST_C_${_FLAGX}}" CACHE INTERNAL "${_FLAG} is available")
    IF(_TEST_C_${_FLAGX})
...
MACRO(CHECK_ADD_CXX_FLAG _FLAG OUTPUT)
    STRING(REPLACE "-" "_" _FLAGX ${_FLAG})
    CHECK_CXX_COMPILER_FLAG(${_FLAG} _TEST_CXX_${_FLAGX})
    SET(${OUTPUT} FALSE)
    IF(_TEST_CXX_${_FLAGX})
...
MACRO(CHECK_ADD_FORTRAN_FLAG _FLAG OUTPUT)
    STRING(REPLACE "-" "_" _FLAGX ${_FLAG})
    CHECK_FORTRAN_COMPILER_FLAG(${_FLAG} _TEST_Fortran_${_FLAGX})
    SET(${OUTPUT} FALSE)
    IF(_TEST_Fortran_${_FLAGX})
