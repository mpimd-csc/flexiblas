...
CONTAINS
    ...
    SUBROUTINE CSC_TABLE_SAVE_ASCII(FILENAME, TAB, COLSEP)
        ...
        RET = CSC_TABLE_SAVE_ASCII_C(FILENAME // C_NULL_CHAR, TAB, COLSEP // C_NULL_CHAR)
        RETURN
    ...
    SUBROUTINE CSC_TABLE_SAVE_LATEX(FILENAME, TAB, STANDALONE)
        ...
        RET = CSC_TABLE_SAVE_LATEX_C(FILENAME // C_NULL_CHAR, TAB, PASS_STANDALONE )
        RETURN
    ...
    SUBROUTINE CSC_TABLE_COMMENT_CMD(TAB)
        ...
        CALL CSC_TABLE_COMMENT_TEXT(TAB, "Commandline: " // TRIM(CMD))
