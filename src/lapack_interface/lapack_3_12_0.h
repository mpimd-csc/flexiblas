...
#define CGEDMD   cgedmd_
#define CGEDMDQ  cgedmdq_
...
#define CLAQP2RK claqp2rk_
#define CLAQP3RK claqp3rk_
...
#define DGEDMD   dgedmd_
#define DGEDMDQ  dgedmdq_
...
#define DLAQP2RK dlaqp2rk_
#define DLAQP3RK dlaqp3rk_
...
#define SGEDMD   sgedmd_
#define SGEDMDQ  sgedmdq_
...
#define SLAQP2RK slaqp2rk_
#define SLAQP3RK slaqp3rk_
...
#define ZGEDMD   zgedmd_
#define ZGEDMDQ  zgedmdq_
...
#define ZLAQP2RK zlaqp2rk_
#define ZLAQP3RK zlaqp3rk_
...
#define ZUPMTR   zupmtr_
    ...
    void FC_GLOBAL(cgees,CGEES)(char* jobvs, char* sort, blaslogical* select, blasint* n, lapack_complex_float* a, blasint* lda, blasint* sdim, lapack_complex_float* w, lapack_complex_float* vs, blasint* ldvs, lapack_complex_float* work, blasint* lwork, float* rwork, blaslogical* bwork, blasint* info, flexiblas_fortran_charlen_t len_jobvs, flexiblas_fortran_charlen_t len_sort);

    void FC_GLOBAL(cgeesx,CGEESX)(char* jobvs, char* sort, blaslogical* select, char* sense, blasint* n, lapack_complex_float* a, blasint* lda, blasint* sdim, lapack_complex_float* w, lapack_complex_float* vs, blasint* ldvs, float* rconde, float* rcondv, lapack_complex_float* work, blasint* lwork, float* rwork, blaslogical* bwork, blasint* info, flexiblas_fortran_charlen_t len_jobvs, flexiblas_fortran_charlen_t len_sort, flexiblas_fortran_charlen_t len_sense);
    ...
    void FC_GLOBAL(cgejsv,CGEJSV)(char* joba, char* jobu, char* jobv, char* jobr, char* jobt, char* jobp, blasint* m, blasint* n, lapack_complex_float* a, blasint* lda, float* sva, lapack_complex_float* u, blasint* ldu, lapack_complex_float* v, blasint* ldv, lapack_complex_float* cwork, blasint* lwork, float* rwork, blasint* lrwork, blasint* iwork, blasint* info, flexiblas_fortran_charlen_t len_joba, flexiblas_fortran_charlen_t len_jobu, flexiblas_fortran_charlen_t len_jobv, flexiblas_fortran_charlen_t len_jobr, flexiblas_fortran_charlen_t len_jobt, flexiblas_fortran_charlen_t len_jobp);
    ...
    void FC_GLOBAL(cgelqs,CGELQS)(blasint* m, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* tau, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info);
    ...
    void FC_GLOBAL(cgelst,CGELST)(char* trans, blasint* m, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_trans);
    ...
    void FC_GLOBAL(cgeqp3rk,CGEQP3RK)(blasint* m, blasint* n, blasint* nrhs, blasint* kmax, float* abstol, float* reltol, lapack_complex_float* a, blasint* lda, blasint* k, float* maxc2nrmk, float* relmaxc2nrmk, blasint* jpiv, lapack_complex_float* tau, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* iwork, blasint* info);
    ...
    void FC_GLOBAL(cgeqrs,CGEQRS)(blasint* m, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* tau, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info);
    ...
    void FC_GLOBAL(cgesvdq,CGESVDQ)(char* joba, char* jobp, char* jobr, char* jobu, char* jobv, blasint* m, blasint* n, lapack_complex_float* a, blasint* lda, float* s, lapack_complex_float* u, blasint* ldu, lapack_complex_float* v, blasint* ldv, blasint* numrank, blasint* iwork, blasint* liwork, lapack_complex_float* cwork, blasint* lcwork, float* rwork, blasint* lrwork, blasint* info, flexiblas_fortran_charlen_t len_joba, flexiblas_fortran_charlen_t len_jobp, flexiblas_fortran_charlen_t len_jobr, flexiblas_fortran_charlen_t len_jobu, flexiblas_fortran_charlen_t len_jobv);

    void FC_GLOBAL(cgesvdx,CGESVDX)(char* jobu, char* jobvt, char* range, blasint* m, blasint* n, lapack_complex_float* a, blasint* lda, float* vl, float* vu, blasint* il, blasint* iu, blasint* ns, float* s, lapack_complex_float* u, blasint* ldu, lapack_complex_float* vt, blasint* ldvt, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* iwork, blasint* info, flexiblas_fortran_charlen_t len_jobu, flexiblas_fortran_charlen_t len_jobvt, flexiblas_fortran_charlen_t len_range);

    void FC_GLOBAL(cgesvj,CGESVJ)(char* joba, char* jobu, char* jobv, blasint* m, blasint* n, lapack_complex_float* a, blasint* lda, float* sva, blasint* mv, lapack_complex_float* v, blasint* ldv, lapack_complex_float* cwork, blasint* lwork, float* rwork, blasint* lrwork, blasint* info, flexiblas_fortran_charlen_t len_joba, flexiblas_fortran_charlen_t len_jobu, flexiblas_fortran_charlen_t len_jobv);
    ...
    void FC_GLOBAL(cgetsls,CGETSLS)(char* trans, blasint* m, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_trans);

    void FC_GLOBAL(cgetsqrhrt,CGETSQRHRT)(blasint* m, blasint* n, blasint* mb1, blasint* nb1, blasint* nb2, lapack_complex_float* a, blasint* lda, lapack_complex_float* t, blasint* ldt, lapack_complex_float* work, blasint* lwork, blasint* info);
    ...
    void FC_GLOBAL(cggsvd3,CGGSVD3)(char* jobu, char* jobv, char* jobq, blasint* m, blasint* n, blasint* p, blasint* k, blasint* l, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, float* alpha, float* beta, lapack_complex_float* u, blasint* ldu, lapack_complex_float* v, blasint* ldv, lapack_complex_float* q, blasint* ldq, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* iwork, blasint* info, flexiblas_fortran_charlen_t len_jobu, flexiblas_fortran_charlen_t len_jobv, flexiblas_fortran_charlen_t len_jobq);
    ...
    void FC_GLOBAL(cggsvp3,CGGSVP3)(char* jobu, char* jobv, char* jobq, blasint* m, blasint* p, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, float* tola, float* tolb, blasint* k, blasint* l, lapack_complex_float* u, blasint* ldu, lapack_complex_float* v, blasint* ldv, lapack_complex_float* q, blasint* ldq, blasint* iwork, float* rwork, lapack_complex_float* tau, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_jobu, flexiblas_fortran_charlen_t len_jobv, flexiblas_fortran_charlen_t len_jobq);

    void FC_GLOBAL(cgsvj0,CGSVJ0)(char* jobv, blasint* m, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* d, float* sva, blasint* mv, lapack_complex_float* v, blasint* ldv, float* eps, float* sfmin, float* tol, blasint* nsweep, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_jobv);

    void FC_GLOBAL(cgsvj1,CGSVJ1)(char* jobv, blasint* m, blasint* n, blasint* n1, lapack_complex_float* a, blasint* lda, lapack_complex_float* d, float* sva, blasint* mv, lapack_complex_float* v, blasint* ldv, float* eps, float* sfmin, float* tol, blasint* nsweep, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_jobv);
    ...
    void FC_GLOBAL_(chb2st_kernels,CHB2ST_KERNELS)(char* uplo, blaslogical* wantz, blasint* ttype, blasint* st, blasint* ed, blasint* sweep, blasint* n, blasint* nb, blasint* ib, lapack_complex_float* a, blasint* lda, lapack_complex_float* v, lapack_complex_float* tau, blasint* ldvt, lapack_complex_float* work, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(chbev_2stage,CHBEV_2STAGE)(char* jobz, char* uplo, blasint* n, blasint* kd, lapack_complex_float* ab, blasint* ldab, float* w, lapack_complex_float* z, blasint* ldz, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(chbevd_2stage,CHBEVD_2STAGE)(char* jobz, char* uplo, blasint* n, blasint* kd, lapack_complex_float* ab, blasint* ldab, float* w, lapack_complex_float* z, blasint* ldz, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* lrwork, blasint* iwork, blasint* liwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(checon_3,CHECON_3)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, float* anorm, float* rcond, lapack_complex_float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(checon_rook,CHECON_ROOK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, blasint* ipiv, float* anorm, float* rcond, lapack_complex_float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(cheev_2stage,CHEEV_2STAGE)(char* jobz, char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, float* w, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(cheevd_2stage,CHEEVD_2STAGE)(char* jobz, char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, float* w, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* lrwork, blasint* iwork, blasint* liwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(cheevr_2stage,CHEEVR_2STAGE)(char* jobz, char* range, char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, float* vl, float* vu, blasint* il, blasint* iu, float* abstol, blasint* m, float* w, lapack_complex_float* z, blasint* ldz, blasint* isuppz, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* lrwork, blasint* iwork, blasint* liwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_range, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(cheevx_2stage,CHEEVX_2STAGE)(char* jobz, char* range, char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, float* vl, float* vu, blasint* il, blasint* iu, float* abstol, blasint* m, float* w, lapack_complex_float* z, blasint* ldz, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* iwork, blasint* ifail, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_range, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(chegv_2stage,CHEGV_2STAGE)(blasint* itype, char* jobz, char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, float* w, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(chesv_aa,CHESV_AA)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chesv_aa_2stage,CHESV_AA_2STAGE)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chesv_rk,CHESV_RK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chesv_rook,CHESV_ROOK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(chetf2_rk,CHETF2_RK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chetf2_rook,CHETF2_ROOK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(chetrd_2stage,CHETRD_2STAGE)(char* vect, char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, float* d, float* e, lapack_complex_float* tau, lapack_complex_float* hous2, blasint* lhous2, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_vect, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chetrd_hb2st,CHETRD_HB2ST)(char* stage1, char* vect, char* uplo, blasint* n, blasint* kd, lapack_complex_float* ab, blasint* ldab, float* d, float* e, lapack_complex_float* hous, blasint* lhous, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_stage1, flexiblas_fortran_charlen_t len_vect, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chetrd_he2hb,CHETRD_HE2HB)(char* uplo, blasint* n, blasint* kd, lapack_complex_float* a, blasint* lda, lapack_complex_float* ab, blasint* ldab, lapack_complex_float* tau, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(chetrf_aa,CHETRF_AA)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chetrf_aa_2stage,CHETRF_AA_2STAGE)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chetrf_rk,CHETRF_RK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chetrf_rook,CHETRF_ROOK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(chetri_3,CHETRI_3)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chetri_3x,CHETRI_3X)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* work, blasint* nb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chetri_rook,CHETRI_ROOK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(chetrs_3,CHETRS_3)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chetrs_aa,CHETRS_AA)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chetrs_aa_2stage,CHETRS_AA_2STAGE)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_float* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(chetrs_rook,CHETRS_ROOK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(clahef_aa,CLAHEF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* h, blasint* ldh, lapack_complex_float* work, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(clahef_rk,CLAHEF_RK)(char* uplo, blasint* n, blasint* nb, blasint* kb, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(clahef_rook,CLAHEF_ROOK)(char* uplo, blasint* n, blasint* nb, blasint* kb, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(claqp2rk,CLAQP2RK)(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* kmax, float* abstol, float* reltol, blasint* kp1, float* maxc2nrm, lapack_complex_float* a, blasint* lda, blasint* k, float* maxc2nrmk, float* relmaxc2nrmk, blasint* jpiv, lapack_complex_float* tau, float* vn1, float* vn2, lapack_complex_float* work, blasint* info);

    void FC_GLOBAL(claqp3rk,CLAQP3RK)(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* nb, float* abstol, float* reltol, blasint* kp1, float* maxc2nrm, lapack_complex_float* a, blasint* lda, blaslogical* done, blasint* kb, float* maxc2nrmk, float* relmaxc2nrmk, blasint* jpiv, lapack_complex_float* tau, float* vn1, float* vn2, lapack_complex_float* auxv, lapack_complex_float* f, blasint* ldf, blasint* iwork, blasint* info);
    ...
    void FC_GLOBAL(claqz0,CLAQZ0)(char* wants, char* wantq, char* wantz, blasint* n, blasint* ilo, blasint* ihi, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, lapack_complex_float* alpha, lapack_complex_float* beta, lapack_complex_float* q, blasint* ldq, lapack_complex_float* z, blasint* ldz, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* rec, blasint* info, flexiblas_fortran_charlen_t len_wants, flexiblas_fortran_charlen_t len_wantq, flexiblas_fortran_charlen_t len_wantz);

    void FC_GLOBAL(claqz1,CLAQZ1)(blaslogical* ilq, blaslogical* ilz, blasint* k, blasint* istartm, blasint* istopm, blasint* ihi, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, blasint* nq, blasint* qstart, lapack_complex_float* q, blasint* ldq, blasint* nz, blasint* zstart, lapack_complex_float* z, blasint* ldz);

    void FC_GLOBAL(claqz2,CLAQZ2)(blaslogical* ilschur, blaslogical* ilq, blaslogical* ilz, blasint* n, blasint* ilo, blasint* ihi, blasint* nw, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, lapack_complex_float* q, blasint* ldq, lapack_complex_float* z, blasint* ldz, blasint* ns, blasint* nd, lapack_complex_float* alpha, lapack_complex_float* beta, lapack_complex_float* qc, blasint* ldqc, lapack_complex_float* zc, blasint* ldzc, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* rec, blasint* info);

    void FC_GLOBAL(claqz3,CLAQZ3)(blaslogical* ilschur, blaslogical* ilq, blaslogical* ilz, blasint* n, blasint* ilo, blasint* ihi, blasint* nshifts, blasint* nblock_desired, lapack_complex_float* alpha, lapack_complex_float* beta, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, lapack_complex_float* q, blasint* ldq, lapack_complex_float* z, blasint* ldz, lapack_complex_float* qc, blasint* ldqc, lapack_complex_float* zc, blasint* ldzc, lapack_complex_float* work, blasint* lwork, blasint* info);
    ...
    void FC_GLOBAL_(clarfb_gett,CLARFB_GETT)(char* ident, blasint* m, blasint* n, blasint* k, lapack_complex_float* t, blasint* ldt, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* ldwork, flexiblas_fortran_charlen_t len_ident);
    ...
    void FC_GLOBAL(clarfy,CLARFY)(char* uplo, blasint* n, lapack_complex_float* v, blasint* incv, lapack_complex_float* tau, lapack_complex_float* c, blasint* ldc, lapack_complex_float* work, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(clartg,CLARTG)(lapack_complex_float* f, lapack_complex_float* g, float* c, lapack_complex_float* s, lapack_complex_float* r);
    ...
    void FC_GLOBAL_(clasyf_aa,CLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* h, blasint* ldh, lapack_complex_float* work, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(clasyf_rk,CLASYF_RK)(char* uplo, blasint* n, blasint* nb, blasint* kb, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(clasyf_rook,CLASYF_ROOK)(char* uplo, blasint* n, blasint* nb, blasint* kb, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(claunhr_col_getrfnp,CLAUNHR_COL_GETRFNP)(blasint* m, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* d, blasint* info);

    void FC_GLOBAL_(claunhr_col_getrfnp2,CLAUNHR_COL_GETRFNP2)(blasint* m, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* d, blasint* info);
    ...
    void FC_GLOBAL(cpotrf2,CPOTRF2)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(crscl,CRSCL)(blasint* n, lapack_complex_float* a, lapack_complex_float* x, blasint* incx);
    ...
    void FC_GLOBAL_(csycon_3,CSYCON_3)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, float* anorm, float* rcond, lapack_complex_float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csycon_rook,CSYCON_ROOK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, blasint* ipiv, float* anorm, float* rcond, lapack_complex_float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL(csyconv,CSYCONV)(char* uplo, char* way, blasint* n, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* e, blasint* info, flexiblas_fortran_charlen_t len_uplo, flexiblas_fortran_charlen_t len_way);

    void FC_GLOBAL(csyconvf,CSYCONVF)(char* uplo, char* way, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo, flexiblas_fortran_charlen_t len_way);

    void FC_GLOBAL_(csyconvf_rook,CSYCONVF_ROOK)(char* uplo, char* way, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo, flexiblas_fortran_charlen_t len_way);
    ...
    void FC_GLOBAL_(csysv_aa,CSYSV_AA)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csysv_aa_2stage,CSYSV_AA_2STAGE)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csysv_rk,CSYSV_RK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csysv_rook,CSYSV_ROOK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(csytf2_rk,CSYTF2_RK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csytf2_rook,CSYTF2_ROOK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(csytrf_aa,CSYTRF_AA)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csytrf_aa_2stage,CSYTRF_AA_2STAGE)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csytrf_rk,CSYTRF_RK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csytrf_rook,CSYTRF_ROOK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(csytri_3,CSYTRI_3)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csytri_3x,CSYTRI_3X)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* work, blasint* nb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csytri_rook,CSYTRI_ROOK)(char* uplo, blasint* n, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(csytrs_3,CSYTRS_3)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* e, blasint* ipiv, lapack_complex_float* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csytrs_aa,CSYTRS_AA)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* b, blasint* ldb, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csytrs_aa_2stage,CSYTRS_AA_2STAGE)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, lapack_complex_float* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_float* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(csytrs_rook,CSYTRS_ROOK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(ctgsna,CTGSNA)(char* job, char* howmny, blaslogical* select, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, lapack_complex_float* vl, blasint* ldvl, lapack_complex_float* vr, blasint* ldvr, float* s, float* dif, blasint* mm, blasint* m, lapack_complex_float* work, blasint* lwork, blasint* iwork, blasint* info, flexiblas_fortran_charlen_t len_job, flexiblas_fortran_charlen_t len_howmny);
    ...
    void FC_GLOBAL(ctrevc3,CTREVC3)(char* side, char* howmny, blaslogical* select, blasint* n, lapack_complex_float* t, blasint* ldt, lapack_complex_float* vl, blasint* ldvl, lapack_complex_float* vr, blasint* ldvr, blasint* mm, blasint* m, lapack_complex_float* work, blasint* lwork, float* rwork, blasint* lrwork, blasint* info, flexiblas_fortran_charlen_t len_side, flexiblas_fortran_charlen_t len_howmny);
    ...
    void FC_GLOBAL(ctrsyl3,CTRSYL3)(char* trana, char* tranb, blasint* isgn, blasint* m, blasint* n, lapack_complex_float* a, blasint* lda, lapack_complex_float* b, blasint* ldb, lapack_complex_float* c, blasint* ldc, float* scale, float* swork, blasint* ldswork, blasint* info, flexiblas_fortran_charlen_t len_trana, flexiblas_fortran_charlen_t len_tranb);
    ...
    void FC_GLOBAL(cungtsqr,CUNGTSQR)(blasint* m, blasint* n, blasint* mb, blasint* nb, lapack_complex_float* a, blasint* lda, lapack_complex_float* t, blasint* ldt, lapack_complex_float* work, blasint* lwork, blasint* info);

    void FC_GLOBAL_(cungtsqr_row,CUNGTSQR_ROW)(blasint* m, blasint* n, blasint* mb, blasint* nb, lapack_complex_float* a, blasint* lda, lapack_complex_float* t, blasint* ldt, lapack_complex_float* work, blasint* lwork, blasint* info);

    void FC_GLOBAL_(cunhr_col,CUNHR_COL)(blasint* m, blasint* n, blasint* nb, lapack_complex_float* a, blasint* lda, lapack_complex_float* t, blasint* ldt, lapack_complex_float* d, blasint* info);

    void FC_GLOBAL(cunm22,CUNM22)(char* side, char* trans, blasint* m, blasint* n, blasint* n1, blasint* n2, lapack_complex_float* q, blasint* ldq, lapack_complex_float* c, blasint* ldc, lapack_complex_float* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_side, flexiblas_fortran_charlen_t len_trans);
    ...
    void FC_GLOBAL(dgeesx,DGEESX)(char* jobvs, char* sort, blaslogical* select, char* sense, blasint* n, double* a, blasint* lda, blasint* sdim, double* wr, double* wi, double* vs, blasint* ldvs, double* rconde, double* rcondv, double* work, blasint* lwork, blasint* iwork, blasint* liwork, blaslogical* bwork, blasint* info, flexiblas_fortran_charlen_t len_jobvs, flexiblas_fortran_charlen_t len_sort, flexiblas_fortran_charlen_t len_sense);
    ...
    void FC_GLOBAL(dgemlq,DGEMLQ)(char* side, char* trans, blasint* m, blasint* n, blasint* k, double* a, blasint* lda, double* t, blasint* tsize, double* c, blasint* ldc, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_side, flexiblas_fortran_charlen_t len_trans);

    void FC_GLOBAL(dgemlqt,DGEMLQT)(char* side, char* trans, blasint* m, blasint* n, blasint* k, blasint* mb, double* v, blasint* ldv, double* t, blasint* ldt, double* c, blasint* ldc, double* work, blasint* info, flexiblas_fortran_charlen_t len_side, flexiblas_fortran_charlen_t len_trans);
    ...
    void FC_GLOBAL(dggev3,DGGEV3)(char* jobvl, char* jobvr, blasint* n, double* a, blasint* lda, double* b, blasint* ldb, double* alphar, double* alphai, double* beta, double* vl, blasint* ldvl, double* vr, blasint* ldvr, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_jobvl, flexiblas_fortran_charlen_t len_jobvr);
    ...
    void FC_GLOBAL(dggsvd3,DGGSVD3)(char* jobu, char* jobv, char* jobq, blasint* m, blasint* n, blasint* p, blasint* k, blasint* l, double* a, blasint* lda, double* b, blasint* ldb, double* alpha, double* beta, double* u, blasint* ldu, double* v, blasint* ldv, double* q, blasint* ldq, double* work, blasint* lwork, blasint* iwork, blasint* info, flexiblas_fortran_charlen_t len_jobu, flexiblas_fortran_charlen_t len_jobv, flexiblas_fortran_charlen_t len_jobq);
    ...
    void FC_GLOBAL(dlamtsqr,DLAMTSQR)(char* side, char* trans, blasint* m, blasint* n, blasint* k, blasint* mb, blasint* nb, double* a, blasint* lda, double* t, blasint* ldt, double* c, blasint* ldc, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_side, flexiblas_fortran_charlen_t len_trans);
    ...
    void FC_GLOBAL(dlaqp3rk,DLAQP3RK)(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* nb, double* abstol, double* reltol, blasint* kp1, double* maxc2nrm, double* a, blasint* lda, blaslogical* done, blasint* kb, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, double* tau, double* vn1, double* vn2, double* auxv, double* f, blasint* ldf, blasint* iwork, blasint* info);
    ...
    void FC_GLOBAL_(dlarfb_gett,DLARFB_GETT)(char* ident, blasint* m, blasint* n, blasint* k, double* t, blasint* ldt, double* a, blasint* lda, double* b, blasint* ldb, double* work, blasint* ldwork, flexiblas_fortran_charlen_t len_ident);
    ...
    void FC_GLOBAL_(dlasyf_aa,DLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, double* a, blasint* lda, blasint* ipiv, double* h, blasint* ldh, double* work, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(dlasyf_rk,DLASYF_RK)(char* uplo, blasint* n, blasint* nb, blasint* kb, double* a, blasint* lda, double* e, blasint* ipiv, double* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(dlasyf_rook,DLASYF_ROOK)(char* uplo, blasint* n, blasint* nb, blasint* kb, double* a, blasint* lda, blasint* ipiv, double* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(dlatrs3,DLATRS3)(char* uplo, char* trans, char* diag, char* normin, blasint* n, blasint* nrhs, double* a, blasint* lda, double* x, blasint* ldx, double* scale, double* cnorm, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo, flexiblas_fortran_charlen_t len_trans, flexiblas_fortran_charlen_t len_diag, flexiblas_fortran_charlen_t len_normin);
    ...
    void FC_GLOBAL(dorm22,DORM22)(char* side, char* trans, blasint* m, blasint* n, blasint* n1, blasint* n2, double* q, blasint* ldq, double* c, blasint* ldc, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_side, flexiblas_fortran_charlen_t len_trans);
    ...
    void FC_GLOBAL(dpotrf2,DPOTRF2)(char* uplo, blasint* n, double* a, blasint* lda, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsb2st_kernels,DSB2ST_KERNELS)(char* uplo, blaslogical* wantz, blasint* ttype, blasint* st, blasint* ed, blasint* sweep, blasint* n, blasint* nb, blasint* ib, double* a, blasint* lda, double* v, double* tau, blasint* ldvt, double* work, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsbevd_2stage,DSBEVD_2STAGE)(char* jobz, char* uplo, blasint* n, blasint* kd, double* ab, blasint* ldab, double* w, double* z, blasint* ldz, double* work, blasint* lwork, blasint* iwork, blasint* liwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsycon_rook,DSYCON_ROOK)(char* uplo, blasint* n, double* a, blasint* lda, blasint* ipiv, double* anorm, double* rcond, double* work, blasint* iwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsyevd_2stage,DSYEVD_2STAGE)(char* jobz, char* uplo, blasint* n, double* a, blasint* lda, double* w, double* work, blasint* lwork, blasint* iwork, blasint* liwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsyevr_2stage,DSYEVR_2STAGE)(char* jobz, char* range, char* uplo, blasint* n, double* a, blasint* lda, double* vl, double* vu, blasint* il, blasint* iu, double* abstol, blasint* m, double* w, double* z, blasint* ldz, blasint* isuppz, double* work, blasint* lwork, blasint* iwork, blasint* liwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_range, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL(dsyevx,DSYEVX)(char* jobz, char* range, char* uplo, blasint* n, double* a, blasint* lda, double* vl, double* vu, blasint* il, blasint* iu, double* abstol, blasint* m, double* w, double* z, blasint* ldz, double* work, blasint* lwork, blasint* iwork, blasint* ifail, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_range, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(dsyevx_2stage,DSYEVX_2STAGE)(char* jobz, char* range, char* uplo, blasint* n, double* a, blasint* lda, double* vl, double* vu, blasint* il, blasint* iu, double* abstol, blasint* m, double* w, double* z, blasint* ldz, double* work, blasint* lwork, blasint* iwork, blasint* ifail, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_range, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsygv_2stage,DSYGV_2STAGE)(blasint* itype, char* jobz, char* uplo, blasint* n, double* a, blasint* lda, double* b, blasint* ldb, double* w, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsysv_aa,DSYSV_AA)(char* uplo, blasint* n, blasint* nrhs, double* a, blasint* lda, blasint* ipiv, double* b, blasint* ldb, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(dsysv_aa_2stage,DSYSV_AA_2STAGE)(char* uplo, blasint* n, blasint* nrhs, double* a, blasint* lda, double* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, double* b, blasint* ldb, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(dsysv_rk,DSYSV_RK)(char* uplo, blasint* n, blasint* nrhs, double* a, blasint* lda, double* e, blasint* ipiv, double* b, blasint* ldb, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsytf2_rk,DSYTF2_RK)(char* uplo, blasint* n, double* a, blasint* lda, double* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(dsytf2_rook,DSYTF2_ROOK)(char* uplo, blasint* n, double* a, blasint* lda, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsytrf_rk,DSYTRF_RK)(char* uplo, blasint* n, double* a, blasint* lda, double* e, blasint* ipiv, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsytri_3,DSYTRI_3)(char* uplo, blasint* n, double* a, blasint* lda, double* e, blasint* ipiv, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(dsytri_3x,DSYTRI_3X)(char* uplo, blasint* n, double* a, blasint* lda, double* e, blasint* ipiv, double* work, blasint* nb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(dsytri_rook,DSYTRI_ROOK)(char* uplo, blasint* n, double* a, blasint* lda, blasint* ipiv, double* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsytrs_3,DSYTRS_3)(char* uplo, blasint* n, blasint* nrhs, double* a, blasint* lda, double* e, blasint* ipiv, double* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(dsytrs_aa,DSYTRS_AA)(char* uplo, blasint* n, blasint* nrhs, double* a, blasint* lda, blasint* ipiv, double* b, blasint* ldb, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dsytrs_rook,DSYTRS_ROOK)(char* uplo, blasint* n, blasint* nrhs, double* a, blasint* lda, blasint* ipiv, double* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(dtgevc,DTGEVC)(char* side, char* howmny, blaslogical* select, blasint* n, double* s, blasint* lds, double* p, blasint* ldp, double* vl, blasint* ldvl, double* vr, blasint* ldvr, blasint* mm, blasint* m, double* work, blasint* info, flexiblas_fortran_charlen_t len_side, flexiblas_fortran_charlen_t len_howmny);
    ...
    void FC_GLOBAL(dtgsna,DTGSNA)(char* job, char* howmny, blaslogical* select, blasint* n, double* a, blasint* lda, double* b, blasint* ldb, double* vl, blasint* ldvl, double* vr, blasint* ldvr, double* s, double* dif, blasint* mm, blasint* m, double* work, blasint* lwork, blasint* iwork, blasint* info, flexiblas_fortran_charlen_t len_job, flexiblas_fortran_charlen_t len_howmny);
    ...
    void FC_GLOBAL(dtpmlqt,DTPMLQT)(char* side, char* trans, blasint* m, blasint* n, blasint* k, blasint* l, blasint* mb, double* v, blasint* ldv, double* t, blasint* ldt, double* a, blasint* lda, double* b, blasint* ldb, double* work, blasint* info, flexiblas_fortran_charlen_t len_side, flexiblas_fortran_charlen_t len_trans);
    ...
    void FC_GLOBAL(dtrevc3,DTREVC3)(char* side, char* howmny, blaslogical* select, blasint* n, double* t, blasint* ldt, double* vl, blasint* ldvl, double* vr, blasint* ldvr, blasint* mm, blasint* m, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_side, flexiblas_fortran_charlen_t len_howmny);
    ...
    void FC_GLOBAL(dtrsen,DTRSEN)(char* job, char* compq, blaslogical* select, blasint* n, double* t, blasint* ldt, double* q, blasint* ldq, double* wr, double* wi, blasint* m, double* s, double* sep, double* work, blasint* lwork, blasint* iwork, blasint* liwork, blasint* info, flexiblas_fortran_charlen_t len_job, flexiblas_fortran_charlen_t len_compq);

    void FC_GLOBAL(dtrsna,DTRSNA)(char* job, char* howmny, blaslogical* select, blasint* n, double* t, blasint* ldt, double* vl, blasint* ldvl, double* vr, blasint* ldvr, double* s, double* sep, blasint* mm, blasint* m, double* work, blasint* ldwork, blasint* iwork, blasint* info, flexiblas_fortran_charlen_t len_job, flexiblas_fortran_charlen_t len_howmny);
    ...
    void FC_GLOBAL(zgedmd,ZGEDMD)(char* jobs, char* jobz, char* jobr, char* jobf, blasint* whtsvd, blasint* m, blasint* n, lapack_complex_float* x, blasint* ldx, lapack_complex_float* y, blasint* ldy, blasint* nrnk, float* tol, blasint* k, lapack_complex_float* eigs, lapack_complex_float* z, blasint* ldz, float* res, lapack_complex_float* b, blasint* ldb, lapack_complex_float* w, blasint* ldw, lapack_complex_float* s, blasint* lds, lapack_complex_float* zwork, blasint* lzwork, float* rwork, blasint* lrwork, blasint* iwork, blasint* liwork, blasint* info, flexiblas_fortran_charlen_t len_jobs, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_jobr, flexiblas_fortran_charlen_t len_jobf);
    ...
    void FC_GLOBAL(zgelqs,ZGELQS)(blasint* m, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* tau, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info);
    ...
    void FC_GLOBAL(zgelst,ZGELST)(char* trans, blasint* m, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_trans);
    ...
    void FC_GLOBAL(zgeqp3rk,ZGEQP3RK)(blasint* m, blasint* n, blasint* nrhs, blasint* kmax, double* abstol, double* reltol, lapack_complex_double* a, blasint* lda, blasint* k, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, lapack_complex_double* tau, lapack_complex_double* work, blasint* lwork, double* rwork, blasint* iwork, blasint* info);
    ...
    void FC_GLOBAL(zgeqrs,ZGEQRS)(blasint* m, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* tau, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info);
    ...
    void FC_GLOBAL(zgesvdq,ZGESVDQ)(char* joba, char* jobp, char* jobr, char* jobu, char* jobv, blasint* m, blasint* n, lapack_complex_double* a, blasint* lda, double* s, lapack_complex_double* u, blasint* ldu, lapack_complex_double* v, blasint* ldv, blasint* numrank, blasint* iwork, blasint* liwork, lapack_complex_double* cwork, blasint* lcwork, double* rwork, blasint* lrwork, blasint* info, flexiblas_fortran_charlen_t len_joba, flexiblas_fortran_charlen_t len_jobp, flexiblas_fortran_charlen_t len_jobr, flexiblas_fortran_charlen_t len_jobu, flexiblas_fortran_charlen_t len_jobv);
    ...
    void FC_GLOBAL(zgetsls,ZGETSLS)(char* trans, blasint* m, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_trans);

    void FC_GLOBAL(zgetsqrhrt,ZGETSQRHRT)(blasint* m, blasint* n, blasint* mb1, blasint* nb1, blasint* nb2, lapack_complex_double* a, blasint* lda, lapack_complex_double* t, blasint* ldt, lapack_complex_double* work, blasint* lwork, blasint* info);
    ...
    void FC_GLOBAL(zggsvd3,ZGGSVD3)(char* jobu, char* jobv, char* jobq, blasint* m, blasint* n, blasint* p, blasint* k, blasint* l, lapack_complex_double* a, blasint* lda, lapack_complex_double* b, blasint* ldb, double* alpha, double* beta, lapack_complex_double* u, blasint* ldu, lapack_complex_double* v, blasint* ldv, lapack_complex_double* q, blasint* ldq, lapack_complex_double* work, blasint* lwork, double* rwork, blasint* iwork, blasint* info, flexiblas_fortran_charlen_t len_jobu, flexiblas_fortran_charlen_t len_jobv, flexiblas_fortran_charlen_t len_jobq);
    ...
    void FC_GLOBAL(zggsvp3,ZGGSVP3)(char* jobu, char* jobv, char* jobq, blasint* m, blasint* p, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* b, blasint* ldb, double* tola, double* tolb, blasint* k, blasint* l, lapack_complex_double* u, blasint* ldu, lapack_complex_double* v, blasint* ldv, lapack_complex_double* q, blasint* ldq, blasint* iwork, double* rwork, lapack_complex_double* tau, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_jobu, flexiblas_fortran_charlen_t len_jobv, flexiblas_fortran_charlen_t len_jobq);

    void FC_GLOBAL(zgsvj0,ZGSVJ0)(char* jobv, blasint* m, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* d, double* sva, blasint* mv, lapack_complex_double* v, blasint* ldv, double* eps, double* sfmin, double* tol, blasint* nsweep, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_jobv);

    void FC_GLOBAL(zgsvj1,ZGSVJ1)(char* jobv, blasint* m, blasint* n, blasint* n1, lapack_complex_double* a, blasint* lda, lapack_complex_double* d, double* sva, blasint* mv, lapack_complex_double* v, blasint* ldv, double* eps, double* sfmin, double* tol, blasint* nsweep, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_jobv);
    ...
    void FC_GLOBAL_(zhb2st_kernels,ZHB2ST_KERNELS)(char* uplo, blaslogical* wantz, blasint* ttype, blasint* st, blasint* ed, blasint* sweep, blasint* n, blasint* nb, blasint* ib, lapack_complex_double* a, blasint* lda, lapack_complex_double* v, lapack_complex_double* tau, blasint* ldvt, lapack_complex_double* work, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zhbevd_2stage,ZHBEVD_2STAGE)(char* jobz, char* uplo, blasint* n, blasint* kd, lapack_complex_double* ab, blasint* ldab, double* w, lapack_complex_double* z, blasint* ldz, lapack_complex_double* work, blasint* lwork, double* rwork, blasint* lrwork, blasint* iwork, blasint* liwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zhbevx_2stage,ZHBEVX_2STAGE)(char* jobz, char* range, char* uplo, blasint* n, blasint* kd, lapack_complex_double* ab, blasint* ldab, lapack_complex_double* q, blasint* ldq, double* vl, double* vu, blasint* il, blasint* iu, double* abstol, blasint* m, double* w, lapack_complex_double* z, blasint* ldz, lapack_complex_double* work, blasint* lwork, double* rwork, blasint* iwork, blasint* ifail, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_range, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zhecon_3,ZHECON_3)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, double* anorm, double* rcond, lapack_complex_double* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhecon_rook,ZHECON_ROOK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, blasint* ipiv, double* anorm, double* rcond, lapack_complex_double* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zheev_2stage,ZHEEV_2STAGE)(char* jobz, char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, double* w, lapack_complex_double* work, blasint* lwork, double* rwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zheevd_2stage,ZHEEVD_2STAGE)(char* jobz, char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, double* w, lapack_complex_double* work, blasint* lwork, double* rwork, blasint* lrwork, blasint* iwork, blasint* liwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zheevr_2stage,ZHEEVR_2STAGE)(char* jobz, char* range, char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, double* vl, double* vu, blasint* il, blasint* iu, double* abstol, blasint* m, double* w, lapack_complex_double* z, blasint* ldz, blasint* isuppz, lapack_complex_double* work, blasint* lwork, double* rwork, blasint* lrwork, blasint* iwork, blasint* liwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_range, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zheevx_2stage,ZHEEVX_2STAGE)(char* jobz, char* range, char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, double* vl, double* vu, blasint* il, blasint* iu, double* abstol, blasint* m, double* w, lapack_complex_double* z, blasint* ldz, lapack_complex_double* work, blasint* lwork, double* rwork, blasint* iwork, blasint* ifail, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_range, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zhegv_2stage,ZHEGV_2STAGE)(blasint* itype, char* jobz, char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* b, blasint* ldb, double* w, lapack_complex_double* work, blasint* lwork, double* rwork, blasint* info, flexiblas_fortran_charlen_t len_jobz, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zhesv_aa,ZHESV_AA)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhesv_aa_2stage,ZHESV_AA_2STAGE)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhesv_rk,ZHESV_RK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhesv_rook,ZHESV_ROOK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zhetf2_rk,ZHETF2_RK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhetf2_rook,ZHETF2_ROOK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zhetrd_2stage,ZHETRD_2STAGE)(char* vect, char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, double* d, double* e, lapack_complex_double* tau, lapack_complex_double* hous2, blasint* lhous2, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_vect, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhetrd_hb2st,ZHETRD_HB2ST)(char* stage1, char* vect, char* uplo, blasint* n, blasint* kd, lapack_complex_double* ab, blasint* ldab, double* d, double* e, lapack_complex_double* hous, blasint* lhous, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_stage1, flexiblas_fortran_charlen_t len_vect, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhetrd_he2hb,ZHETRD_HE2HB)(char* uplo, blasint* n, blasint* kd, lapack_complex_double* a, blasint* lda, lapack_complex_double* ab, blasint* ldab, lapack_complex_double* tau, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zhetrf_aa,ZHETRF_AA)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhetrf_aa_2stage,ZHETRF_AA_2STAGE)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhetrf_rk,ZHETRF_RK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhetrf_rook,ZHETRF_ROOK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zhetri_3,ZHETRI_3)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhetri_3x,ZHETRI_3X)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* work, blasint* nb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhetri_rook,ZHETRI_ROOK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zhetrs_3,ZHETRS_3)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhetrs_aa,ZHETRS_AA)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhetrs_aa_2stage,ZHETRS_AA_2STAGE)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_double* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zhetrs_rook,ZHETRS_ROOK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zlahef_aa,ZLAHEF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* h, blasint* ldh, lapack_complex_double* work, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zlahef_rk,ZLAHEF_RK)(char* uplo, blasint* n, blasint* nb, blasint* kb, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zlahef_rook,ZLAHEF_ROOK)(char* uplo, blasint* n, blasint* nb, blasint* kb, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(zlaqp2rk,ZLAQP2RK)(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* kmax, double* abstol, double* reltol, blasint* kp1, double* maxc2nrm, lapack_complex_double* a, blasint* lda, blasint* k, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, lapack_complex_double* tau, double* vn1, double* vn2, lapack_complex_double* work, blasint* info);

    void FC_GLOBAL(zlaqp3rk,ZLAQP3RK)(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* nb, double* abstol, double* reltol, blasint* kp1, double* maxc2nrm, lapack_complex_double* a, blasint* lda, blaslogical* done, blasint* kb, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, lapack_complex_double* tau, double* vn1, double* vn2, lapack_complex_double* auxv, lapack_complex_double* f, blasint* ldf, blasint* iwork, blasint* info);
    ...
    void FC_GLOBAL(zlaqz0,ZLAQZ0)(char* wants, char* wantq, char* wantz, blasint* n, blasint* ilo, blasint* ihi, lapack_complex_double* a, blasint* lda, lapack_complex_double* b, blasint* ldb, lapack_complex_double* alpha, lapack_complex_double* beta, lapack_complex_double* q, blasint* ldq, lapack_complex_double* z, blasint* ldz, lapack_complex_double* work, blasint* lwork, double* rwork, blasint* rec, blasint* info, flexiblas_fortran_charlen_t len_wants, flexiblas_fortran_charlen_t len_wantq, flexiblas_fortran_charlen_t len_wantz);

    void FC_GLOBAL(zlaqz1,ZLAQZ1)(blaslogical* ilq, blaslogical* ilz, blasint* k, blasint* istartm, blasint* istopm, blasint* ihi, lapack_complex_double* a, blasint* lda, lapack_complex_double* b, blasint* ldb, blasint* nq, blasint* qstart, lapack_complex_double* q, blasint* ldq, blasint* nz, blasint* zstart, lapack_complex_double* z, blasint* ldz);

    void FC_GLOBAL(zlaqz2,ZLAQZ2)(blaslogical* ilschur, blaslogical* ilq, blaslogical* ilz, blasint* n, blasint* ilo, blasint* ihi, blasint* nw, lapack_complex_double* a, blasint* lda, lapack_complex_double* b, blasint* ldb, lapack_complex_double* q, blasint* ldq, lapack_complex_double* z, blasint* ldz, blasint* ns, blasint* nd, lapack_complex_double* alpha, lapack_complex_double* beta, lapack_complex_double* qc, blasint* ldqc, lapack_complex_double* zc, blasint* ldzc, lapack_complex_double* work, blasint* lwork, double* rwork, blasint* rec, blasint* info);

    void FC_GLOBAL(zlaqz3,ZLAQZ3)(blaslogical* ilschur, blaslogical* ilq, blaslogical* ilz, blasint* n, blasint* ilo, blasint* ihi, blasint* nshifts, blasint* nblock_desired, lapack_complex_double* alpha, lapack_complex_double* beta, lapack_complex_double* a, blasint* lda, lapack_complex_double* b, blasint* ldb, lapack_complex_double* q, blasint* ldq, lapack_complex_double* z, blasint* ldz, lapack_complex_double* qc, blasint* ldqc, lapack_complex_double* zc, blasint* ldzc, lapack_complex_double* work, blasint* lwork, blasint* info);
    ...
    void FC_GLOBAL_(zlarfb_gett,ZLARFB_GETT)(char* ident, blasint* m, blasint* n, blasint* k, lapack_complex_double* t, blasint* ldt, lapack_complex_double* a, blasint* lda, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* ldwork, flexiblas_fortran_charlen_t len_ident);
    ...
    void FC_GLOBAL(zlarfy,ZLARFY)(char* uplo, blasint* n, lapack_complex_double* v, blasint* incv, lapack_complex_double* tau, lapack_complex_double* c, blasint* ldc, lapack_complex_double* work, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(zlartg,ZLARTG)(lapack_complex_float* f, lapack_complex_float* g, float* c, lapack_complex_float* s, lapack_complex_float* r);
    ...
    void FC_GLOBAL(zlassq,ZLASSQ)(blasint* n, lapack_complex_float* x, blasint* incx, float* scale, float* sumsq);
    ...
    void FC_GLOBAL_(zlasyf_aa,ZLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* h, blasint* ldh, lapack_complex_double* work, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zlasyf_rk,ZLASYF_RK)(char* uplo, blasint* n, blasint* nb, blasint* kb, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zlasyf_rook,ZLASYF_ROOK)(char* uplo, blasint* n, blasint* nb, blasint* kb, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(zlatrs3,ZLATRS3)(char* uplo, char* trans, char* diag, char* normin, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* x, blasint* ldx, double* scale, double* cnorm, double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo, flexiblas_fortran_charlen_t len_trans, flexiblas_fortran_charlen_t len_diag, flexiblas_fortran_charlen_t len_normin);
    ...
    void FC_GLOBAL_(zlaunhr_col_getrfnp,ZLAUNHR_COL_GETRFNP)(blasint* m, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* d, blasint* info);

    void FC_GLOBAL_(zlaunhr_col_getrfnp2,ZLAUNHR_COL_GETRFNP2)(blasint* m, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* d, blasint* info);
    ...
    void FC_GLOBAL(zpotrf2,ZPOTRF2)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(zrscl,ZRSCL)(blasint* n, lapack_complex_double* a, lapack_complex_double* x, blasint* incx);
    ...
    void FC_GLOBAL_(zsycon_3,ZSYCON_3)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, double* anorm, double* rcond, lapack_complex_double* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsycon_rook,ZSYCON_ROOK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, blasint* ipiv, double* anorm, double* rcond, lapack_complex_double* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL(zsyconv,ZSYCONV)(char* uplo, char* way, blasint* n, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* e, blasint* info, flexiblas_fortran_charlen_t len_uplo, flexiblas_fortran_charlen_t len_way);

    void FC_GLOBAL(zsyconvf,ZSYCONVF)(char* uplo, char* way, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo, flexiblas_fortran_charlen_t len_way);

    void FC_GLOBAL_(zsyconvf_rook,ZSYCONVF_ROOK)(char* uplo, char* way, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo, flexiblas_fortran_charlen_t len_way);
    ...
    void FC_GLOBAL_(zsysv_aa,ZSYSV_AA)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsysv_aa_2stage,ZSYSV_AA_2STAGE)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsysv_rk,ZSYSV_RK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsysv_rook,ZSYSV_ROOK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zsytf2_rk,ZSYTF2_RK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsytf2_rook,ZSYTF2_ROOK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zsytrf_aa,ZSYTRF_AA)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsytrf_aa_2stage,ZSYTRF_AA_2STAGE)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsytrf_rk,ZSYTRF_RK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsytrf_rook,ZSYTRF_ROOK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zsytri_3,ZSYTRI_3)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsytri_3x,ZSYTRI_3X)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* work, blasint* nb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsytri_rook,ZSYTRI_ROOK)(char* uplo, blasint* n, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zsytrs_3,ZSYTRS_3)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* e, blasint* ipiv, lapack_complex_double* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsytrs_aa,ZSYTRS_AA)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* b, blasint* ldb, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsytrs_aa_2stage,ZSYTRS_AA_2STAGE)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, lapack_complex_double* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, lapack_complex_double* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);

    void FC_GLOBAL_(zsytrs_rook,ZSYTRS_ROOK)(char* uplo, blasint* n, blasint* nrhs, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* b, blasint* ldb, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(ztgevc,ZTGEVC)(char* side, char* howmny, blaslogical* select, blasint* n, lapack_complex_double* s, blasint* lds, lapack_complex_double* p, blasint* ldp, lapack_complex_double* vl, blasint* ldvl, lapack_complex_double* vr, blasint* ldvr, blasint* mm, blasint* m, lapack_complex_double* work, double* rwork, blasint* info, flexiblas_fortran_charlen_t len_side, flexiblas_fortran_charlen_t len_howmny);
    ...
    void FC_GLOBAL(ztrsyl3,ZTRSYL3)(char* trana, char* tranb, blasint* isgn, blasint* m, blasint* n, lapack_complex_double* a, blasint* lda, lapack_complex_double* b, blasint* ldb, lapack_complex_double* c, blasint* ldc, double* scale, double* swork, blasint* ldswork, blasint* info, flexiblas_fortran_charlen_t len_trana, flexiblas_fortran_charlen_t len_tranb);
    ...
    void FC_GLOBAL(zungtsqr,ZUNGTSQR)(blasint* m, blasint* n, blasint* mb, blasint* nb, lapack_complex_double* a, blasint* lda, lapack_complex_double* t, blasint* ldt, lapack_complex_double* work, blasint* lwork, blasint* info);

    void FC_GLOBAL_(zungtsqr_row,ZUNGTSQR_ROW)(blasint* m, blasint* n, blasint* mb, blasint* nb, lapack_complex_double* a, blasint* lda, lapack_complex_double* t, blasint* ldt, lapack_complex_double* work, blasint* lwork, blasint* info);

    void FC_GLOBAL_(zunhr_col,ZUNHR_COL)(blasint* m, blasint* n, blasint* nb, lapack_complex_double* a, blasint* lda, lapack_complex_double* t, blasint* ldt, lapack_complex_double* d, blasint* info);

    void FC_GLOBAL(zunm22,ZUNM22)(char* side, char* trans, blasint* m, blasint* n, blasint* n1, blasint* n2, lapack_complex_double* q, blasint* ldq, lapack_complex_double* c, blasint* ldc, lapack_complex_double* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_side, flexiblas_fortran_charlen_t len_trans);
