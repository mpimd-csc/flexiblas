...
HIDDEN int __flexiblas_load_flapack_fallback ( flexiblas_backend_t *handle, int *loaded, int *failed )  {
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.cgedmd,cgedmd);
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.cgedmdq,cgedmdq);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.cgelqs,cgelqs);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.cgelst,cgelst);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.cgeqp3rk,cgeqp3rk);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.cgeqrs,cgeqrs);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.claqp2rk,claqp2rk);
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.claqp3rk,claqp3rk);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.clatrs3,clatrs3);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.crscl,crscl);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.ctrsyl3,ctrsyl3);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.dgedmd,dgedmd);
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.dgedmdq,dgedmdq);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.dgelqs,dgelqs);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.dgelst,dgelst);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.dgeqp3rk,dgeqp3rk);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.dgeqrs,dgeqrs);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.dlaqp2rk,dlaqp2rk);
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.dlaqp3rk,dlaqp3rk);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.dlarmm,dlarmm);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.dlatrs3,dlatrs3);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.dtrsyl3,dtrsyl3);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.sgedmd,sgedmd);
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.sgedmdq,sgedmdq);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.sgelqs,sgelqs);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.sgelst,sgelst);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.sgeqp3rk,sgeqp3rk);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.sgeqrs,sgeqrs);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.slaqp2rk,slaqp2rk);
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.slaqp3rk,slaqp3rk);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.slarmm,slarmm);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.slatrs3,slatrs3);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.strsyl3,strsyl3);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.xerbla,xerbla);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.zgedmd,zgedmd);
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.zgedmdq,zgedmdq);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.zgelqs,zgelqs);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.zgelst,zgelst);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.zgeqp3rk,zgeqp3rk);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.zgeqrs,zgeqrs);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.zlaqp2rk,zlaqp2rk);
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.zlaqp3rk,zlaqp3rk);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.zlatrs3,zlatrs3);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.zrscl,zrscl);
	...
	LOAD_FLAPACK_NOFALLBACK(handle,lapack.ztrsyl3,ztrsyl3);
