...
#define ZUPMTR   zupmtr_
    ...
    void FC_GLOBAL(classq,CLASSQ)(blasint* n, lapack_complex_float* x, blasint* incx, float* scl, float* sumsq);
    ...
    void FC_GLOBAL(zlassq,ZLASSQ)(blasint* n, lapack_complex_float* x, blasint* incx, float* scl, float* sumsq);
