...
#define ZUPMTR   zupmtr_
    ...
    void FC_GLOBAL(csyswapr,CSYSWAPR)(char* uplo, blasint* n, lapack_complex_float* a, blasint* i1, blasint* i2, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL(zsyswapr,ZSYSWAPR)(char* uplo, blasint* n, lapack_complex_double* a, blasint* i1, blasint* i2, flexiblas_fortran_charlen_t len_uplo);
