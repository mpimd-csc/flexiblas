...
#define ZUPMTR   zupmtr_
    ...
    void FC_GLOBAL(dlasq5,DLASQ5)(blasint* i0, blasint* n0, double* z, blasint* pp, double* tau, double* dmin, double* dmin1, double* dmin2, double* dn, double* dnm1, double* dnm2, blaslogical* ieee);
    ...
    void FC_GLOBAL(slasq5,SLASQ5)(blasint* i0, blasint* n0, float* z, blasint* pp, float* tau, float* dmin, float* dmin1, float* dmin2, float* dn, float* dnm1, float* dnm2, blaslogical* ieee);
