...
void FC_GLOBAL_(clahef_aa,CLAHEF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, float complex* a, blasint* lda, blasint* ipiv, float complex* h, blasint* ldh, float complex* work, blasint* info);
...
void FC_GLOBAL_(dlasyf_aa,DLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, double* a, blasint* lda, blasint* ipiv, double* h, blasint* ldh, double* work, blasint* info);
...
int FC_GLOBAL(iparmq,IPARMQ)(blasint* ispec, char* name, char* opts, blasint* n, blasint* ilo, blasint* ihi, blasint* lwork, blasint len_name, blasint len_opts);
...
void FC_GLOBAL_(slasyf_aa,SLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, float* a, blasint* lda, blasint* ipiv, float* h, blasint* ldh, float* work, blasint* info);
...
void FC_GLOBAL(strevc3,STREVC3)(char* side, char* howmny, blasint* selectfunc, blasint* n, float* t, blasint* ldt, float* vl, blasint* ldvl, float* vr, blasint* ldvr, blasint* mm, blasint* m, float* work, blasint* lwork, blasint* info);
...
void FC_GLOBAL_(zlahef_aa,ZLAHEF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, double complex* a, blasint* lda, blasint* ipiv, double complex* h, blasint* ldh, double complex* work, blasint* info);
...
void FC_GLOBAL_(zlasyf_aa,ZLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, double complex* a, blasint* lda, blasint* ipiv, double complex* h, blasint* ldh, double complex* work, blasint* info);
