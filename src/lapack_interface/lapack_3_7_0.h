...
#define ZUPMTR   zupmtr_
    ...
    void FC_GLOBAL_(clahef_aa,CLAHEF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, float complex* a, blasint* lda, blasint* ipiv, float complex* h, blasint* ldh, float complex* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(clasyf_aa,CLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, float complex* a, blasint* lda, blasint* ipiv, float complex* h, blasint* ldh, float complex* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(dlasyf_aa,DLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, double* a, blasint* lda, blasint* ipiv, double* h, blasint* ldh, double* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(slasyf_aa,SLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, float* a, blasint* lda, blasint* ipiv, float* h, blasint* ldh, float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zlahef_aa,ZLAHEF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, double complex* a, blasint* lda, blasint* ipiv, double complex* h, blasint* ldh, double complex* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zlasyf_aa,ZLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, double complex* a, blasint* lda, blasint* ipiv, double complex* h, blasint* ldh, double complex* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
