...
#define ZUPMTR   zupmtr_
    ...
    void FC_GLOBAL_(clahef_aa,CLAHEF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* h, blasint* ldh, lapack_complex_float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(clasyf_aa,CLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, lapack_complex_float* a, blasint* lda, blasint* ipiv, lapack_complex_float* h, blasint* ldh, lapack_complex_float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zlahef_aa,ZLAHEF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* h, blasint* ldh, lapack_complex_double* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
    ...
    void FC_GLOBAL_(zlasyf_aa,ZLASYF_AA)(char* uplo, blasint* j1, blasint* m, blasint* nb, lapack_complex_double* a, blasint* lda, blasint* ipiv, lapack_complex_double* h, blasint* ldh, lapack_complex_double* work, blasint* info, flexiblas_fortran_charlen_t len_uplo);
