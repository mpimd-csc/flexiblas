...
#endif
{
	...
	fn = current_backend->lapack.sgelqf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgelqf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgelqf_(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgelqf,SGELQF)))));
#else
#ifndef __APPLE__
void sgelqf(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgelqf,SGELQF)))));
#else
void sgelqf(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sgelqf,SGELQF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgelqf_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_sgelqf < __flexiblas_hooks->sgelqf.nhook) {
        fn_hook = __flexiblas_hooks->sgelqf.f77_hook_function[hook_pos_sgelqf];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_sgelqf = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
