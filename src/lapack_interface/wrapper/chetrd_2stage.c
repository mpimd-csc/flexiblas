...
#endif 
{
	...
	fn = current_backend->lapack.chetrd_2stage.call_fblas; 
	if ( __flexiblas_profile ) {
		...
		current_backend->lapack.chetrd_2stage.timings[0] += (flexiblas_wtime() -ts);
		current_backend->lapack.chetrd_2stage.calls[0]++;
	} else { 
		fn((void*) vect, (void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tau, (void*) hous2, (void*) lhous2, (void*) work, (void*) lwork, (void*) info); 
	} 
	return;
