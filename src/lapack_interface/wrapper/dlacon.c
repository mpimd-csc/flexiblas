...
#ifndef __APPLE__
void FC_GLOBAL2(dlacon,DLACON)(blasint* n, double* v, double* x, blasint* isgn, double* est, blasint* kase) __attribute__((alias(MTS(FC_GLOBAL(dlacon,DLACON)))));
void FC_GLOBAL3(dlacon,DLACON)(blasint* n, double* v, double* x, blasint* isgn, double* est, blasint* kase) __attribute__((alias(MTS(FC_GLOBAL(dlacon,DLACON)))));
#else
void FC_GLOBAL2(dlacon,DLACON)(blasint* n, double* v, double* x, blasint* isgn, double* est, blasint* kase){ FC_GLOBAL(dlacon,DLACON)((void*) n, (void*) v, (void*) x, (void*) isgn, (void*) est, (void*) kase); }
void FC_GLOBAL3(dlacon,DLACON)(blasint* n, double* v, double* x, blasint* isgn, double* est, blasint* kase){ FC_GLOBAL(dlacon,DLACON)((void*) n, (void*) v, (void*) x, (void*) isgn, (void*) est, (void*) kase); }
#endif
