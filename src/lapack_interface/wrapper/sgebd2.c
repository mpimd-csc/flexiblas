...
#endif
{
	...
	fn = current_backend->lapack.sgebd2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgebd2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgebd2_(blasint* m, blasint* n, float* a, blasint* lda, float* d, float* e, float* tauq, float* taup, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgebd2,SGEBD2)))));
#else
#ifndef __APPLE__
void sgebd2(blasint* m, blasint* n, float* a, blasint* lda, float* d, float* e, float* tauq, float* taup, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgebd2,SGEBD2)))));
#else
void sgebd2(blasint* m, blasint* n, float* a, blasint* lda, float* d, float* e, float* tauq, float* taup, float* work, blasint* info){ FC_GLOBAL(sgebd2,SGEBD2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tauq, (void*) taup, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgebd2_(void* m, void* n, void* a, void* lda, void* d, void* e, void* tauq, void* taup, void* work, void* info)
{
    ...
    if( hook_pos_sgebd2 < __flexiblas_hooks->sgebd2.nhook) {
        fn_hook = __flexiblas_hooks->sgebd2.f77_hook_function[hook_pos_sgebd2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tauq, (void*) taup, (void*) work, (void*) info);
    } else {
        hook_pos_sgebd2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tauq, (void*) taup, (void*) work, (void*) info); 
