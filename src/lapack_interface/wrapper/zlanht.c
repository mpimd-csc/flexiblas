...
#ifndef __APPLE__
double FC_GLOBAL2(zlanht,ZLANHT)(char* norm, blasint* n, double* d, double complex* e, flexiblas_fortran_charlen_t len_norm) __attribute__((alias(MTS(FC_GLOBAL(zlanht,ZLANHT)))));
double FC_GLOBAL3(zlanht,ZLANHT)(char* norm, blasint* n, double* d, double complex* e, flexiblas_fortran_charlen_t len_norm) __attribute__((alias(MTS(FC_GLOBAL(zlanht,ZLANHT)))));
#else
double FC_GLOBAL2(zlanht,ZLANHT)(char* norm, blasint* n, double* d, double complex* e, flexiblas_fortran_charlen_t len_norm){ return FC_GLOBAL(zlanht,ZLANHT)((void*) norm, (void*) n, (void*) d, (void*) e, (flexiblas_fortran_charlen_t) len_norm); }
double FC_GLOBAL3(zlanht,ZLANHT)(char* norm, blasint* n, double* d, double complex* e, flexiblas_fortran_charlen_t len_norm){ return FC_GLOBAL(zlanht,ZLANHT)((void*) norm, (void*) n, (void*) d, (void*) e, (flexiblas_fortran_charlen_t) len_norm); }
#endif
