...
#endif
{
	...
	fn = current_backend->lapack.zgetrf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->zgetrf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void zgetrf_(blasint* m, blasint* n, double complex* a, blasint* lda, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgetrf,ZGETRF)))));
#else
#ifndef __APPLE__
void zgetrf(blasint* m, blasint* n, double complex* a, blasint* lda, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgetrf,ZGETRF)))));
#else
void zgetrf(blasint* m, blasint* n, double complex* a, blasint* lda, blasint* ipiv, blasint* info){ FC_GLOBAL(zgetrf,ZGETRF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); }
#endif
#endif
...
void flexiblas_chain_zgetrf_(void* m, void* n, void* a, void* lda, void* ipiv, void* info)
{
    ...
    if( hook_pos_zgetrf < __flexiblas_hooks->zgetrf.nhook) {
        fn_hook = __flexiblas_hooks->zgetrf.f77_hook_function[hook_pos_zgetrf];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info);
    } else {
        hook_pos_zgetrf = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); 
