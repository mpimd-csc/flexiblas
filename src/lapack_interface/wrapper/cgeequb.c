...
#endif
{
	...
	fn = current_backend->lapack.cgeequb.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgeequb.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgeequb_(blasint* m, blasint* n, float complex* a, blasint* lda, float* r, float* c, float* rowcnd, float* colcnd, float* amax, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeequb,CGEEQUB)))));
#else
#ifndef __APPLE__
void cgeequb(blasint* m, blasint* n, float complex* a, blasint* lda, float* r, float* c, float* rowcnd, float* colcnd, float* amax, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeequb,CGEEQUB)))));
#else
void cgeequb(blasint* m, blasint* n, float complex* a, blasint* lda, float* r, float* c, float* rowcnd, float* colcnd, float* amax, blasint* info){ FC_GLOBAL(cgeequb,CGEEQUB)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) r, (void*) c, (void*) rowcnd, (void*) colcnd, (void*) amax, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgeequb_(void* m, void* n, void* a, void* lda, void* r, void* c, void* rowcnd, void* colcnd, void* amax, void* info)
{
    ...
    if( hook_pos_cgeequb < __flexiblas_hooks->cgeequb.nhook) {
        fn_hook = __flexiblas_hooks->cgeequb.f77_hook_function[hook_pos_cgeequb];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) r, (void*) c, (void*) rowcnd, (void*) colcnd, (void*) amax, (void*) info);
    } else {
        hook_pos_cgeequb = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) r, (void*) c, (void*) rowcnd, (void*) colcnd, (void*) amax, (void*) info); 
