...
#endif
{
	...
	fn = current_backend->lapack.sgetrf2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgetrf2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgetrf2_(blasint* m, blasint* n, float* a, blasint* lda, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgetrf2,SGETRF2)))));
#else
#ifndef __APPLE__
void sgetrf2(blasint* m, blasint* n, float* a, blasint* lda, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgetrf2,SGETRF2)))));
#else
void sgetrf2(blasint* m, blasint* n, float* a, blasint* lda, blasint* ipiv, blasint* info){ FC_GLOBAL(sgetrf2,SGETRF2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgetrf2_(void* m, void* n, void* a, void* lda, void* ipiv, void* info)
{
    ...
    if( hook_pos_sgetrf2 < __flexiblas_hooks->sgetrf2.nhook) {
        fn_hook = __flexiblas_hooks->sgetrf2.f77_hook_function[hook_pos_sgetrf2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info);
    } else {
        hook_pos_sgetrf2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); 
