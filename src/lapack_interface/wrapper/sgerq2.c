...
#else
void sgerq2(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* info){ FC_GLOBAL(sgerq2,SGERQ2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
