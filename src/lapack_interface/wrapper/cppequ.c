...
void cppequ_(char* uplo, blasint* n, float complex* ap, float* s, float* scond, float* amax, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(cppequ,CPPEQU)))));
#else
#ifndef __APPLE__
void cppequ(char* uplo, blasint* n, float complex* ap, float* s, float* scond, float* amax, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(cppequ,CPPEQU)))));
#else
void cppequ(char* uplo, blasint* n, float complex* ap, float* s, float* scond, float* amax, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(cppequ,CPPEQU)((void*) uplo, (void*) n, (void*) ap, (void*) s, (void*) scond, (void*) amax, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
