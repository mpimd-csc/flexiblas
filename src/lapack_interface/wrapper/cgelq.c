...
#endif
{
	...
	fn = current_backend->lapack.cgelq.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgelq.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgelq_(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* t, blasint* tsize, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgelq,CGELQ)))));
#else
#ifndef __APPLE__
void cgelq(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* t, blasint* tsize, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgelq,CGELQ)))));
#else
void cgelq(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* t, blasint* tsize, float complex* work, blasint* lwork, blasint* info){ FC_GLOBAL(cgelq,CGELQ)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) tsize, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgelq_(void* m, void* n, void* a, void* lda, void* t, void* tsize, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_cgelq < __flexiblas_hooks->cgelq.nhook) {
        fn_hook = __flexiblas_hooks->cgelq.f77_hook_function[hook_pos_cgelq];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) tsize, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_cgelq = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) tsize, (void*) work, (void*) lwork, (void*) info); 
