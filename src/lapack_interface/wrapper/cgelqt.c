...
#endif
{
	...
	fn = current_backend->lapack.cgelqt.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgelqt.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
#else
void cgelqt(blasint* m, blasint* n, blasint* mb, float complex* a, blasint* lda, float complex* t, blasint* ldt, float complex* work, blasint* info){ FC_GLOBAL(cgelqt,CGELQT)((void*) m, (void*) n, (void*) mb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgelqt_(void* m, void* n, void* mb, void* a, void* lda, void* t, void* ldt, void* work, void* info)
{
    ...
    if( hook_pos_cgelqt < __flexiblas_hooks->cgelqt.nhook) {
        fn_hook = __flexiblas_hooks->cgelqt.f77_hook_function[hook_pos_cgelqt];
        fn_hook((void*) m, (void*) n, (void*) mb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info);
    } else {
        hook_pos_cgelqt = 0;
		fn((void*) m, (void*) n, (void*) mb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info); 
