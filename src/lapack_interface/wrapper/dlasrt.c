...
#ifndef __APPLE__
void FC_GLOBAL2(dlasrt,DLASRT)(char* id, blasint* n, double* d, blasint* info, flexiblas_fortran_charlen_t len_id) __attribute__((alias(MTS(FC_GLOBAL(dlasrt,DLASRT)))));
void FC_GLOBAL3(dlasrt,DLASRT)(char* id, blasint* n, double* d, blasint* info, flexiblas_fortran_charlen_t len_id) __attribute__((alias(MTS(FC_GLOBAL(dlasrt,DLASRT)))));
#else
void FC_GLOBAL2(dlasrt,DLASRT)(char* id, blasint* n, double* d, blasint* info, flexiblas_fortran_charlen_t len_id){ FC_GLOBAL(dlasrt,DLASRT)((void*) id, (void*) n, (void*) d, (void*) info, (flexiblas_fortran_charlen_t) len_id); }
void FC_GLOBAL3(dlasrt,DLASRT)(char* id, blasint* n, double* d, blasint* info, flexiblas_fortran_charlen_t len_id){ FC_GLOBAL(dlasrt,DLASRT)((void*) id, (void*) n, (void*) d, (void*) info, (flexiblas_fortran_charlen_t) len_id); }
#endif
