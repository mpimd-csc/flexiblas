...
#endif
{
	...
	fn = current_backend->lapack.dlasq2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->dlasq2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void dlasq2_(blasint* n, double* z, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dlasq2,DLASQ2)))));
#else
#ifndef __APPLE__
void dlasq2(blasint* n, double* z, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dlasq2,DLASQ2)))));
#else
void dlasq2(blasint* n, double* z, blasint* info){ FC_GLOBAL(dlasq2,DLASQ2)((void*) n, (void*) z, (void*) info); }
#endif
#endif
...
void flexiblas_chain_dlasq2_(void* n, void* z, void* info)
{
    ...
    if( hook_pos_dlasq2 < __flexiblas_hooks->dlasq2.nhook) {
        fn_hook = __flexiblas_hooks->dlasq2.f77_hook_function[hook_pos_dlasq2];
        fn_hook((void*) n, (void*) z, (void*) info);
    } else {
        hook_pos_dlasq2 = 0;
		fn((void*) n, (void*) z, (void*) info); 
