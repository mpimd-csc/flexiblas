...
#endif
{
	...
	fn = current_backend->lapack.cgetrf2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgetrf2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgetrf2_(blasint* m, blasint* n, float complex* a, blasint* lda, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgetrf2,CGETRF2)))));
#else
#ifndef __APPLE__
void cgetrf2(blasint* m, blasint* n, float complex* a, blasint* lda, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgetrf2,CGETRF2)))));
#else
void cgetrf2(blasint* m, blasint* n, float complex* a, blasint* lda, blasint* ipiv, blasint* info){ FC_GLOBAL(cgetrf2,CGETRF2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgetrf2_(void* m, void* n, void* a, void* lda, void* ipiv, void* info)
{
    ...
    if( hook_pos_cgetrf2 < __flexiblas_hooks->cgetrf2.nhook) {
        fn_hook = __flexiblas_hooks->cgetrf2.f77_hook_function[hook_pos_cgetrf2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info);
    } else {
        hook_pos_cgetrf2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); 
