...
#endif
{
	...
	fn = current_backend->lapack.sorg2l.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sorg2l.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sorg2l_(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sorg2l,SORG2L)))));
#else
#ifndef __APPLE__
void sorg2l(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sorg2l,SORG2L)))));
#else
void sorg2l(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* info){ FC_GLOBAL(sorg2l,SORG2L)((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sorg2l_(void* m, void* n, void* k, void* a, void* lda, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_sorg2l < __flexiblas_hooks->sorg2l.nhook) {
        fn_hook = __flexiblas_hooks->sorg2l.f77_hook_function[hook_pos_sorg2l];
        fn_hook((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_sorg2l = 0;
		fn((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); 
