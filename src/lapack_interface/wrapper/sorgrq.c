...
#endif
{
	...
	fn = current_backend->lapack.sorgrq.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sorgrq.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sorgrq_(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sorgrq,SORGRQ)))));
#else
#ifndef __APPLE__
void sorgrq(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sorgrq,SORGRQ)))));
#else
void sorgrq(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sorgrq,SORGRQ)((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sorgrq_(void* m, void* n, void* k, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_sorgrq < __flexiblas_hooks->sorgrq.nhook) {
        fn_hook = __flexiblas_hooks->sorgrq.f77_hook_function[hook_pos_sorgrq];
        fn_hook((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_sorgrq = 0;
		fn((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
