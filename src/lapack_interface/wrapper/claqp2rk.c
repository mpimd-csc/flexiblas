...
void claqp2rk_(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* kmax, float* abstol, float* reltol, blasint* kp1, float* maxc2nrm, float complex* a, blasint* lda, blasint* k, float* maxc2nrmk, float* relmaxc2nrmk, blasint* jpiv, float complex* tau, float* vn1, float* vn2, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(claqp2rk,CLAQP2RK)))));
#else
#ifndef __APPLE__
void claqp2rk(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* kmax, float* abstol, float* reltol, blasint* kp1, float* maxc2nrm, float complex* a, blasint* lda, blasint* k, float* maxc2nrmk, float* relmaxc2nrmk, blasint* jpiv, float complex* tau, float* vn1, float* vn2, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(claqp2rk,CLAQP2RK)))));
#else
