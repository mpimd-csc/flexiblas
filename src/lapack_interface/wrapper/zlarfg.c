...
#endif
{
    ...
    *(void **) & fn = current_backend->lapack.zlarfg.f77_blas_function;
    *(void **) & fn_hook = __flexiblas_hooks->zlarfg.f77_hook_function[0];
    if ( fn_hook == NULL ) {
...
#ifndef __APPLE__
void FC_GLOBAL2(zlarfg,ZLARFG)(blasint* n, double complex* alpha, double complex* x, blasint* incx, double complex* tau) __attribute__((alias(MTS(FC_GLOBAL(zlarfg,ZLARFG)))));
void FC_GLOBAL3(zlarfg,ZLARFG)(blasint* n, double complex* alpha, double complex* x, blasint* incx, double complex* tau) __attribute__((alias(MTS(FC_GLOBAL(zlarfg,ZLARFG)))));
#else
void FC_GLOBAL2(zlarfg,ZLARFG)(blasint* n, double complex* alpha, double complex* x, blasint* incx, double complex* tau){ FC_GLOBAL(zlarfg,ZLARFG)((void*) n, (void*) alpha, (void*) x, (void*) incx, (void*) tau); }
void FC_GLOBAL3(zlarfg,ZLARFG)(blasint* n, double complex* alpha, double complex* x, blasint* incx, double complex* tau){ FC_GLOBAL(zlarfg,ZLARFG)((void*) n, (void*) alpha, (void*) x, (void*) incx, (void*) tau); }
#endif
...
void flexiblas_chain_zlarfg_(void* n, void* alpha, void* x, void* incx, void* tau)
{
    ...
    *(void **) &fn      = current_backend->lapack.zlarfg.f77_blas_function;
    ...
    if( hook_pos_zlarfg < __flexiblas_hooks->zlarfg.nhook) {
        *(void **) &fn_hook = __flexiblas_hooks->zlarfg.f77_hook_function[hook_pos_zlarfg];
        fn_hook((void*) n, (void*) alpha, (void*) x, (void*) incx, (void*) tau);
    } else {
        hook_pos_zlarfg = 0;
        fn((void*) n, (void*) alpha, (void*) x, (void*) incx, (void*) tau);
