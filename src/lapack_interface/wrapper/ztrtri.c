...
#endif
{
	...
	fn = current_backend->lapack.ztrtri.f77_blas_function; 
	fn_hook = __flexiblas_hooks->ztrtri.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void flexiblas_chain_ztrtri_(void* uplo, void* diag, void* n, void* a, void* lda, void* info)
{
    ...
    if( hook_pos_ztrtri < __flexiblas_hooks->ztrtri.nhook) {
        fn_hook = __flexiblas_hooks->ztrtri.f77_hook_function[hook_pos_ztrtri];
        fn_hook((void*) uplo, (void*) diag, (void*) n, (void*) a, (void*) lda, (void*) info);
    } else {
        hook_pos_ztrtri = 0;
		fn((void*) uplo, (void*) diag, (void*) n, (void*) a, (void*) lda, (void*) info); 
