...
void slaed3_(blasint* k, blasint* n, blasint* n1, float* d, float* q, blasint* ldq, float* rho, float* dlambda, float* q2, blasint* indx, blasint* ctot, float* w, float* s, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(slaed3,SLAED3)))));
#else
#ifndef __APPLE__
void slaed3(blasint* k, blasint* n, blasint* n1, float* d, float* q, blasint* ldq, float* rho, float* dlambda, float* q2, blasint* indx, blasint* ctot, float* w, float* s, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(slaed3,SLAED3)))));
#else
void slaed3(blasint* k, blasint* n, blasint* n1, float* d, float* q, blasint* ldq, float* rho, float* dlambda, float* q2, blasint* indx, blasint* ctot, float* w, float* s, blasint* info){ FC_GLOBAL(slaed3,SLAED3)((void*) k, (void*) n, (void*) n1, (void*) d, (void*) q, (void*) ldq, (void*) rho, (void*) dlambda, (void*) q2, (void*) indx, (void*) ctot, (void*) w, (void*) s, (void*) info); }
#endif
#endif
