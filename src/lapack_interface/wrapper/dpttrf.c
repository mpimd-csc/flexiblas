...
#endif
{
	...
	fn = current_backend->lapack.dpttrf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->dpttrf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void flexiblas_chain_dpttrf_(void* n, void* d, void* e, void* info)
{
    ...
    if( hook_pos_dpttrf < __flexiblas_hooks->dpttrf.nhook) {
        fn_hook = __flexiblas_hooks->dpttrf.f77_hook_function[hook_pos_dpttrf];
        fn_hook((void*) n, (void*) d, (void*) e, (void*) info);
    } else {
        hook_pos_dpttrf = 0;
		fn((void*) n, (void*) d, (void*) e, (void*) info); 
