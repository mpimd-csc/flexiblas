...
#ifndef __APPLE__
void FC_GLOBAL2(dpttrf,DPTTRF)(blasint* n, double* d, double* e, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dpttrf,DPTTRF)))));
void FC_GLOBAL3(dpttrf,DPTTRF)(blasint* n, double* d, double* e, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dpttrf,DPTTRF)))));
#else
void FC_GLOBAL2(dpttrf,DPTTRF)(blasint* n, double* d, double* e, blasint* info){ FC_GLOBAL(dpttrf,DPTTRF)((void*) n, (void*) d, (void*) e, (void*) info); }
void FC_GLOBAL3(dpttrf,DPTTRF)(blasint* n, double* d, double* e, blasint* info){ FC_GLOBAL(dpttrf,DPTTRF)((void*) n, (void*) d, (void*) e, (void*) info); }
#endif
