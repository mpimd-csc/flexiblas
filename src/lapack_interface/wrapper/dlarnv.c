...
#ifndef __APPLE__
void FC_GLOBAL2(dlarnv,DLARNV)(blasint* idist, blasint* iseed, blasint* n, double* x) __attribute__((alias(MTS(FC_GLOBAL(dlarnv,DLARNV)))));
void FC_GLOBAL3(dlarnv,DLARNV)(blasint* idist, blasint* iseed, blasint* n, double* x) __attribute__((alias(MTS(FC_GLOBAL(dlarnv,DLARNV)))));
#else
void FC_GLOBAL2(dlarnv,DLARNV)(blasint* idist, blasint* iseed, blasint* n, double* x){ FC_GLOBAL(dlarnv,DLARNV)((void*) idist, (void*) iseed, (void*) n, (void*) x); }
void FC_GLOBAL3(dlarnv,DLARNV)(blasint* idist, blasint* iseed, blasint* n, double* x){ FC_GLOBAL(dlarnv,DLARNV)((void*) idist, (void*) iseed, (void*) n, (void*) x); }
#endif
