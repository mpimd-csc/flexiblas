...
#endif
{
	...
	fn = current_backend->lapack.slacn2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->slacn2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void slacn2_(blasint* n, float* v, float* x, blasint* isgn, float* est, blasint* kase, blasint* isave) __attribute__((alias(MTS(FC_GLOBAL(slacn2,SLACN2)))));
#else
#ifndef __APPLE__
void slacn2(blasint* n, float* v, float* x, blasint* isgn, float* est, blasint* kase, blasint* isave) __attribute__((alias(MTS(FC_GLOBAL(slacn2,SLACN2)))));
#else
void slacn2(blasint* n, float* v, float* x, blasint* isgn, float* est, blasint* kase, blasint* isave){ FC_GLOBAL(slacn2,SLACN2)((void*) n, (void*) v, (void*) x, (void*) isgn, (void*) est, (void*) kase, (void*) isave); }
#endif
#endif
...
void flexiblas_chain_slacn2_(void* n, void* v, void* x, void* isgn, void* est, void* kase, void* isave)
{
    ...
    if( hook_pos_slacn2 < __flexiblas_hooks->slacn2.nhook) {
        fn_hook = __flexiblas_hooks->slacn2.f77_hook_function[hook_pos_slacn2];
        fn_hook((void*) n, (void*) v, (void*) x, (void*) isgn, (void*) est, (void*) kase, (void*) isave);
    } else {
        hook_pos_slacn2 = 0;
		fn((void*) n, (void*) v, (void*) x, (void*) isgn, (void*) est, (void*) kase, (void*) isave); 
