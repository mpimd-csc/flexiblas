...
void csytf2_rk_(char* uplo, blasint* n, float complex* a, blasint* lda, float complex* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(csytf2_rk,CSYTF2_RK)))));
#else
#ifndef __APPLE__
void csytf2_rk(char* uplo, blasint* n, float complex* a, blasint* lda, float complex* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(csytf2_rk,CSYTF2_RK)))));
#else
void csytf2_rk(char* uplo, blasint* n, float complex* a, blasint* lda, float complex* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL_(csytf2_rk,CSYTF2_RK)((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) e, (void*) ipiv, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
