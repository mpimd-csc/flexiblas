...
void clahef_rk_(char* uplo, blasint* n, blasint* nb, blasint* kb, float complex* a, blasint* lda, float complex* e, blasint* ipiv, float complex* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(clahef_rk,CLAHEF_RK)))));
#else
#ifndef __APPLE__
void clahef_rk(char* uplo, blasint* n, blasint* nb, blasint* kb, float complex* a, blasint* lda, float complex* e, blasint* ipiv, float complex* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(clahef_rk,CLAHEF_RK)))));
#else
void clahef_rk(char* uplo, blasint* n, blasint* nb, blasint* kb, float complex* a, blasint* lda, float complex* e, blasint* ipiv, float complex* w, blasint* ldw, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL_(clahef_rk,CLAHEF_RK)((void*) uplo, (void*) n, (void*) nb, (void*) kb, (void*) a, (void*) lda, (void*) e, (void*) ipiv, (void*) w, (void*) ldw, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
