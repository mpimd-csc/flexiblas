...
#endif
{
	...
	fn = current_backend->lapack.dgeqrf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->dgeqrf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void dgeqrf_(blasint* m, blasint* n, double* a, blasint* lda, double* tau, double* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgeqrf,DGEQRF)))));
#else
#ifndef __APPLE__
void dgeqrf(blasint* m, blasint* n, double* a, blasint* lda, double* tau, double* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgeqrf,DGEQRF)))));
#else
void dgeqrf(blasint* m, blasint* n, double* a, blasint* lda, double* tau, double* work, blasint* lwork, blasint* info){ FC_GLOBAL(dgeqrf,DGEQRF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_dgeqrf_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_dgeqrf < __flexiblas_hooks->dgeqrf.nhook) {
        fn_hook = __flexiblas_hooks->dgeqrf.f77_hook_function[hook_pos_dgeqrf];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_dgeqrf = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
