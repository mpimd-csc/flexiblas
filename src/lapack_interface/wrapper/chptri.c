...
void chptri_(char* uplo, blasint* n, float complex* ap, blasint* ipiv, float complex* work, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(chptri,CHPTRI)))));
#else
#ifndef __APPLE__
void chptri(char* uplo, blasint* n, float complex* ap, blasint* ipiv, float complex* work, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(chptri,CHPTRI)))));
#else
void chptri(char* uplo, blasint* n, float complex* ap, blasint* ipiv, float complex* work, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(chptri,CHPTRI)((void*) uplo, (void*) n, (void*) ap, (void*) ipiv, (void*) work, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
