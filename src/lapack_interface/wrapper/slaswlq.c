...
#endif
{
	...
	fn = current_backend->lapack.slaswlq.f77_blas_function; 
	fn_hook = __flexiblas_hooks->slaswlq.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void slaswlq_(blasint* m, blasint* n, blasint* mb, blasint* nb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(slaswlq,SLASWLQ)))));
#else
#ifndef __APPLE__
void slaswlq(blasint* m, blasint* n, blasint* mb, blasint* nb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(slaswlq,SLASWLQ)))));
#else
void slaswlq(blasint* m, blasint* n, blasint* mb, blasint* nb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(slaswlq,SLASWLQ)((void*) m, (void*) n, (void*) mb, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_slaswlq_(void* m, void* n, void* mb, void* nb, void* a, void* lda, void* t, void* ldt, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_slaswlq < __flexiblas_hooks->slaswlq.nhook) {
        fn_hook = __flexiblas_hooks->slaswlq.f77_hook_function[hook_pos_slaswlq];
        fn_hook((void*) m, (void*) n, (void*) mb, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_slaswlq = 0;
		fn((void*) m, (void*) n, (void*) mb, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info); 
