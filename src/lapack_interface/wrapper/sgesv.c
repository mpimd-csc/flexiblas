...
#endif
{
	...
	fn = current_backend->lapack.sgesv.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgesv.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgesv_(blasint* n, blasint* nrhs, float* a, blasint* lda, blasint* ipiv, float* b, blasint* ldb, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgesv,SGESV)))));
#else
#ifndef __APPLE__
void sgesv(blasint* n, blasint* nrhs, float* a, blasint* lda, blasint* ipiv, float* b, blasint* ldb, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgesv,SGESV)))));
#else
void sgesv(blasint* n, blasint* nrhs, float* a, blasint* lda, blasint* ipiv, float* b, blasint* ldb, blasint* info){ FC_GLOBAL(sgesv,SGESV)((void*) n, (void*) nrhs, (void*) a, (void*) lda, (void*) ipiv, (void*) b, (void*) ldb, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgesv_(void* n, void* nrhs, void* a, void* lda, void* ipiv, void* b, void* ldb, void* info)
{
    ...
    if( hook_pos_sgesv < __flexiblas_hooks->sgesv.nhook) {
        fn_hook = __flexiblas_hooks->sgesv.f77_hook_function[hook_pos_sgesv];
        fn_hook((void*) n, (void*) nrhs, (void*) a, (void*) lda, (void*) ipiv, (void*) b, (void*) ldb, (void*) info);
    } else {
        hook_pos_sgesv = 0;
		fn((void*) n, (void*) nrhs, (void*) a, (void*) lda, (void*) ipiv, (void*) b, (void*) ldb, (void*) info); 
