...
#else
void cgetf2(blasint* m, blasint* n, float complex* a, blasint* lda, blasint* ipiv, blasint* info){ FC_GLOBAL(cgetf2,CGETF2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); }
#endif
#endif
