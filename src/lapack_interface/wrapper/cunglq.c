...
#endif
{
	...
	fn = current_backend->lapack.cunglq.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cunglq.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cunglq_(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cunglq,CUNGLQ)))));
#else
#ifndef __APPLE__
void cunglq(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cunglq,CUNGLQ)))));
#else
void cunglq(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info){ FC_GLOBAL(cunglq,CUNGLQ)((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cunglq_(void* m, void* n, void* k, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_cunglq < __flexiblas_hooks->cunglq.nhook) {
        fn_hook = __flexiblas_hooks->cunglq.f77_hook_function[hook_pos_cunglq];
        fn_hook((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_cunglq = 0;
		fn((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
