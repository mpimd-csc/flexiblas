...
#endif
{
	...
	fn = current_backend->lapack.zhetf2_rook.f77_blas_function; 
	fn_hook = __flexiblas_hooks->zhetf2_rook.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void flexiblas_chain_zhetf2_rook_(void* uplo, void* n, void* a, void* lda, void* ipiv, void* info)
{
    ...
    if( hook_pos_zhetf2_rook < __flexiblas_hooks->zhetf2_rook.nhook) {
        fn_hook = __flexiblas_hooks->zhetf2_rook.f77_hook_function[hook_pos_zhetf2_rook];
        fn_hook((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info);
    } else {
        hook_pos_zhetf2_rook = 0;
		fn((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); 
