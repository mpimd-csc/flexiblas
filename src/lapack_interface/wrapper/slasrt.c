...
#endif
{
	...
	fn = current_backend->lapack.slasrt.f77_blas_function; 
	fn_hook = __flexiblas_hooks->slasrt.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void flexiblas_chain_slasrt_(void* id, void* n, void* d, void* info)
{
    ...
    if( hook_pos_slasrt < __flexiblas_hooks->slasrt.nhook) {
        fn_hook = __flexiblas_hooks->slasrt.f77_hook_function[hook_pos_slasrt];
        fn_hook((void*) id, (void*) n, (void*) d, (void*) info);
    } else {
        hook_pos_slasrt = 0;
		fn((void*) id, (void*) n, (void*) d, (void*) info); 
