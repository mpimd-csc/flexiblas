...
void sgelqs_(blasint* m, blasint* n, blasint* nrhs, float* a, blasint* lda, float* tau, float* b, blasint* ldb, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgelqs,SGELQS)))));
#else
#ifndef __APPLE__
void sgelqs(blasint* m, blasint* n, blasint* nrhs, float* a, blasint* lda, float* tau, float* b, blasint* ldb, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgelqs,SGELQS)))));
#else
void sgelqs(blasint* m, blasint* n, blasint* nrhs, float* a, blasint* lda, float* tau, float* b, blasint* ldb, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sgelqs,SGELQS)((void*) m, (void*) n, (void*) nrhs, (void*) a, (void*) lda, (void*) tau, (void*) b, (void*) ldb, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
