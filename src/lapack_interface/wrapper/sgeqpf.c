...
#endif
{
	...
	fn = current_backend->lapack.sgeqpf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgeqpf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgeqpf_(blasint* m, blasint* n, float* a, blasint* lda, blasint* jpvt, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqpf,SGEQPF)))));
#else
#ifndef __APPLE__
void sgeqpf(blasint* m, blasint* n, float* a, blasint* lda, blasint* jpvt, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqpf,SGEQPF)))));
#else
void sgeqpf(blasint* m, blasint* n, float* a, blasint* lda, blasint* jpvt, float* tau, float* work, blasint* info){ FC_GLOBAL(sgeqpf,SGEQPF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) jpvt, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgeqpf_(void* m, void* n, void* a, void* lda, void* jpvt, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_sgeqpf < __flexiblas_hooks->sgeqpf.nhook) {
        fn_hook = __flexiblas_hooks->sgeqpf.f77_hook_function[hook_pos_sgeqpf];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) jpvt, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_sgeqpf = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) jpvt, (void*) tau, (void*) work, (void*) info); 
