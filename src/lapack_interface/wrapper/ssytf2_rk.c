...
void ssytf2_rk_(char* uplo, blasint* n, float* a, blasint* lda, float* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(ssytf2_rk,SSYTF2_RK)))));
#else
#ifndef __APPLE__
void ssytf2_rk(char* uplo, blasint* n, float* a, blasint* lda, float* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(ssytf2_rk,SSYTF2_RK)))));
#else
void ssytf2_rk(char* uplo, blasint* n, float* a, blasint* lda, float* e, blasint* ipiv, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL_(ssytf2_rk,SSYTF2_RK)((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) e, (void*) ipiv, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
