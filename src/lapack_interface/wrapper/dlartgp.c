...
#ifndef __APPLE__
void FC_GLOBAL2(dlartgp,DLARTGP)(double* f, double* g, double* cs, double* sn, double* r) __attribute__((alias(MTS(FC_GLOBAL(dlartgp,DLARTGP)))));
void FC_GLOBAL3(dlartgp,DLARTGP)(double* f, double* g, double* cs, double* sn, double* r) __attribute__((alias(MTS(FC_GLOBAL(dlartgp,DLARTGP)))));
#else
void FC_GLOBAL2(dlartgp,DLARTGP)(double* f, double* g, double* cs, double* sn, double* r){ FC_GLOBAL(dlartgp,DLARTGP)((void*) f, (void*) g, (void*) cs, (void*) sn, (void*) r); }
void FC_GLOBAL3(dlartgp,DLARTGP)(double* f, double* g, double* cs, double* sn, double* r){ FC_GLOBAL(dlartgp,DLARTGP)((void*) f, (void*) g, (void*) cs, (void*) sn, (void*) r); }
#endif
