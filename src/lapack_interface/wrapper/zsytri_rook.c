...
#ifndef __APPLE__
void FC_GLOBAL2_(zsytri_rook,ZSYTRI_ROOK)(char* uplo, blasint* n, double complex* a, blasint* lda, blasint* ipiv, double complex* work, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(zsytri_rook,ZSYTRI_ROOK)))));
void FC_GLOBAL3_(zsytri_rook,ZSYTRI_ROOK)(char* uplo, blasint* n, double complex* a, blasint* lda, blasint* ipiv, double complex* work, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(zsytri_rook,ZSYTRI_ROOK)))));
#else
void FC_GLOBAL2_(zsytri_rook,ZSYTRI_ROOK)(char* uplo, blasint* n, double complex* a, blasint* lda, blasint* ipiv, double complex* work, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL_(zsytri_rook,ZSYTRI_ROOK)((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) work, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
void FC_GLOBAL3_(zsytri_rook,ZSYTRI_ROOK)(char* uplo, blasint* n, double complex* a, blasint* lda, blasint* ipiv, double complex* work, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL_(zsytri_rook,ZSYTRI_ROOK)((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) work, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
