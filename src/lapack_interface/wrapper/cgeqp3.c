...
#endif
{
	...
	fn = current_backend->lapack.cgeqp3.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgeqp3.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgeqp3_(blasint* m, blasint* n, float complex* a, blasint* lda, blasint* jpvt, float complex* tau, float complex* work, blasint* lwork, float* rwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeqp3,CGEQP3)))));
#else
#ifndef __APPLE__
void cgeqp3(blasint* m, blasint* n, float complex* a, blasint* lda, blasint* jpvt, float complex* tau, float complex* work, blasint* lwork, float* rwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeqp3,CGEQP3)))));
#else
void cgeqp3(blasint* m, blasint* n, float complex* a, blasint* lda, blasint* jpvt, float complex* tau, float complex* work, blasint* lwork, float* rwork, blasint* info){ FC_GLOBAL(cgeqp3,CGEQP3)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) jpvt, (void*) tau, (void*) work, (void*) lwork, (void*) rwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgeqp3_(void* m, void* n, void* a, void* lda, void* jpvt, void* tau, void* work, void* lwork, void* rwork, void* info)
{
    ...
    if( hook_pos_cgeqp3 < __flexiblas_hooks->cgeqp3.nhook) {
        fn_hook = __flexiblas_hooks->cgeqp3.f77_hook_function[hook_pos_cgeqp3];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) jpvt, (void*) tau, (void*) work, (void*) lwork, (void*) rwork, (void*) info);
    } else {
        hook_pos_cgeqp3 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) jpvt, (void*) tau, (void*) work, (void*) lwork, (void*) rwork, (void*) info); 
