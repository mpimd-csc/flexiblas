...
#endif
{
	...
	fn = current_backend->lapack.sorglq.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sorglq.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sorglq_(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sorglq,SORGLQ)))));
#else
#ifndef __APPLE__
void sorglq(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sorglq,SORGLQ)))));
#else
void sorglq(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sorglq,SORGLQ)((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sorglq_(void* m, void* n, void* k, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_sorglq < __flexiblas_hooks->sorglq.nhook) {
        fn_hook = __flexiblas_hooks->sorglq.f77_hook_function[hook_pos_sorglq];
        fn_hook((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_sorglq = 0;
		fn((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
