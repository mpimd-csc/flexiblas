...
#endif 
{
	...
	fn = current_backend->lapack.clasyf_rook.call_fblas; 
	if ( __flexiblas_profile ) {
		ts = flexiblas_wtime(); 
		fn((void*) uplo, (void*) n, (void*) nb, (void*) kb, (void*) a, (void*) lda, (void*) ipiv, (void*) w, (void*) ldw, (void*) info); 
		current_backend->lapack.clasyf_rook.timings[0] += (flexiblas_wtime() -ts);
		current_backend->lapack.clasyf_rook.calls[0]++;
	} else { 
		fn((void*) uplo, (void*) n, (void*) nb, (void*) kb, (void*) a, (void*) lda, (void*) ipiv, (void*) w, (void*) ldw, (void*) info); 
	} 
	return;
