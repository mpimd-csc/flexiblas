...
#ifndef __APPLE__
void FC_GLOBAL2(dlaed5,DLAED5)(blasint* i, double* d, double* z, double* delta, double* rho, double* dlam) __attribute__((alias(MTS(FC_GLOBAL(dlaed5,DLAED5)))));
void FC_GLOBAL3(dlaed5,DLAED5)(blasint* i, double* d, double* z, double* delta, double* rho, double* dlam) __attribute__((alias(MTS(FC_GLOBAL(dlaed5,DLAED5)))));
#else
void FC_GLOBAL2(dlaed5,DLAED5)(blasint* i, double* d, double* z, double* delta, double* rho, double* dlam){ FC_GLOBAL(dlaed5,DLAED5)((void*) i, (void*) d, (void*) z, (void*) delta, (void*) rho, (void*) dlam); }
void FC_GLOBAL3(dlaed5,DLAED5)(blasint* i, double* d, double* z, double* delta, double* rho, double* dlam){ FC_GLOBAL(dlaed5,DLAED5)((void*) i, (void*) d, (void*) z, (void*) delta, (void*) rho, (void*) dlam); }
#endif
