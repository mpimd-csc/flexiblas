...
#ifndef __APPLE__
void FC_GLOBAL2(dgeqpf,DGEQPF)(blasint* m, blasint* n, double* a, blasint* lda, blasint* jpvt, double* tau, double* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgeqpf,DGEQPF)))));
void FC_GLOBAL3(dgeqpf,DGEQPF)(blasint* m, blasint* n, double* a, blasint* lda, blasint* jpvt, double* tau, double* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgeqpf,DGEQPF)))));
#else
void FC_GLOBAL2(dgeqpf,DGEQPF)(blasint* m, blasint* n, double* a, blasint* lda, blasint* jpvt, double* tau, double* work, blasint* info){ FC_GLOBAL(dgeqpf,DGEQPF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) jpvt, (void*) tau, (void*) work, (void*) info); }
void FC_GLOBAL3(dgeqpf,DGEQPF)(blasint* m, blasint* n, double* a, blasint* lda, blasint* jpvt, double* tau, double* work, blasint* info){ FC_GLOBAL(dgeqpf,DGEQPF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) jpvt, (void*) tau, (void*) work, (void*) info); }
#endif
