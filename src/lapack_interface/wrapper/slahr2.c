...
#endif
{
	...
	fn = current_backend->lapack.slahr2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->slahr2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
#else
void slahr2(blasint* n, blasint* k, blasint* nb, float* a, blasint* lda, float* tau, float* t, blasint* ldt, float* y, blasint* ldy){ FC_GLOBAL(slahr2,SLAHR2)((void*) n, (void*) k, (void*) nb, (void*) a, (void*) lda, (void*) tau, (void*) t, (void*) ldt, (void*) y, (void*) ldy); }
#endif
#endif
...
void flexiblas_chain_slahr2_(void* n, void* k, void* nb, void* a, void* lda, void* tau, void* t, void* ldt, void* y, void* ldy)
{
    ...
    if( hook_pos_slahr2 < __flexiblas_hooks->slahr2.nhook) {
        fn_hook = __flexiblas_hooks->slahr2.f77_hook_function[hook_pos_slahr2];
        fn_hook((void*) n, (void*) k, (void*) nb, (void*) a, (void*) lda, (void*) tau, (void*) t, (void*) ldt, (void*) y, (void*) ldy);
    } else {
        hook_pos_slahr2 = 0;
		fn((void*) n, (void*) k, (void*) nb, (void*) a, (void*) lda, (void*) tau, (void*) t, (void*) ldt, (void*) y, (void*) ldy); 
