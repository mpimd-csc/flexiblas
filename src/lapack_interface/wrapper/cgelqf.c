...
#endif
{
	...
	fn = current_backend->lapack.cgelqf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgelqf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgelqf_(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgelqf,CGELQF)))));
#else
#ifndef __APPLE__
void cgelqf(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgelqf,CGELQF)))));
#else
void cgelqf(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info){ FC_GLOBAL(cgelqf,CGELQF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgelqf_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_cgelqf < __flexiblas_hooks->cgelqf.nhook) {
        fn_hook = __flexiblas_hooks->cgelqf.f77_hook_function[hook_pos_cgelqf];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_cgelqf = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
