...
#endif
{
	...
	fn = current_backend->lapack.sgebrd.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgebrd.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgebrd_(blasint* m, blasint* n, float* a, blasint* lda, float* d, float* e, float* tauq, float* taup, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgebrd,SGEBRD)))));
#else
#ifndef __APPLE__
void sgebrd(blasint* m, blasint* n, float* a, blasint* lda, float* d, float* e, float* tauq, float* taup, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgebrd,SGEBRD)))));
#else
void sgebrd(blasint* m, blasint* n, float* a, blasint* lda, float* d, float* e, float* tauq, float* taup, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sgebrd,SGEBRD)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tauq, (void*) taup, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgebrd_(void* m, void* n, void* a, void* lda, void* d, void* e, void* tauq, void* taup, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_sgebrd < __flexiblas_hooks->sgebrd.nhook) {
        fn_hook = __flexiblas_hooks->sgebrd.f77_hook_function[hook_pos_sgebrd];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tauq, (void*) taup, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_sgebrd = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tauq, (void*) taup, (void*) work, (void*) lwork, (void*) info); 
