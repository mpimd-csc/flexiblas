...
#endif
{
	...
	fn = current_backend->lapack.slargv.f77_blas_function; 
	fn_hook = __flexiblas_hooks->slargv.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void slargv_(blasint* n, float* x, blasint* incx, float* y, blasint* incy, float* c, blasint* incc) __attribute__((alias(MTS(FC_GLOBAL(slargv,SLARGV)))));
#else
#ifndef __APPLE__
void slargv(blasint* n, float* x, blasint* incx, float* y, blasint* incy, float* c, blasint* incc) __attribute__((alias(MTS(FC_GLOBAL(slargv,SLARGV)))));
#else
void slargv(blasint* n, float* x, blasint* incx, float* y, blasint* incy, float* c, blasint* incc){ FC_GLOBAL(slargv,SLARGV)((void*) n, (void*) x, (void*) incx, (void*) y, (void*) incy, (void*) c, (void*) incc); }
#endif
#endif
...
void flexiblas_chain_slargv_(void* n, void* x, void* incx, void* y, void* incy, void* c, void* incc)
{
    ...
    if( hook_pos_slargv < __flexiblas_hooks->slargv.nhook) {
        fn_hook = __flexiblas_hooks->slargv.f77_hook_function[hook_pos_slargv];
        fn_hook((void*) n, (void*) x, (void*) incx, (void*) y, (void*) incy, (void*) c, (void*) incc);
    } else {
        hook_pos_slargv = 0;
		fn((void*) n, (void*) x, (void*) incx, (void*) y, (void*) incy, (void*) c, (void*) incc); 
