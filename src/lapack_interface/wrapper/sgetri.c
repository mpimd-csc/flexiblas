...
#else
void sgetri(blasint* n, float* a, blasint* lda, blasint* ipiv, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sgetri,SGETRI)((void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
