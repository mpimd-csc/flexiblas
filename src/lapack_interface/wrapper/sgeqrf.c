...
#endif
{
	...
	fn = current_backend->lapack.sgeqrf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgeqrf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgeqrf_(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqrf,SGEQRF)))));
#else
#ifndef __APPLE__
void sgeqrf(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqrf,SGEQRF)))));
#else
void sgeqrf(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sgeqrf,SGEQRF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgeqrf_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_sgeqrf < __flexiblas_hooks->sgeqrf.nhook) {
        fn_hook = __flexiblas_hooks->sgeqrf.f77_hook_function[hook_pos_sgeqrf];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_sgeqrf = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
