...
void zlaqp2rk_(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* kmax, double* abstol, double* reltol, blasint* kp1, double* maxc2nrm, double complex* a, blasint* lda, blasint* k, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, double complex* tau, double* vn1, double* vn2, double complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zlaqp2rk,ZLAQP2RK)))));
#else
#ifndef __APPLE__
void zlaqp2rk(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* kmax, double* abstol, double* reltol, blasint* kp1, double* maxc2nrm, double complex* a, blasint* lda, blasint* k, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, double complex* tau, double* vn1, double* vn2, double complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zlaqp2rk,ZLAQP2RK)))));
#else
