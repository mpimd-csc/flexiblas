...
#endif
{
	...
	fn = current_backend->lapack.sgeqrt2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgeqrt2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgeqrt2_(blasint* m, blasint* n, float* a, blasint* lda, float* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqrt2,SGEQRT2)))));
#else
#ifndef __APPLE__
void sgeqrt2(blasint* m, blasint* n, float* a, blasint* lda, float* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqrt2,SGEQRT2)))));
#else
void sgeqrt2(blasint* m, blasint* n, float* a, blasint* lda, float* t, blasint* ldt, blasint* info){ FC_GLOBAL(sgeqrt2,SGEQRT2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgeqrt2_(void* m, void* n, void* a, void* lda, void* t, void* ldt, void* info)
{
    ...
    if( hook_pos_sgeqrt2 < __flexiblas_hooks->sgeqrt2.nhook) {
        fn_hook = __flexiblas_hooks->sgeqrt2.f77_hook_function[hook_pos_sgeqrt2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info);
    } else {
        hook_pos_sgeqrt2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info); 
