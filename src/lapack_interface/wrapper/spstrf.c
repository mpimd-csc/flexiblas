...
#endif
{
	...
	fn = current_backend->lapack.spstrf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->spstrf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void flexiblas_real_spstrf_(void* uplo, void* n, void* a, void* lda, void* piv, void* rank_bn, void* tol, void* work, void* info)
{
	void (*fn) (void* uplo, void* n, void* a, void* lda, void* piv, void* rank_bn, void* tol, void* work, void* info);
...
void flexiblas_chain_spstrf_(void* uplo, void* n, void* a, void* lda, void* piv, void* rank_bn, void* tol, void* work, void* info)
{
	void (*fn) (void* uplo, void* n, void* a, void* lda, void* piv, void* rank_bn, void* tol, void* work, void* info);
	void (*fn_hook) (void* uplo, void* n, void* a, void* lda, void* piv, void* rank_bn, void* tol, void* work, void* info);
    ...
    if( hook_pos_spstrf < __flexiblas_hooks->spstrf.nhook) {
        fn_hook = __flexiblas_hooks->spstrf.f77_hook_function[hook_pos_spstrf];
        fn_hook((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) piv, (void*) rank_bn, (void*) tol, (void*) work, (void*) info);
    } else {
        hook_pos_spstrf = 0;
		fn((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) piv, (void*) rank_bn, (void*) tol, (void*) work, (void*) info); 
