...
#ifndef __APPLE__
void FC_GLOBAL2(dgelqs,DGELQS)(blasint* m, blasint* n, blasint* nrhs, double* a, blasint* lda, double* tau, double* b, blasint* ldb, double* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgelqs,DGELQS)))));
void FC_GLOBAL3(dgelqs,DGELQS)(blasint* m, blasint* n, blasint* nrhs, double* a, blasint* lda, double* tau, double* b, blasint* ldb, double* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgelqs,DGELQS)))));
#else
void FC_GLOBAL2(dgelqs,DGELQS)(blasint* m, blasint* n, blasint* nrhs, double* a, blasint* lda, double* tau, double* b, blasint* ldb, double* work, blasint* lwork, blasint* info){ FC_GLOBAL(dgelqs,DGELQS)((void*) m, (void*) n, (void*) nrhs, (void*) a, (void*) lda, (void*) tau, (void*) b, (void*) ldb, (void*) work, (void*) lwork, (void*) info); }
void FC_GLOBAL3(dgelqs,DGELQS)(blasint* m, blasint* n, blasint* nrhs, double* a, blasint* lda, double* tau, double* b, blasint* ldb, double* work, blasint* lwork, blasint* info){ FC_GLOBAL(dgelqs,DGELQS)((void*) m, (void*) n, (void*) nrhs, (void*) a, (void*) lda, (void*) tau, (void*) b, (void*) ldb, (void*) work, (void*) lwork, (void*) info); }
#endif
