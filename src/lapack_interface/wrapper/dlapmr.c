...
#else
void dlapmr(blasint* forwrd, blasint* m, blasint* n, double* x, blasint* ldx, blasint* k){ FC_GLOBAL(dlapmr,DLAPMR)((void*) forwrd, (void*) m, (void*) n, (void*) x, (void*) ldx, (void*) k); }
#endif
#endif
