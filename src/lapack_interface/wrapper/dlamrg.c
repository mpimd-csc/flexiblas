...
#ifndef __APPLE__
void FC_GLOBAL2(dlamrg,DLAMRG)(blasint* n1, blasint* n2, double* a, blasint* dtrd1, blasint* dtrd2, blasint* index_bn) __attribute__((alias(MTS(FC_GLOBAL(dlamrg,DLAMRG)))));
void FC_GLOBAL3(dlamrg,DLAMRG)(blasint* n1, blasint* n2, double* a, blasint* dtrd1, blasint* dtrd2, blasint* index_bn) __attribute__((alias(MTS(FC_GLOBAL(dlamrg,DLAMRG)))));
#else
void FC_GLOBAL2(dlamrg,DLAMRG)(blasint* n1, blasint* n2, double* a, blasint* dtrd1, blasint* dtrd2, blasint* index_bn){ FC_GLOBAL(dlamrg,DLAMRG)((void*) n1, (void*) n2, (void*) a, (void*) dtrd1, (void*) dtrd2, (void*) index_bn); }
void FC_GLOBAL3(dlamrg,DLAMRG)(blasint* n1, blasint* n2, double* a, blasint* dtrd1, blasint* dtrd2, blasint* index_bn){ FC_GLOBAL(dlamrg,DLAMRG)((void*) n1, (void*) n2, (void*) a, (void*) dtrd1, (void*) dtrd2, (void*) index_bn); }
#endif
