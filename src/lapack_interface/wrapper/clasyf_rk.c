...
#endif
{
	...
	fn = current_backend->lapack.clasyf_rk.f77_blas_function; 
	fn_hook = __flexiblas_hooks->clasyf_rk.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void flexiblas_real_clasyf_rk_(void* uplo, void* n, void* nb, void* kb, void* a, void* lda, void* e, void* ipiv, void* w, void* ldw, void* info)
{
	void (*fn) (void* uplo, void* n, void* nb, void* kb, void* a, void* lda, void* e, void* ipiv, void* w, void* ldw, void* info);
...
void flexiblas_chain_clasyf_rk_(void* uplo, void* n, void* nb, void* kb, void* a, void* lda, void* e, void* ipiv, void* w, void* ldw, void* info)
{
	void (*fn) (void* uplo, void* n, void* nb, void* kb, void* a, void* lda, void* e, void* ipiv, void* w, void* ldw, void* info);
	void (*fn_hook) (void* uplo, void* n, void* nb, void* kb, void* a, void* lda, void* e, void* ipiv, void* w, void* ldw, void* info);
    ...
    if( hook_pos_clasyf_rk < __flexiblas_hooks->clasyf_rk.nhook) {
        fn_hook = __flexiblas_hooks->clasyf_rk.f77_hook_function[hook_pos_clasyf_rk];
        fn_hook((void*) uplo, (void*) n, (void*) nb, (void*) kb, (void*) a, (void*) lda, (void*) e, (void*) ipiv, (void*) w, (void*) ldw, (void*) info);
    } else {
        hook_pos_clasyf_rk = 0;
		fn((void*) uplo, (void*) n, (void*) nb, (void*) kb, (void*) a, (void*) lda, (void*) e, (void*) ipiv, (void*) w, (void*) ldw, (void*) info); 
