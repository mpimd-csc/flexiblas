...
#endif
{
	...
	fn = current_backend->lapack.zgeequ.f77_blas_function; 
	fn_hook = __flexiblas_hooks->zgeequ.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void zgeequ_(blasint* m, blasint* n, double complex* a, blasint* lda, double* r, double* c, double* rowcnd, double* colcnd, double* amax, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgeequ,ZGEEQU)))));
#else
#ifndef __APPLE__
void zgeequ(blasint* m, blasint* n, double complex* a, blasint* lda, double* r, double* c, double* rowcnd, double* colcnd, double* amax, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgeequ,ZGEEQU)))));
#else
void zgeequ(blasint* m, blasint* n, double complex* a, blasint* lda, double* r, double* c, double* rowcnd, double* colcnd, double* amax, blasint* info){ FC_GLOBAL(zgeequ,ZGEEQU)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) r, (void*) c, (void*) rowcnd, (void*) colcnd, (void*) amax, (void*) info); }
#endif
#endif
...
void flexiblas_chain_zgeequ_(void* m, void* n, void* a, void* lda, void* r, void* c, void* rowcnd, void* colcnd, void* amax, void* info)
{
    ...
    if( hook_pos_zgeequ < __flexiblas_hooks->zgeequ.nhook) {
        fn_hook = __flexiblas_hooks->zgeequ.f77_hook_function[hook_pos_zgeequ];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) r, (void*) c, (void*) rowcnd, (void*) colcnd, (void*) amax, (void*) info);
    } else {
        hook_pos_zgeequ = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) r, (void*) c, (void*) rowcnd, (void*) colcnd, (void*) amax, (void*) info); 
