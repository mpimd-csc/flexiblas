...
#endif
{
	...
	fn = current_backend->lapack.cungqr.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cungqr.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cungqr_(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cungqr,CUNGQR)))));
#else
#ifndef __APPLE__
void cungqr(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cungqr,CUNGQR)))));
#else
void cungqr(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info){ FC_GLOBAL(cungqr,CUNGQR)((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cungqr_(void* m, void* n, void* k, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_cungqr < __flexiblas_hooks->cungqr.nhook) {
        fn_hook = __flexiblas_hooks->cungqr.f77_hook_function[hook_pos_cungqr];
        fn_hook((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_cungqr = 0;
		fn((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
