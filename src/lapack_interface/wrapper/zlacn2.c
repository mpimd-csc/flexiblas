...
#ifndef __APPLE__
void FC_GLOBAL2(zlacn2,ZLACN2)(blasint* n, double complex* v, double complex* x, double* est, blasint* kase, blasint* isave) __attribute__((alias(MTS(FC_GLOBAL(zlacn2,ZLACN2)))));
void FC_GLOBAL3(zlacn2,ZLACN2)(blasint* n, double complex* v, double complex* x, double* est, blasint* kase, blasint* isave) __attribute__((alias(MTS(FC_GLOBAL(zlacn2,ZLACN2)))));
#else
void FC_GLOBAL2(zlacn2,ZLACN2)(blasint* n, double complex* v, double complex* x, double* est, blasint* kase, blasint* isave){ FC_GLOBAL(zlacn2,ZLACN2)((void*) n, (void*) v, (void*) x, (void*) est, (void*) kase, (void*) isave); }
void FC_GLOBAL3(zlacn2,ZLACN2)(blasint* n, double complex* v, double complex* x, double* est, blasint* kase, blasint* isave){ FC_GLOBAL(zlacn2,ZLACN2)((void*) n, (void*) v, (void*) x, (void*) est, (void*) kase, (void*) isave); }
#endif
