...
#endif
{
	...
	fn = current_backend->lapack.stplqt.f77_blas_function; 
	fn_hook = __flexiblas_hooks->stplqt.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void stplqt_(blasint* m, blasint* n, blasint* l, blasint* mb, float* a, blasint* lda, float* b, blasint* ldb, float* t, blasint* ldt, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(stplqt,STPLQT)))));
#else
#ifndef __APPLE__
void stplqt(blasint* m, blasint* n, blasint* l, blasint* mb, float* a, blasint* lda, float* b, blasint* ldb, float* t, blasint* ldt, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(stplqt,STPLQT)))));
#else
void stplqt(blasint* m, blasint* n, blasint* l, blasint* mb, float* a, blasint* lda, float* b, blasint* ldb, float* t, blasint* ldt, float* work, blasint* info){ FC_GLOBAL(stplqt,STPLQT)((void*) m, (void*) n, (void*) l, (void*) mb, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_stplqt_(void* m, void* n, void* l, void* mb, void* a, void* lda, void* b, void* ldb, void* t, void* ldt, void* work, void* info)
{
    ...
    if( hook_pos_stplqt < __flexiblas_hooks->stplqt.nhook) {
        fn_hook = __flexiblas_hooks->stplqt.f77_hook_function[hook_pos_stplqt];
        fn_hook((void*) m, (void*) n, (void*) l, (void*) mb, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) work, (void*) info);
    } else {
        hook_pos_stplqt = 0;
		fn((void*) m, (void*) n, (void*) l, (void*) mb, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) work, (void*) info); 
