...
#ifndef __APPLE__
void FC_GLOBAL2(dlae2,DLAE2)(double* a, double* b, double* c, double* rt1, double* rt2) __attribute__((alias(MTS(FC_GLOBAL(dlae2,DLAE2)))));
void FC_GLOBAL3(dlae2,DLAE2)(double* a, double* b, double* c, double* rt1, double* rt2) __attribute__((alias(MTS(FC_GLOBAL(dlae2,DLAE2)))));
#else
void FC_GLOBAL2(dlae2,DLAE2)(double* a, double* b, double* c, double* rt1, double* rt2){ FC_GLOBAL(dlae2,DLAE2)((void*) a, (void*) b, (void*) c, (void*) rt1, (void*) rt2); }
void FC_GLOBAL3(dlae2,DLAE2)(double* a, double* b, double* c, double* rt1, double* rt2){ FC_GLOBAL(dlae2,DLAE2)((void*) a, (void*) b, (void*) c, (void*) rt1, (void*) rt2); }
#endif
