...
#endif
{
	...
	fn = current_backend->lapack.cgeqrt3.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgeqrt3.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgeqrt3_(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeqrt3,CGEQRT3)))));
#else
#ifndef __APPLE__
void cgeqrt3(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeqrt3,CGEQRT3)))));
#else
void cgeqrt3(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* t, blasint* ldt, blasint* info){ FC_GLOBAL(cgeqrt3,CGEQRT3)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgeqrt3_(void* m, void* n, void* a, void* lda, void* t, void* ldt, void* info)
{
    ...
    if( hook_pos_cgeqrt3 < __flexiblas_hooks->cgeqrt3.nhook) {
        fn_hook = __flexiblas_hooks->cgeqrt3.f77_hook_function[hook_pos_cgeqrt3];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info);
    } else {
        hook_pos_cgeqrt3 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info); 
