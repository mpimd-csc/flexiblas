...
#endif
{
	...
	fn = current_backend->lapack.cungl2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cungl2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cungl2_(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cungl2,CUNGL2)))));
#else
#ifndef __APPLE__
void cungl2(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cungl2,CUNGL2)))));
#else
void cungl2(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info){ FC_GLOBAL(cungl2,CUNGL2)((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cungl2_(void* m, void* n, void* k, void* a, void* lda, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_cungl2 < __flexiblas_hooks->cungl2.nhook) {
        fn_hook = __flexiblas_hooks->cungl2.f77_hook_function[hook_pos_cungl2];
        fn_hook((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_cungl2 = 0;
		fn((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); 
