...
#endif
{
	...
	fn = current_backend->lapack.sgetsqrhrt.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgetsqrhrt.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgetsqrhrt_(blasint* m, blasint* n, blasint* mb1, blasint* nb1, blasint* nb2, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgetsqrhrt,SGETSQRHRT)))));
#else
#ifndef __APPLE__
void sgetsqrhrt(blasint* m, blasint* n, blasint* mb1, blasint* nb1, blasint* nb2, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgetsqrhrt,SGETSQRHRT)))));
#else
void sgetsqrhrt(blasint* m, blasint* n, blasint* mb1, blasint* nb1, blasint* nb2, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sgetsqrhrt,SGETSQRHRT)((void*) m, (void*) n, (void*) mb1, (void*) nb1, (void*) nb2, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgetsqrhrt_(void* m, void* n, void* mb1, void* nb1, void* nb2, void* a, void* lda, void* t, void* ldt, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_sgetsqrhrt < __flexiblas_hooks->sgetsqrhrt.nhook) {
        fn_hook = __flexiblas_hooks->sgetsqrhrt.f77_hook_function[hook_pos_sgetsqrhrt];
        fn_hook((void*) m, (void*) n, (void*) mb1, (void*) nb1, (void*) nb2, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_sgetsqrhrt = 0;
		fn((void*) m, (void*) n, (void*) mb1, (void*) nb1, (void*) nb2, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info); 
