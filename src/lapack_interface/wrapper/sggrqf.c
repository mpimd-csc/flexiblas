...
#endif
{
	...
	fn = current_backend->lapack.sggrqf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sggrqf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sggrqf_(blasint* m, blasint* p, blasint* n, float* a, blasint* lda, float* taua, float* b, blasint* ldb, float* taub, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sggrqf,SGGRQF)))));
#else
#ifndef __APPLE__
void sggrqf(blasint* m, blasint* p, blasint* n, float* a, blasint* lda, float* taua, float* b, blasint* ldb, float* taub, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sggrqf,SGGRQF)))));
#else
void sggrqf(blasint* m, blasint* p, blasint* n, float* a, blasint* lda, float* taua, float* b, blasint* ldb, float* taub, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sggrqf,SGGRQF)((void*) m, (void*) p, (void*) n, (void*) a, (void*) lda, (void*) taua, (void*) b, (void*) ldb, (void*) taub, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sggrqf_(void* m, void* p, void* n, void* a, void* lda, void* taua, void* b, void* ldb, void* taub, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_sggrqf < __flexiblas_hooks->sggrqf.nhook) {
        fn_hook = __flexiblas_hooks->sggrqf.f77_hook_function[hook_pos_sggrqf];
        fn_hook((void*) m, (void*) p, (void*) n, (void*) a, (void*) lda, (void*) taua, (void*) b, (void*) ldb, (void*) taub, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_sggrqf = 0;
		fn((void*) m, (void*) p, (void*) n, (void*) a, (void*) lda, (void*) taua, (void*) b, (void*) ldb, (void*) taub, (void*) work, (void*) lwork, (void*) info); 
