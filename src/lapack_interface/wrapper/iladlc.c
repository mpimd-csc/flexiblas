...
#endif
{
	...
	fn = current_backend->lapack.iladlc.f77_blas_function; 
	fn_hook = __flexiblas_hooks->iladlc.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
blasint flexiblas_chain_iladlc_(void* m, void* n, void* a, void* lda)
{
    ...
    if( hook_pos_iladlc < __flexiblas_hooks->iladlc.nhook) {
        fn_hook = __flexiblas_hooks->iladlc.f77_hook_function[hook_pos_iladlc];
        ret = fn_hook((void*) m, (void*) n, (void*) a, (void*) lda);
    } else {
        hook_pos_iladlc = 0;
		ret = fn((void*) m, (void*) n, (void*) a, (void*) lda); 
