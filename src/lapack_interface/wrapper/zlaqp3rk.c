...
#else
#ifndef __APPLE__
void zlaqp3rk(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* nb, double* abstol, double* reltol, blasint* kp1, double* maxc2nrm, double complex* a, blasint* lda, blasint* done, blasint* kb, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, double complex* tau, double* vn1, double* vn2, double complex* auxv, double complex* f, blasint* ldf, blasint* iwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zlaqp3rk,ZLAQP3RK)))));
#else
