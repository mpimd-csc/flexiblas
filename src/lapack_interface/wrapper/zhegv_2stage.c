...
#endif 
{
	...
	fn = current_backend->lapack.zhegv_2stage.call_fblas; 
	if ( __flexiblas_profile ) {
		...
		current_backend->lapack.zhegv_2stage.timings[0] += (flexiblas_wtime() -ts);
		current_backend->lapack.zhegv_2stage.calls[0]++;
	} else { 
		fn((void*) itype, (void*) jobz, (void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) w, (void*) work, (void*) lwork, (void*) rwork, (void*) info); 
	} 
	return;
