...
#ifndef __APPLE__
void FC_GLOBAL2(zgeqp3rk,ZGEQP3RK)(blasint* m, blasint* n, blasint* nrhs, blasint* kmax, double* abstol, double* reltol, double complex* a, blasint* lda, blasint* k, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, double complex* tau, double complex* work, blasint* lwork, double* rwork, blasint* iwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgeqp3rk,ZGEQP3RK)))));
void FC_GLOBAL3(zgeqp3rk,ZGEQP3RK)(blasint* m, blasint* n, blasint* nrhs, blasint* kmax, double* abstol, double* reltol, double complex* a, blasint* lda, blasint* k, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, double complex* tau, double complex* work, blasint* lwork, double* rwork, blasint* iwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgeqp3rk,ZGEQP3RK)))));
#else
