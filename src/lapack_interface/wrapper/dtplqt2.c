...
#endif
{
	...
	fn = current_backend->lapack.dtplqt2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->dtplqt2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void dtplqt2_(blasint* m, blasint* n, blasint* l, double* a, blasint* lda, double* b, blasint* ldb, double* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dtplqt2,DTPLQT2)))));
#else
#ifndef __APPLE__
void dtplqt2(blasint* m, blasint* n, blasint* l, double* a, blasint* lda, double* b, blasint* ldb, double* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dtplqt2,DTPLQT2)))));
#else
void dtplqt2(blasint* m, blasint* n, blasint* l, double* a, blasint* lda, double* b, blasint* ldb, double* t, blasint* ldt, blasint* info){ FC_GLOBAL(dtplqt2,DTPLQT2)((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) info); }
#endif
#endif
...
void flexiblas_chain_dtplqt2_(void* m, void* n, void* l, void* a, void* lda, void* b, void* ldb, void* t, void* ldt, void* info)
{
    ...
    if( hook_pos_dtplqt2 < __flexiblas_hooks->dtplqt2.nhook) {
        fn_hook = __flexiblas_hooks->dtplqt2.f77_hook_function[hook_pos_dtplqt2];
        fn_hook((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) info);
    } else {
        hook_pos_dtplqt2 = 0;
		fn((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) info); 
