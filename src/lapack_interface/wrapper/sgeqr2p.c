...
#endif
{
	...
	fn = current_backend->lapack.sgeqr2p.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgeqr2p.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgeqr2p_(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqr2p,SGEQR2P)))));
#else
#ifndef __APPLE__
void sgeqr2p(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqr2p,SGEQR2P)))));
#else
void sgeqr2p(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* info){ FC_GLOBAL(sgeqr2p,SGEQR2P)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgeqr2p_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_sgeqr2p < __flexiblas_hooks->sgeqr2p.nhook) {
        fn_hook = __flexiblas_hooks->sgeqr2p.f77_hook_function[hook_pos_sgeqr2p];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_sgeqr2p = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); 
