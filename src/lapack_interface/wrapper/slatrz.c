...
#else
void slatrz(blasint* m, blasint* n, blasint* l, float* a, blasint* lda, float* tau, float* work){ FC_GLOBAL(slatrz,SLATRZ)((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) tau, (void*) work); }
#endif
#endif
