...
#ifndef __APPLE__
void FC_GLOBAL2(dlaqp2rk,DLAQP2RK)(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* kmax, double* abstol, double* reltol, blasint* kp1, double* maxc2nrm, double* a, blasint* lda, blasint* k, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, double* tau, double* vn1, double* vn2, double* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dlaqp2rk,DLAQP2RK)))));
void FC_GLOBAL3(dlaqp2rk,DLAQP2RK)(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* kmax, double* abstol, double* reltol, blasint* kp1, double* maxc2nrm, double* a, blasint* lda, blasint* k, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, double* tau, double* vn1, double* vn2, double* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dlaqp2rk,DLAQP2RK)))));
#else
