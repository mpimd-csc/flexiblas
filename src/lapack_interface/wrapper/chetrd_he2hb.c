...
#endif 
{
	...
	fn = current_backend->lapack.chetrd_he2hb.call_fblas; 
	if ( __flexiblas_profile ) {
		ts = flexiblas_wtime(); 
		fn((void*) uplo, (void*) n, (void*) kd, (void*) a, (void*) lda, (void*) ab, (void*) ldab, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
		current_backend->lapack.chetrd_he2hb.timings[0] += (flexiblas_wtime() -ts);
		current_backend->lapack.chetrd_he2hb.calls[0]++;
	} else { 
		fn((void*) uplo, (void*) n, (void*) kd, (void*) a, (void*) lda, (void*) ab, (void*) ldab, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
	} 
	return;
