...
#ifndef __APPLE__
void FC_GLOBAL2(dptts2,DPTTS2)(blasint* n, blasint* nrhs, double* d, double* e, double* b, blasint* ldb) __attribute__((alias(MTS(FC_GLOBAL(dptts2,DPTTS2)))));
void FC_GLOBAL3(dptts2,DPTTS2)(blasint* n, blasint* nrhs, double* d, double* e, double* b, blasint* ldb) __attribute__((alias(MTS(FC_GLOBAL(dptts2,DPTTS2)))));
#else
void FC_GLOBAL2(dptts2,DPTTS2)(blasint* n, blasint* nrhs, double* d, double* e, double* b, blasint* ldb){ FC_GLOBAL(dptts2,DPTTS2)((void*) n, (void*) nrhs, (void*) d, (void*) e, (void*) b, (void*) ldb); }
void FC_GLOBAL3(dptts2,DPTTS2)(blasint* n, blasint* nrhs, double* d, double* e, double* b, blasint* ldb){ FC_GLOBAL(dptts2,DPTTS2)((void*) n, (void*) nrhs, (void*) d, (void*) e, (void*) b, (void*) ldb); }
#endif
