...
#ifndef __APPLE__
void FC_GLOBAL2(zlaein,ZLAEIN)(blaslogical* rightv, blaslogical* noinit, blasint* n, double complex* h, blasint* ldh, double complex* w, double complex* v, double complex* b, blasint* ldb, double* rwork, double* eps3, double* smlnum, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zlaein,ZLAEIN)))));
void FC_GLOBAL3(zlaein,ZLAEIN)(blaslogical* rightv, blaslogical* noinit, blasint* n, double complex* h, blasint* ldh, double complex* w, double complex* v, double complex* b, blasint* ldb, double* rwork, double* eps3, double* smlnum, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zlaein,ZLAEIN)))));
#else
void FC_GLOBAL2(zlaein,ZLAEIN)(blaslogical* rightv, blaslogical* noinit, blasint* n, double complex* h, blasint* ldh, double complex* w, double complex* v, double complex* b, blasint* ldb, double* rwork, double* eps3, double* smlnum, blasint* info){ FC_GLOBAL(zlaein,ZLAEIN)((void*) rightv, (void*) noinit, (void*) n, (void*) h, (void*) ldh, (void*) w, (void*) v, (void*) b, (void*) ldb, (void*) rwork, (void*) eps3, (void*) smlnum, (void*) info); }
void FC_GLOBAL3(zlaein,ZLAEIN)(blaslogical* rightv, blaslogical* noinit, blasint* n, double complex* h, blasint* ldh, double complex* w, double complex* v, double complex* b, blasint* ldb, double* rwork, double* eps3, double* smlnum, blasint* info){ FC_GLOBAL(zlaein,ZLAEIN)((void*) rightv, (void*) noinit, (void*) n, (void*) h, (void*) ldh, (void*) w, (void*) v, (void*) b, (void*) ldb, (void*) rwork, (void*) eps3, (void*) smlnum, (void*) info); }
#endif
