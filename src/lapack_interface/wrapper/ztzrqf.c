...
#else
void ztzrqf(blasint* m, blasint* n, double complex* a, blasint* lda, double complex* tau, blasint* info){ FC_GLOBAL(ztzrqf,ZTZRQF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) info); }
#endif
#endif
