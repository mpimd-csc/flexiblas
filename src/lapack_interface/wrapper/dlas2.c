...
#ifndef __APPLE__
void FC_GLOBAL2(dlas2,DLAS2)(double* f, double* g, double* h, double* ssmin, double* ssmax) __attribute__((alias(MTS(FC_GLOBAL(dlas2,DLAS2)))));
void FC_GLOBAL3(dlas2,DLAS2)(double* f, double* g, double* h, double* ssmin, double* ssmax) __attribute__((alias(MTS(FC_GLOBAL(dlas2,DLAS2)))));
#else
void FC_GLOBAL2(dlas2,DLAS2)(double* f, double* g, double* h, double* ssmin, double* ssmax){ FC_GLOBAL(dlas2,DLAS2)((void*) f, (void*) g, (void*) h, (void*) ssmin, (void*) ssmax); }
void FC_GLOBAL3(dlas2,DLAS2)(double* f, double* g, double* h, double* ssmin, double* ssmax){ FC_GLOBAL(dlas2,DLAS2)((void*) f, (void*) g, (void*) h, (void*) ssmin, (void*) ssmax); }
#endif
