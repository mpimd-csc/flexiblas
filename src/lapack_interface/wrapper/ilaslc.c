...
#endif
{
	...
	fn = current_backend->lapack.ilaslc.f77_blas_function; 
	fn_hook = __flexiblas_hooks->ilaslc.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
int ilaslc_(blasint* m, blasint* n, float* a, blasint* lda) __attribute__((alias(MTS(FC_GLOBAL(ilaslc,ILASLC)))));
#else
#ifndef __APPLE__
int ilaslc(blasint* m, blasint* n, float* a, blasint* lda) __attribute__((alias(MTS(FC_GLOBAL(ilaslc,ILASLC)))));
#else
int ilaslc(blasint* m, blasint* n, float* a, blasint* lda){ return FC_GLOBAL(ilaslc,ILASLC)((void*) m, (void*) n, (void*) a, (void*) lda); }
#endif
#endif
...
blasint flexiblas_chain_ilaslc_(void* m, void* n, void* a, void* lda)
{
    ...
    if( hook_pos_ilaslc < __flexiblas_hooks->ilaslc.nhook) {
        fn_hook = __flexiblas_hooks->ilaslc.f77_hook_function[hook_pos_ilaslc];
        ret = fn_hook((void*) m, (void*) n, (void*) a, (void*) lda);
    } else {
        hook_pos_ilaslc = 0;
		ret = fn((void*) m, (void*) n, (void*) a, (void*) lda); 
