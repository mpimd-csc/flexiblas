...
#endif
{
	...
	fn = current_backend->lapack.ctplqt2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->ctplqt2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void ctplqt2_(blasint* m, blasint* n, blasint* l, float complex* a, blasint* lda, float complex* b, blasint* ldb, float complex* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(ctplqt2,CTPLQT2)))));
#else
#ifndef __APPLE__
void ctplqt2(blasint* m, blasint* n, blasint* l, float complex* a, blasint* lda, float complex* b, blasint* ldb, float complex* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(ctplqt2,CTPLQT2)))));
#else
void ctplqt2(blasint* m, blasint* n, blasint* l, float complex* a, blasint* lda, float complex* b, blasint* ldb, float complex* t, blasint* ldt, blasint* info){ FC_GLOBAL(ctplqt2,CTPLQT2)((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) info); }
#endif
#endif
...
void flexiblas_chain_ctplqt2_(void* m, void* n, void* l, void* a, void* lda, void* b, void* ldb, void* t, void* ldt, void* info)
{
    ...
    if( hook_pos_ctplqt2 < __flexiblas_hooks->ctplqt2.nhook) {
        fn_hook = __flexiblas_hooks->ctplqt2.f77_hook_function[hook_pos_ctplqt2];
        fn_hook((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) info);
    } else {
        hook_pos_ctplqt2 = 0;
		fn((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) info); 
