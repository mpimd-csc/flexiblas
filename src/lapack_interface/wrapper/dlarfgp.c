...
#endif
{
	...
	fn = current_backend->lapack.dlarfgp.f77_blas_function; 
	fn_hook = __flexiblas_hooks->dlarfgp.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void dlarfgp_(blasint* n, double* alpha, double* x, blasint* incx, double* tau) __attribute__((alias(MTS(FC_GLOBAL(dlarfgp,DLARFGP)))));
#else
#ifndef __APPLE__
void dlarfgp(blasint* n, double* alpha, double* x, blasint* incx, double* tau) __attribute__((alias(MTS(FC_GLOBAL(dlarfgp,DLARFGP)))));
#else
void dlarfgp(blasint* n, double* alpha, double* x, blasint* incx, double* tau){ FC_GLOBAL(dlarfgp,DLARFGP)((void*) n, (void*) alpha, (void*) x, (void*) incx, (void*) tau); }
#endif
#endif
...
void flexiblas_chain_dlarfgp_(void* n, void* alpha, void* x, void* incx, void* tau)
{
    ...
    if( hook_pos_dlarfgp < __flexiblas_hooks->dlarfgp.nhook) {
        fn_hook = __flexiblas_hooks->dlarfgp.f77_hook_function[hook_pos_dlarfgp];
        fn_hook((void*) n, (void*) alpha, (void*) x, (void*) incx, (void*) tau);
    } else {
        hook_pos_dlarfgp = 0;
		fn((void*) n, (void*) alpha, (void*) x, (void*) incx, (void*) tau); 
