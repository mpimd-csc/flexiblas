...
#endif
{
	...
	fn = current_backend->lapack.cggqrf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cggqrf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cggqrf_(blasint* n, blasint* m, blasint* p, float complex* a, blasint* lda, float complex* taua, float complex* b, blasint* ldb, float complex* taub, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cggqrf,CGGQRF)))));
#else
#ifndef __APPLE__
void cggqrf(blasint* n, blasint* m, blasint* p, float complex* a, blasint* lda, float complex* taua, float complex* b, blasint* ldb, float complex* taub, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cggqrf,CGGQRF)))));
#else
void cggqrf(blasint* n, blasint* m, blasint* p, float complex* a, blasint* lda, float complex* taua, float complex* b, blasint* ldb, float complex* taub, float complex* work, blasint* lwork, blasint* info){ FC_GLOBAL(cggqrf,CGGQRF)((void*) n, (void*) m, (void*) p, (void*) a, (void*) lda, (void*) taua, (void*) b, (void*) ldb, (void*) taub, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cggqrf_(void* n, void* m, void* p, void* a, void* lda, void* taua, void* b, void* ldb, void* taub, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_cggqrf < __flexiblas_hooks->cggqrf.nhook) {
        fn_hook = __flexiblas_hooks->cggqrf.f77_hook_function[hook_pos_cggqrf];
        fn_hook((void*) n, (void*) m, (void*) p, (void*) a, (void*) lda, (void*) taua, (void*) b, (void*) ldb, (void*) taub, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_cggqrf = 0;
		fn((void*) n, (void*) m, (void*) p, (void*) a, (void*) lda, (void*) taua, (void*) b, (void*) ldb, (void*) taub, (void*) work, (void*) lwork, (void*) info); 
