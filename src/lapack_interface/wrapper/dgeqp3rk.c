...
#ifndef __APPLE__
void FC_GLOBAL2(dgeqp3rk,DGEQP3RK)(blasint* m, blasint* n, blasint* nrhs, blasint* kmax, double* abstol, double* reltol, double* a, blasint* lda, blasint* k, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, double* tau, double* work, blasint* lwork, blasint* iwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgeqp3rk,DGEQP3RK)))));
void FC_GLOBAL3(dgeqp3rk,DGEQP3RK)(blasint* m, blasint* n, blasint* nrhs, blasint* kmax, double* abstol, double* reltol, double* a, blasint* lda, blasint* k, double* maxc2nrmk, double* relmaxc2nrmk, blasint* jpiv, double* tau, double* work, blasint* lwork, blasint* iwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgeqp3rk,DGEQP3RK)))));
#else
