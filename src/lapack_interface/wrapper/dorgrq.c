...
#endif
{
	...
	fn = current_backend->lapack.dorgrq.f77_blas_function; 
	fn_hook = __flexiblas_hooks->dorgrq.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void dorgrq_(blasint* m, blasint* n, blasint* k, double* a, blasint* lda, double* tau, double* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dorgrq,DORGRQ)))));
#else
#ifndef __APPLE__
void dorgrq(blasint* m, blasint* n, blasint* k, double* a, blasint* lda, double* tau, double* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dorgrq,DORGRQ)))));
#else
void dorgrq(blasint* m, blasint* n, blasint* k, double* a, blasint* lda, double* tau, double* work, blasint* lwork, blasint* info){ FC_GLOBAL(dorgrq,DORGRQ)((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_dorgrq_(void* m, void* n, void* k, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_dorgrq < __flexiblas_hooks->dorgrq.nhook) {
        fn_hook = __flexiblas_hooks->dorgrq.f77_hook_function[hook_pos_dorgrq];
        fn_hook((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_dorgrq = 0;
		fn((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
