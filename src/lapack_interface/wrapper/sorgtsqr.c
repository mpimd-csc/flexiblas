...
#endif
{
	...
	fn = current_backend->lapack.sorgtsqr.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sorgtsqr.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sorgtsqr_(blasint* m, blasint* n, blasint* mb, blasint* nb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sorgtsqr,SORGTSQR)))));
#else
#ifndef __APPLE__
void sorgtsqr(blasint* m, blasint* n, blasint* mb, blasint* nb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sorgtsqr,SORGTSQR)))));
#else
void sorgtsqr(blasint* m, blasint* n, blasint* mb, blasint* nb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sorgtsqr,SORGTSQR)((void*) m, (void*) n, (void*) mb, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sorgtsqr_(void* m, void* n, void* mb, void* nb, void* a, void* lda, void* t, void* ldt, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_sorgtsqr < __flexiblas_hooks->sorgtsqr.nhook) {
        fn_hook = __flexiblas_hooks->sorgtsqr.f77_hook_function[hook_pos_sorgtsqr];
        fn_hook((void*) m, (void*) n, (void*) mb, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_sorgtsqr = 0;
		fn((void*) m, (void*) n, (void*) mb, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info); 
