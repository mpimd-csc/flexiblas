...
#ifndef __APPLE__
void FC_GLOBAL2(zgeqrt2,ZGEQRT2)(blasint* m, blasint* n, double complex* a, blasint* lda, double complex* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgeqrt2,ZGEQRT2)))));
void FC_GLOBAL3(zgeqrt2,ZGEQRT2)(blasint* m, blasint* n, double complex* a, blasint* lda, double complex* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgeqrt2,ZGEQRT2)))));
#else
void FC_GLOBAL2(zgeqrt2,ZGEQRT2)(blasint* m, blasint* n, double complex* a, blasint* lda, double complex* t, blasint* ldt, blasint* info){ FC_GLOBAL(zgeqrt2,ZGEQRT2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info); }
void FC_GLOBAL3(zgeqrt2,ZGEQRT2)(blasint* m, blasint* n, double complex* a, blasint* lda, double complex* t, blasint* ldt, blasint* info){ FC_GLOBAL(zgeqrt2,ZGEQRT2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info); }
#endif
