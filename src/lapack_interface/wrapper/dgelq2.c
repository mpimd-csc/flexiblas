...
#else
void dgelq2(blasint* m, blasint* n, double* a, blasint* lda, double* tau, double* work, blasint* info){ FC_GLOBAL(dgelq2,DGELQ2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
