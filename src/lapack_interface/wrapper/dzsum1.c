...
#ifndef __APPLE__
double FC_GLOBAL2(dzsum1,DZSUM1)(blasint* n, double complex* cx, blasint* incx) __attribute__((alias(MTS(FC_GLOBAL(dzsum1,DZSUM1)))));
double FC_GLOBAL3(dzsum1,DZSUM1)(blasint* n, double complex* cx, blasint* incx) __attribute__((alias(MTS(FC_GLOBAL(dzsum1,DZSUM1)))));
#else
double FC_GLOBAL2(dzsum1,DZSUM1)(blasint* n, double complex* cx, blasint* incx){ return FC_GLOBAL(dzsum1,DZSUM1)((void*) n, (void*) cx, (void*) incx); }
double FC_GLOBAL3(dzsum1,DZSUM1)(blasint* n, double complex* cx, blasint* incx){ return FC_GLOBAL(dzsum1,DZSUM1)((void*) n, (void*) cx, (void*) incx); }
#endif
