...
#endif
{
	...
	fn = current_backend->lapack.cgeqlf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgeqlf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgeqlf_(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeqlf,CGEQLF)))));
#else
#ifndef __APPLE__
void cgeqlf(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeqlf,CGEQLF)))));
#else
void cgeqlf(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* lwork, blasint* info){ FC_GLOBAL(cgeqlf,CGEQLF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgeqlf_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_cgeqlf < __flexiblas_hooks->cgeqlf.nhook) {
        fn_hook = __flexiblas_hooks->cgeqlf.f77_hook_function[hook_pos_cgeqlf];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_cgeqlf = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
