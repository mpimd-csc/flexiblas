...
#endif
{
	...
	fn = current_backend->lapack.sgeqr2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgeqr2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgeqr2_(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqr2,SGEQR2)))));
#else
#ifndef __APPLE__
void sgeqr2(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqr2,SGEQR2)))));
#else
void sgeqr2(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* info){ FC_GLOBAL(sgeqr2,SGEQR2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgeqr2_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_sgeqr2 < __flexiblas_hooks->sgeqr2.nhook) {
        fn_hook = __flexiblas_hooks->sgeqr2.f77_hook_function[hook_pos_sgeqr2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_sgeqr2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); 
