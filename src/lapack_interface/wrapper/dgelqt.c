...
void dgelqt_(blasint* m, blasint* n, blasint* mb, double* a, blasint* lda, double* t, blasint* ldt, double* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgelqt,DGELQT)))));
#else
#ifndef __APPLE__
void dgelqt(blasint* m, blasint* n, blasint* mb, double* a, blasint* lda, double* t, blasint* ldt, double* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgelqt,DGELQT)))));
#else
void dgelqt(blasint* m, blasint* n, blasint* mb, double* a, blasint* lda, double* t, blasint* ldt, double* work, blasint* info){ FC_GLOBAL(dgelqt,DGELQT)((void*) m, (void*) n, (void*) mb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info); }
#endif
#endif
