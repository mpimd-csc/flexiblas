...
#ifndef __APPLE__
void FC_GLOBAL2(zlargv,ZLARGV)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* c, blasint* incc) __attribute__((alias(MTS(FC_GLOBAL(zlargv,ZLARGV)))));
void FC_GLOBAL3(zlargv,ZLARGV)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* c, blasint* incc) __attribute__((alias(MTS(FC_GLOBAL(zlargv,ZLARGV)))));
#else
void FC_GLOBAL2(zlargv,ZLARGV)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* c, blasint* incc){ FC_GLOBAL(zlargv,ZLARGV)((void*) n, (void*) x, (void*) incx, (void*) y, (void*) incy, (void*) c, (void*) incc); }
void FC_GLOBAL3(zlargv,ZLARGV)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* c, blasint* incc){ FC_GLOBAL(zlargv,ZLARGV)((void*) n, (void*) x, (void*) incx, (void*) y, (void*) incy, (void*) c, (void*) incc); }
#endif
