...
void chetrf_aa_2stage_(char* uplo, blasint* n, float complex* a, blasint* lda, float complex* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, float complex* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(chetrf_aa_2stage,CHETRF_AA_2STAGE)))));
#else
#ifndef __APPLE__
void chetrf_aa_2stage(char* uplo, blasint* n, float complex* a, blasint* lda, float complex* tb, blasint* ltb, blasint* ipiv, blasint* ipiv2, float complex* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(chetrf_aa_2stage,CHETRF_AA_2STAGE)))));
#else
