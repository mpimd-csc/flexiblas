...
#endif
{
	...
	fn = current_backend->lapack.cgeql2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgeql2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgeql2_(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeql2,CGEQL2)))));
#else
#ifndef __APPLE__
void cgeql2(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeql2,CGEQL2)))));
#else
void cgeql2(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info){ FC_GLOBAL(cgeql2,CGEQL2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgeql2_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_cgeql2 < __flexiblas_hooks->cgeql2.nhook) {
        fn_hook = __flexiblas_hooks->cgeql2.f77_hook_function[hook_pos_cgeql2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_cgeql2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); 
