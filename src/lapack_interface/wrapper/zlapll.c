...
#ifndef __APPLE__
void FC_GLOBAL2(zlapll,ZLAPLL)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* ssmin) __attribute__((alias(MTS(FC_GLOBAL(zlapll,ZLAPLL)))));
void FC_GLOBAL3(zlapll,ZLAPLL)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* ssmin) __attribute__((alias(MTS(FC_GLOBAL(zlapll,ZLAPLL)))));
#else
void FC_GLOBAL2(zlapll,ZLAPLL)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* ssmin){ FC_GLOBAL(zlapll,ZLAPLL)((void*) n, (void*) x, (void*) incx, (void*) y, (void*) incy, (void*) ssmin); }
void FC_GLOBAL3(zlapll,ZLAPLL)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* ssmin){ FC_GLOBAL(zlapll,ZLAPLL)((void*) n, (void*) x, (void*) incx, (void*) y, (void*) incy, (void*) ssmin); }
#endif
