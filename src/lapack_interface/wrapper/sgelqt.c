...
#endif
{
	...
	fn = current_backend->lapack.sgelqt.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgelqt.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgelqt_(blasint* m, blasint* n, blasint* mb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgelqt,SGELQT)))));
#else
#ifndef __APPLE__
void sgelqt(blasint* m, blasint* n, blasint* mb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgelqt,SGELQT)))));
#else
void sgelqt(blasint* m, blasint* n, blasint* mb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* info){ FC_GLOBAL(sgelqt,SGELQT)((void*) m, (void*) n, (void*) mb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgelqt_(void* m, void* n, void* mb, void* a, void* lda, void* t, void* ldt, void* work, void* info)
{
    ...
    if( hook_pos_sgelqt < __flexiblas_hooks->sgelqt.nhook) {
        fn_hook = __flexiblas_hooks->sgelqt.f77_hook_function[hook_pos_sgelqt];
        fn_hook((void*) m, (void*) n, (void*) mb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info);
    } else {
        hook_pos_sgelqt = 0;
		fn((void*) m, (void*) n, (void*) mb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info); 
