...
#endif
{
	...
	fn = current_backend->lapack.dgebd2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->dgebd2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void flexiblas_chain_dgebd2_(void* m, void* n, void* a, void* lda, void* d, void* e, void* tauq, void* taup, void* work, void* info)
{
    ...
    if( hook_pos_dgebd2 < __flexiblas_hooks->dgebd2.nhook) {
        fn_hook = __flexiblas_hooks->dgebd2.f77_hook_function[hook_pos_dgebd2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tauq, (void*) taup, (void*) work, (void*) info);
    } else {
        hook_pos_dgebd2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tauq, (void*) taup, (void*) work, (void*) info); 
