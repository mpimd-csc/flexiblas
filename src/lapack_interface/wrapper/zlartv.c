...
#ifndef __APPLE__
void FC_GLOBAL2(zlartv,ZLARTV)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* c, double complex* s, blasint* incc) __attribute__((alias(MTS(FC_GLOBAL(zlartv,ZLARTV)))));
void FC_GLOBAL3(zlartv,ZLARTV)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* c, double complex* s, blasint* incc) __attribute__((alias(MTS(FC_GLOBAL(zlartv,ZLARTV)))));
#else
void FC_GLOBAL2(zlartv,ZLARTV)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* c, double complex* s, blasint* incc){ FC_GLOBAL(zlartv,ZLARTV)((void*) n, (void*) x, (void*) incx, (void*) y, (void*) incy, (void*) c, (void*) s, (void*) incc); }
void FC_GLOBAL3(zlartv,ZLARTV)(blasint* n, double complex* x, blasint* incx, double complex* y, blasint* incy, double* c, double complex* s, blasint* incc){ FC_GLOBAL(zlartv,ZLARTV)((void*) n, (void*) x, (void*) incx, (void*) y, (void*) incy, (void*) c, (void*) s, (void*) incc); }
#endif
