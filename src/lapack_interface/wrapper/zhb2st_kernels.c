...
#endif 
{
	...
	fn = current_backend->lapack.zhb2st_kernels.call_fblas; 
	if ( __flexiblas_profile ) {
		...
		current_backend->lapack.zhb2st_kernels.timings[0] += (flexiblas_wtime() -ts);
		current_backend->lapack.zhb2st_kernels.calls[0]++;
	} else { 
		fn((void*) uplo, (void*) wantz, (void*) ttype, (void*) st, (void*) ed, (void*) sweep, (void*) n, (void*) nb, (void*) ib, (void*) a, (void*) lda, (void*) v, (void*) tau, (void*) ldvt, (void*) work); 
	} 
	return;
