...
void spbtf2_(char* uplo, blasint* n, blasint* kd, float* ab, blasint* ldab, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(spbtf2,SPBTF2)))));
#else
#ifndef __APPLE__
void spbtf2(char* uplo, blasint* n, blasint* kd, float* ab, blasint* ldab, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(spbtf2,SPBTF2)))));
#else
void spbtf2(char* uplo, blasint* n, blasint* kd, float* ab, blasint* ldab, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(spbtf2,SPBTF2)((void*) uplo, (void*) n, (void*) kd, (void*) ab, (void*) ldab, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
