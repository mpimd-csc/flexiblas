...
#endif
{
    ...
    *(void **) & fn = current_backend->lapack.zlatrz.f77_blas_function;
    *(void **) & fn_hook = __flexiblas_hooks->zlatrz.f77_hook_function[0];
    if ( fn_hook == NULL ) {
...
#ifndef __APPLE__
void FC_GLOBAL2(zlatrz,ZLATRZ)(blasint* m, blasint* n, blasint* l, double complex* a, blasint* lda, double complex* tau, double complex* work) __attribute__((alias(MTS(FC_GLOBAL(zlatrz,ZLATRZ)))));
void FC_GLOBAL3(zlatrz,ZLATRZ)(blasint* m, blasint* n, blasint* l, double complex* a, blasint* lda, double complex* tau, double complex* work) __attribute__((alias(MTS(FC_GLOBAL(zlatrz,ZLATRZ)))));
#else
void FC_GLOBAL2(zlatrz,ZLATRZ)(blasint* m, blasint* n, blasint* l, double complex* a, blasint* lda, double complex* tau, double complex* work){ FC_GLOBAL(zlatrz,ZLATRZ)((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) tau, (void*) work); }
void FC_GLOBAL3(zlatrz,ZLATRZ)(blasint* m, blasint* n, blasint* l, double complex* a, blasint* lda, double complex* tau, double complex* work){ FC_GLOBAL(zlatrz,ZLATRZ)((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) tau, (void*) work); }
#endif
...
void flexiblas_chain_zlatrz_(void* m, void* n, void* l, void* a, void* lda, void* tau, void* work)
{
    ...
    *(void **) &fn      = current_backend->lapack.zlatrz.f77_blas_function;
    ...
    if( hook_pos_zlatrz < __flexiblas_hooks->zlatrz.nhook) {
        *(void **) &fn_hook = __flexiblas_hooks->zlatrz.f77_hook_function[hook_pos_zlatrz];
        fn_hook((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) tau, (void*) work);
    } else {
        hook_pos_zlatrz = 0;
        fn((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) tau, (void*) work);
