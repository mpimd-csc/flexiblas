...
#ifndef __APPLE__
void FC_GLOBAL2(zlar2v,ZLAR2V)(blasint* n, double complex* x, double complex* y, double complex* z, blasint* incx, double* c, double complex* s, blasint* incc) __attribute__((alias(MTS(FC_GLOBAL(zlar2v,ZLAR2V)))));
void FC_GLOBAL3(zlar2v,ZLAR2V)(blasint* n, double complex* x, double complex* y, double complex* z, blasint* incx, double* c, double complex* s, blasint* incc) __attribute__((alias(MTS(FC_GLOBAL(zlar2v,ZLAR2V)))));
#else
void FC_GLOBAL2(zlar2v,ZLAR2V)(blasint* n, double complex* x, double complex* y, double complex* z, blasint* incx, double* c, double complex* s, blasint* incc){ FC_GLOBAL(zlar2v,ZLAR2V)((void*) n, (void*) x, (void*) y, (void*) z, (void*) incx, (void*) c, (void*) s, (void*) incc); }
void FC_GLOBAL3(zlar2v,ZLAR2V)(blasint* n, double complex* x, double complex* y, double complex* z, blasint* incx, double* c, double complex* s, blasint* incc){ FC_GLOBAL(zlar2v,ZLAR2V)((void*) n, (void*) x, (void*) y, (void*) z, (void*) incx, (void*) c, (void*) s, (void*) incc); }
#endif
