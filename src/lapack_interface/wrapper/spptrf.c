...
void spptrf_(char* uplo, blasint* n, float* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(spptrf,SPPTRF)))));
#else
#ifndef __APPLE__
void spptrf(char* uplo, blasint* n, float* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(spptrf,SPPTRF)))));
#else
void spptrf(char* uplo, blasint* n, float* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(spptrf,SPPTRF)((void*) uplo, (void*) n, (void*) ap, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
