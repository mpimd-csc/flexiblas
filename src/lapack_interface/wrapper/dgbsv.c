...
#endif
{
	...
	fn = current_backend->lapack.dgbsv.f77_blas_function; 
	fn_hook = __flexiblas_hooks->dgbsv.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void dgbsv_(blasint* n, blasint* kl, blasint* ku, blasint* nrhs, double* ab, blasint* ldab, blasint* ipiv, double* b, blasint* ldb, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgbsv,DGBSV)))));
#else
#ifndef __APPLE__
void dgbsv(blasint* n, blasint* kl, blasint* ku, blasint* nrhs, double* ab, blasint* ldab, blasint* ipiv, double* b, blasint* ldb, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgbsv,DGBSV)))));
#else
void dgbsv(blasint* n, blasint* kl, blasint* ku, blasint* nrhs, double* ab, blasint* ldab, blasint* ipiv, double* b, blasint* ldb, blasint* info){ FC_GLOBAL(dgbsv,DGBSV)((void*) n, (void*) kl, (void*) ku, (void*) nrhs, (void*) ab, (void*) ldab, (void*) ipiv, (void*) b, (void*) ldb, (void*) info); }
#endif
#endif
...
void flexiblas_chain_dgbsv_(void* n, void* kl, void* ku, void* nrhs, void* ab, void* ldab, void* ipiv, void* b, void* ldb, void* info)
{
    ...
    if( hook_pos_dgbsv < __flexiblas_hooks->dgbsv.nhook) {
        fn_hook = __flexiblas_hooks->dgbsv.f77_hook_function[hook_pos_dgbsv];
        fn_hook((void*) n, (void*) kl, (void*) ku, (void*) nrhs, (void*) ab, (void*) ldab, (void*) ipiv, (void*) b, (void*) ldb, (void*) info);
    } else {
        hook_pos_dgbsv = 0;
		fn((void*) n, (void*) kl, (void*) ku, (void*) nrhs, (void*) ab, (void*) ldab, (void*) ipiv, (void*) b, (void*) ldb, (void*) info); 
