...
#endif 
{
	...
	fn = current_backend->lapack.dsycon_rook.call_fblas; 
	if ( __flexiblas_profile ) {
		ts = flexiblas_wtime(); 
		fn((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) anorm, (void*) rcond, (void*) work, (void*) iwork, (void*) info); 
		current_backend->lapack.dsycon_rook.timings[0] += (flexiblas_wtime() -ts);
		current_backend->lapack.dsycon_rook.calls[0]++;
	} else { 
		fn((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) anorm, (void*) rcond, (void*) work, (void*) iwork, (void*) info); 
	} 
	return;
