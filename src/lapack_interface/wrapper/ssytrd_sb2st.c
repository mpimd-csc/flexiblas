...
#endif 
{
	...
	fn = current_backend->lapack.ssytrd_sb2st.call_fblas; 
	if ( __flexiblas_profile ) {
		...
		current_backend->lapack.ssytrd_sb2st.timings[0] += (flexiblas_wtime() -ts);
		current_backend->lapack.ssytrd_sb2st.calls[0]++;
	} else { 
		fn((void*) stage1, (void*) vect, (void*) uplo, (void*) n, (void*) kd, (void*) ab, (void*) ldab, (void*) d, (void*) e, (void*) hous, (void*) lhous, (void*) work, (void*) lwork, (void*) info); 
	} 
	return;
