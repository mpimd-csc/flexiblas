...
#endif
{
	...
	fn = current_backend->lapack.slaorhr_col_getrfnp.f77_blas_function; 
	fn_hook = __flexiblas_hooks->slaorhr_col_getrfnp.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void slaorhr_col_getrfnp_(blasint* m, blasint* n, float* a, blasint* lda, float* d, blasint* info) __attribute__((alias(MTS(FC_GLOBAL_(slaorhr_col_getrfnp,SLAORHR_COL_GETRFNP)))));
#else
#ifndef __APPLE__
void slaorhr_col_getrfnp(blasint* m, blasint* n, float* a, blasint* lda, float* d, blasint* info) __attribute__((alias(MTS(FC_GLOBAL_(slaorhr_col_getrfnp,SLAORHR_COL_GETRFNP)))));
#else
void slaorhr_col_getrfnp(blasint* m, blasint* n, float* a, blasint* lda, float* d, blasint* info){ FC_GLOBAL_(slaorhr_col_getrfnp,SLAORHR_COL_GETRFNP)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) info); }
#endif
#endif
...
void flexiblas_chain_slaorhr_col_getrfnp_(void* m, void* n, void* a, void* lda, void* d, void* info)
{
    ...
    if( hook_pos_slaorhr_col_getrfnp < __flexiblas_hooks->slaorhr_col_getrfnp.nhook) {
        fn_hook = __flexiblas_hooks->slaorhr_col_getrfnp.f77_hook_function[hook_pos_slaorhr_col_getrfnp];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) info);
    } else {
        hook_pos_slaorhr_col_getrfnp = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) info); 
