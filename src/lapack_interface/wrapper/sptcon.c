...
#endif
{
	...
	fn = current_backend->lapack.sptcon.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sptcon.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sptcon_(blasint* n, float* d, float* e, float* anorm, float* rcond, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sptcon,SPTCON)))));
#else
#ifndef __APPLE__
void sptcon(blasint* n, float* d, float* e, float* anorm, float* rcond, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sptcon,SPTCON)))));
#else
void sptcon(blasint* n, float* d, float* e, float* anorm, float* rcond, float* work, blasint* info){ FC_GLOBAL(sptcon,SPTCON)((void*) n, (void*) d, (void*) e, (void*) anorm, (void*) rcond, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sptcon_(void* n, void* d, void* e, void* anorm, void* rcond, void* work, void* info)
{
    ...
    if( hook_pos_sptcon < __flexiblas_hooks->sptcon.nhook) {
        fn_hook = __flexiblas_hooks->sptcon.f77_hook_function[hook_pos_sptcon];
        fn_hook((void*) n, (void*) d, (void*) e, (void*) anorm, (void*) rcond, (void*) work, (void*) info);
    } else {
        hook_pos_sptcon = 0;
		fn((void*) n, (void*) d, (void*) e, (void*) anorm, (void*) rcond, (void*) work, (void*) info); 
