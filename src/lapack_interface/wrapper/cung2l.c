...
#endif
{
	...
	fn = current_backend->lapack.cung2l.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cung2l.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cung2l_(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cung2l,CUNG2L)))));
#else
#ifndef __APPLE__
void cung2l(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cung2l,CUNG2L)))));
#else
void cung2l(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info){ FC_GLOBAL(cung2l,CUNG2L)((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cung2l_(void* m, void* n, void* k, void* a, void* lda, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_cung2l < __flexiblas_hooks->cung2l.nhook) {
        fn_hook = __flexiblas_hooks->cung2l.f77_hook_function[hook_pos_cung2l];
        fn_hook((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_cung2l = 0;
		fn((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); 
