...
#endif
{
	...
	fn = current_backend->lapack.ilaclc.f77_blas_function; 
	fn_hook = __flexiblas_hooks->ilaclc.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
blasint flexiblas_chain_ilaclc_(void* m, void* n, void* a, void* lda)
{
    ...
    if( hook_pos_ilaclc < __flexiblas_hooks->ilaclc.nhook) {
        fn_hook = __flexiblas_hooks->ilaclc.f77_hook_function[hook_pos_ilaclc];
        ret = fn_hook((void*) m, (void*) n, (void*) a, (void*) lda);
    } else {
        hook_pos_ilaclc = 0;
		ret = fn((void*) m, (void*) n, (void*) a, (void*) lda); 
