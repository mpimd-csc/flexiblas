...
#endif
{
	...
	fn = current_backend->lapack.dorgtsqr_row.f77_blas_function; 
	fn_hook = __flexiblas_hooks->dorgtsqr_row.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void dorgtsqr_row_(blasint* m, blasint* n, blasint* mb, blasint* nb, double* a, blasint* lda, double* t, blasint* ldt, double* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL_(dorgtsqr_row,DORGTSQR_ROW)))));
#else
#ifndef __APPLE__
void dorgtsqr_row(blasint* m, blasint* n, blasint* mb, blasint* nb, double* a, blasint* lda, double* t, blasint* ldt, double* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL_(dorgtsqr_row,DORGTSQR_ROW)))));
#else
void dorgtsqr_row(blasint* m, blasint* n, blasint* mb, blasint* nb, double* a, blasint* lda, double* t, blasint* ldt, double* work, blasint* lwork, blasint* info){ FC_GLOBAL_(dorgtsqr_row,DORGTSQR_ROW)((void*) m, (void*) n, (void*) mb, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_dorgtsqr_row_(void* m, void* n, void* mb, void* nb, void* a, void* lda, void* t, void* ldt, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_dorgtsqr_row < __flexiblas_hooks->dorgtsqr_row.nhook) {
        fn_hook = __flexiblas_hooks->dorgtsqr_row.f77_hook_function[hook_pos_dorgtsqr_row];
        fn_hook((void*) m, (void*) n, (void*) mb, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_dorgtsqr_row = 0;
		fn((void*) m, (void*) n, (void*) mb, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info); 
