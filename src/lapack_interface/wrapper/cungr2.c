...
#endif
{
	...
	fn = current_backend->lapack.cungr2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cungr2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cungr2_(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cungr2,CUNGR2)))));
#else
#ifndef __APPLE__
void cungr2(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cungr2,CUNGR2)))));
#else
void cungr2(blasint* m, blasint* n, blasint* k, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info){ FC_GLOBAL(cungr2,CUNGR2)((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cungr2_(void* m, void* n, void* k, void* a, void* lda, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_cungr2 < __flexiblas_hooks->cungr2.nhook) {
        fn_hook = __flexiblas_hooks->cungr2.f77_hook_function[hook_pos_cungr2];
        fn_hook((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_cungr2 = 0;
		fn((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); 
