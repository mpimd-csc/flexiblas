...
void chesv_rk_(char* uplo, blasint* n, blasint* nrhs, float complex* a, blasint* lda, float complex* e, blasint* ipiv, float complex* b, blasint* ldb, float complex* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(chesv_rk,CHESV_RK)))));
#else
#ifndef __APPLE__
void chesv_rk(char* uplo, blasint* n, blasint* nrhs, float complex* a, blasint* lda, float complex* e, blasint* ipiv, float complex* b, blasint* ldb, float complex* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(chesv_rk,CHESV_RK)))));
#else
