...
#else
void ctzrqf(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, blasint* info){ FC_GLOBAL(ctzrqf,CTZRQF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) info); }
#endif
#endif
