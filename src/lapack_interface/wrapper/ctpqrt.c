...
void ctpqrt_(blasint* m, blasint* n, blasint* l, blasint* nb, float complex* a, blasint* lda, float complex* b, blasint* ldb, float complex* t, blasint* ldt, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(ctpqrt,CTPQRT)))));
#else
#ifndef __APPLE__
void ctpqrt(blasint* m, blasint* n, blasint* l, blasint* nb, float complex* a, blasint* lda, float complex* b, blasint* ldb, float complex* t, blasint* ldt, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(ctpqrt,CTPQRT)))));
#else
void ctpqrt(blasint* m, blasint* n, blasint* l, blasint* nb, float complex* a, blasint* lda, float complex* b, blasint* ldb, float complex* t, blasint* ldt, float complex* work, blasint* info){ FC_GLOBAL(ctpqrt,CTPQRT)((void*) m, (void*) n, (void*) l, (void*) nb, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) work, (void*) info); }
#endif
#endif
