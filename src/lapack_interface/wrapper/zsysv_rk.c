...
#ifndef __APPLE__
void FC_GLOBAL2_(zsysv_rk,ZSYSV_RK)(char* uplo, blasint* n, blasint* nrhs, double complex* a, blasint* lda, double complex* e, blasint* ipiv, double complex* b, blasint* ldb, double complex* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(zsysv_rk,ZSYSV_RK)))));
void FC_GLOBAL3_(zsysv_rk,ZSYSV_RK)(char* uplo, blasint* n, blasint* nrhs, double complex* a, blasint* lda, double complex* e, blasint* ipiv, double complex* b, blasint* ldb, double complex* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(zsysv_rk,ZSYSV_RK)))));
#else
void FC_GLOBAL2_(zsysv_rk,ZSYSV_RK)(char* uplo, blasint* n, blasint* nrhs, double complex* a, blasint* lda, double complex* e, blasint* ipiv, double complex* b, blasint* ldb, double complex* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL_(zsysv_rk,ZSYSV_RK)((void*) uplo, (void*) n, (void*) nrhs, (void*) a, (void*) lda, (void*) e, (void*) ipiv, (void*) b, (void*) ldb, (void*) work, (void*) lwork, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
void FC_GLOBAL3_(zsysv_rk,ZSYSV_RK)(char* uplo, blasint* n, blasint* nrhs, double complex* a, blasint* lda, double complex* e, blasint* ipiv, double complex* b, blasint* ldb, double complex* work, blasint* lwork, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL_(zsysv_rk,ZSYSV_RK)((void*) uplo, (void*) n, (void*) nrhs, (void*) a, (void*) lda, (void*) e, (void*) ipiv, (void*) b, (void*) ldb, (void*) work, (void*) lwork, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
