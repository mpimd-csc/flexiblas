...
#endif
{
	...
	fn = current_backend->lapack.cgeequ.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgeequ.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgeequ_(blasint* m, blasint* n, float complex* a, blasint* lda, float* r, float* c, float* rowcnd, float* colcnd, float* amax, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeequ,CGEEQU)))));
#else
#ifndef __APPLE__
void cgeequ(blasint* m, blasint* n, float complex* a, blasint* lda, float* r, float* c, float* rowcnd, float* colcnd, float* amax, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgeequ,CGEEQU)))));
#else
void cgeequ(blasint* m, blasint* n, float complex* a, blasint* lda, float* r, float* c, float* rowcnd, float* colcnd, float* amax, blasint* info){ FC_GLOBAL(cgeequ,CGEEQU)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) r, (void*) c, (void*) rowcnd, (void*) colcnd, (void*) amax, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgeequ_(void* m, void* n, void* a, void* lda, void* r, void* c, void* rowcnd, void* colcnd, void* amax, void* info)
{
    ...
    if( hook_pos_cgeequ < __flexiblas_hooks->cgeequ.nhook) {
        fn_hook = __flexiblas_hooks->cgeequ.f77_hook_function[hook_pos_cgeequ];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) r, (void*) c, (void*) rowcnd, (void*) colcnd, (void*) amax, (void*) info);
    } else {
        hook_pos_cgeequ = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) r, (void*) c, (void*) rowcnd, (void*) colcnd, (void*) amax, (void*) info); 
