...
#ifndef __APPLE__
void FC_GLOBAL2(zlacgv,ZLACGV)(blasint* n, double complex* x, blasint* incx) __attribute__((alias(MTS(FC_GLOBAL(zlacgv,ZLACGV)))));
void FC_GLOBAL3(zlacgv,ZLACGV)(blasint* n, double complex* x, blasint* incx) __attribute__((alias(MTS(FC_GLOBAL(zlacgv,ZLACGV)))));
#else
void FC_GLOBAL2(zlacgv,ZLACGV)(blasint* n, double complex* x, blasint* incx){ FC_GLOBAL(zlacgv,ZLACGV)((void*) n, (void*) x, (void*) incx); }
void FC_GLOBAL3(zlacgv,ZLACGV)(blasint* n, double complex* x, blasint* incx){ FC_GLOBAL(zlacgv,ZLACGV)((void*) n, (void*) x, (void*) incx); }
#endif
