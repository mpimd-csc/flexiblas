...
void strttp_(char* uplo, blasint* n, float* a, blasint* lda, float* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(strttp,STRTTP)))));
#else
#ifndef __APPLE__
void strttp(char* uplo, blasint* n, float* a, blasint* lda, float* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(strttp,STRTTP)))));
#else
void strttp(char* uplo, blasint* n, float* a, blasint* lda, float* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(strttp,STRTTP)((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) ap, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
