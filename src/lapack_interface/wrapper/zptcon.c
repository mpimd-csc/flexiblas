...
#ifndef __APPLE__
void FC_GLOBAL2(zptcon,ZPTCON)(blasint* n, double* d, double complex* e, double* anorm, double* rcond, double* rwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zptcon,ZPTCON)))));
void FC_GLOBAL3(zptcon,ZPTCON)(blasint* n, double* d, double complex* e, double* anorm, double* rcond, double* rwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zptcon,ZPTCON)))));
#else
void FC_GLOBAL2(zptcon,ZPTCON)(blasint* n, double* d, double complex* e, double* anorm, double* rcond, double* rwork, blasint* info){ FC_GLOBAL(zptcon,ZPTCON)((void*) n, (void*) d, (void*) e, (void*) anorm, (void*) rcond, (void*) rwork, (void*) info); }
void FC_GLOBAL3(zptcon,ZPTCON)(blasint* n, double* d, double complex* e, double* anorm, double* rcond, double* rwork, blasint* info){ FC_GLOBAL(zptcon,ZPTCON)((void*) n, (void*) d, (void*) e, (void*) anorm, (void*) rcond, (void*) rwork, (void*) info); }
#endif
...
#else
void flexiblas_real_zptcon(void* n, void* d, void* e, void* anorm, void* rcond, void* rwork, void* info){flexiblas_real_zptcon_((void*) n, (void*) d, (void*) e, (void*) anorm, (void*) rcond, (void*) rwork, (void*) info);}
#endif
...
#else
void flexiblas_chain_zptcon(void* n, void* d, void* e, void* anorm, void* rcond, void* rwork, void* info){flexiblas_chain_zptcon_((void*) n, (void*) d, (void*) e, (void*) anorm, (void*) rcond, (void*) rwork, (void*) info);}
#endif
