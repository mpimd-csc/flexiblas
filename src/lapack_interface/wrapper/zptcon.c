...
#else
void zptcon(blasint* n, double* d, double complex* e, double* anorm, double* rcond, double* rwork, blasint* info){ FC_GLOBAL(zptcon,ZPTCON)((void*) n, (void*) d, (void*) e, (void*) anorm, (void*) rcond, (void*) rwork, (void*) info); }
#endif
#endif
