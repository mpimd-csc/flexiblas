...
#ifndef __APPLE__
void FC_GLOBAL2(dlaqtr,DLAQTR)(blaslogical* ltran, blaslogical* lreal, blasint* n, double* t, blasint* ldt, double* b, double* w, double* scale, double* x, double* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dlaqtr,DLAQTR)))));
void FC_GLOBAL3(dlaqtr,DLAQTR)(blaslogical* ltran, blaslogical* lreal, blasint* n, double* t, blasint* ldt, double* b, double* w, double* scale, double* x, double* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dlaqtr,DLAQTR)))));
#else
void FC_GLOBAL2(dlaqtr,DLAQTR)(blaslogical* ltran, blaslogical* lreal, blasint* n, double* t, blasint* ldt, double* b, double* w, double* scale, double* x, double* work, blasint* info){ FC_GLOBAL(dlaqtr,DLAQTR)((void*) ltran, (void*) lreal, (void*) n, (void*) t, (void*) ldt, (void*) b, (void*) w, (void*) scale, (void*) x, (void*) work, (void*) info); }
void FC_GLOBAL3(dlaqtr,DLAQTR)(blaslogical* ltran, blaslogical* lreal, blasint* n, double* t, blasint* ldt, double* b, double* w, double* scale, double* x, double* work, blasint* info){ FC_GLOBAL(dlaqtr,DLAQTR)((void*) ltran, (void*) lreal, (void*) n, (void*) t, (void*) ldt, (void*) b, (void*) w, (void*) scale, (void*) x, (void*) work, (void*) info); }
#endif
