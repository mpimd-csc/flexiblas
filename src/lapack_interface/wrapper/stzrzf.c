...
#endif
{
	...
	fn = current_backend->lapack.stzrzf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->stzrzf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void stzrzf_(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(stzrzf,STZRZF)))));
#else
#ifndef __APPLE__
void stzrzf(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(stzrzf,STZRZF)))));
#else
void stzrzf(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(stzrzf,STZRZF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_stzrzf_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_stzrzf < __flexiblas_hooks->stzrzf.nhook) {
        fn_hook = __flexiblas_hooks->stzrzf.f77_hook_function[hook_pos_stzrzf];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_stzrzf = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
