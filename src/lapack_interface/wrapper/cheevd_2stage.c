...
#endif 
{
	...
	fn = current_backend->lapack.cheevd_2stage.call_fblas; 
	if ( __flexiblas_profile ) {
		...
		current_backend->lapack.cheevd_2stage.timings[0] += (flexiblas_wtime() -ts);
		current_backend->lapack.cheevd_2stage.calls[0]++;
	} else { 
		fn((void*) jobz, (void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) w, (void*) work, (void*) lwork, (void*) rwork, (void*) lrwork, (void*) iwork, (void*) liwork, (void*) info); 
	} 
	return;
