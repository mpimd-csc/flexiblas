...
#endif
{
	...
	fn = current_backend->lapack.slasq1.f77_blas_function; 
	fn_hook = __flexiblas_hooks->slasq1.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
#else
void slasq1(blasint* n, float* d, float* e, float* work, blasint* info){ FC_GLOBAL(slasq1,SLASQ1)((void*) n, (void*) d, (void*) e, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_slasq1_(void* n, void* d, void* e, void* work, void* info)
{
    ...
    if( hook_pos_slasq1 < __flexiblas_hooks->slasq1.nhook) {
        fn_hook = __flexiblas_hooks->slasq1.f77_hook_function[hook_pos_slasq1];
        fn_hook((void*) n, (void*) d, (void*) e, (void*) work, (void*) info);
    } else {
        hook_pos_slasq1 = 0;
		fn((void*) n, (void*) d, (void*) e, (void*) work, (void*) info); 
