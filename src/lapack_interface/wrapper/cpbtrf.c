...
void cpbtrf_(char* uplo, blasint* n, blasint* kd, float complex* ab, blasint* ldab, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(cpbtrf,CPBTRF)))));
#else
#ifndef __APPLE__
void cpbtrf(char* uplo, blasint* n, blasint* kd, float complex* ab, blasint* ldab, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(cpbtrf,CPBTRF)))));
#else
void cpbtrf(char* uplo, blasint* n, blasint* kd, float complex* ab, blasint* ldab, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(cpbtrf,CPBTRF)((void*) uplo, (void*) n, (void*) kd, (void*) ab, (void*) ldab, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
