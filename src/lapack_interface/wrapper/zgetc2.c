...
#endif
{
    ...
    *(void **) & fn = current_backend->lapack.zgetc2.f77_blas_function;
    *(void **) & fn_hook = __flexiblas_hooks->zgetc2.f77_hook_function[0];
    if ( fn_hook == NULL ) {
...
#ifndef __APPLE__
void FC_GLOBAL2(zgetc2,ZGETC2)(blasint* n, double complex* a, blasint* lda, blasint* ipiv, blasint* jpiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgetc2,ZGETC2)))));
void FC_GLOBAL3(zgetc2,ZGETC2)(blasint* n, double complex* a, blasint* lda, blasint* ipiv, blasint* jpiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgetc2,ZGETC2)))));
#else
void FC_GLOBAL2(zgetc2,ZGETC2)(blasint* n, double complex* a, blasint* lda, blasint* ipiv, blasint* jpiv, blasint* info){ FC_GLOBAL(zgetc2,ZGETC2)((void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) jpiv, (void*) info); }
void FC_GLOBAL3(zgetc2,ZGETC2)(blasint* n, double complex* a, blasint* lda, blasint* ipiv, blasint* jpiv, blasint* info){ FC_GLOBAL(zgetc2,ZGETC2)((void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) jpiv, (void*) info); }
#endif
...
void flexiblas_chain_zgetc2_(void* n, void* a, void* lda, void* ipiv, void* jpiv, void* info)
{
    ...
    *(void **) &fn      = current_backend->lapack.zgetc2.f77_blas_function;
    ...
    if( hook_pos_zgetc2 < __flexiblas_hooks->zgetc2.nhook) {
        *(void **) &fn_hook = __flexiblas_hooks->zgetc2.f77_hook_function[hook_pos_zgetc2];
        fn_hook((void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) jpiv, (void*) info);
    } else {
        hook_pos_zgetc2 = 0;
        fn((void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) jpiv, (void*) info);
