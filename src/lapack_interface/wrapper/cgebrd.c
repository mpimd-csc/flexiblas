...
#endif
{
	...
	fn = current_backend->lapack.cgebrd.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgebrd.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgebrd_(blasint* m, blasint* n, float complex* a, blasint* lda, float* d, float* e, float complex* tauq, float complex* taup, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgebrd,CGEBRD)))));
#else
#ifndef __APPLE__
void cgebrd(blasint* m, blasint* n, float complex* a, blasint* lda, float* d, float* e, float complex* tauq, float complex* taup, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgebrd,CGEBRD)))));
#else
void cgebrd(blasint* m, blasint* n, float complex* a, blasint* lda, float* d, float* e, float complex* tauq, float complex* taup, float complex* work, blasint* lwork, blasint* info){ FC_GLOBAL(cgebrd,CGEBRD)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tauq, (void*) taup, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgebrd_(void* m, void* n, void* a, void* lda, void* d, void* e, void* tauq, void* taup, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_cgebrd < __flexiblas_hooks->cgebrd.nhook) {
        fn_hook = __flexiblas_hooks->cgebrd.f77_hook_function[hook_pos_cgebrd];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tauq, (void*) taup, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_cgebrd = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) e, (void*) tauq, (void*) taup, (void*) work, (void*) lwork, (void*) info); 
