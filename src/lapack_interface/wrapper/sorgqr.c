...
#endif
{
	...
	fn = current_backend->lapack.sorgqr.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sorgqr.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sorgqr_(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sorgqr,SORGQR)))));
#else
#ifndef __APPLE__
void sorgqr(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sorgqr,SORGQR)))));
#else
void sorgqr(blasint* m, blasint* n, blasint* k, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sorgqr,SORGQR)((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sorgqr_(void* m, void* n, void* k, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_sorgqr < __flexiblas_hooks->sorgqr.nhook) {
        fn_hook = __flexiblas_hooks->sorgqr.f77_hook_function[hook_pos_sorgqr];
        fn_hook((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_sorgqr = 0;
		fn((void*) m, (void*) n, (void*) k, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
