...
#ifndef __APPLE__
void FC_GLOBAL2(dladiv,DLADIV)(double* a, double* b, double* c, double* d, double* p, double* q) __attribute__((alias(MTS(FC_GLOBAL(dladiv,DLADIV)))));
void FC_GLOBAL3(dladiv,DLADIV)(double* a, double* b, double* c, double* d, double* p, double* q) __attribute__((alias(MTS(FC_GLOBAL(dladiv,DLADIV)))));
#else
void FC_GLOBAL2(dladiv,DLADIV)(double* a, double* b, double* c, double* d, double* p, double* q){ FC_GLOBAL(dladiv,DLADIV)((void*) a, (void*) b, (void*) c, (void*) d, (void*) p, (void*) q); }
void FC_GLOBAL3(dladiv,DLADIV)(double* a, double* b, double* c, double* d, double* p, double* q){ FC_GLOBAL(dladiv,DLADIV)((void*) a, (void*) b, (void*) c, (void*) d, (void*) p, (void*) q); }
#endif
