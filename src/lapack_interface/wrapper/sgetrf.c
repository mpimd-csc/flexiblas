...
#else
void sgetrf(blasint* m, blasint* n, float* a, blasint* lda, blasint* ipiv, blasint* info){ FC_GLOBAL(sgetrf,SGETRF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); }
#endif
#endif
