...
#endif
{
	...
	fn = current_backend->lapack.sgetf2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgetf2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgetf2_(blasint* m, blasint* n, float* a, blasint* lda, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgetf2,SGETF2)))));
#else
#ifndef __APPLE__
void sgetf2(blasint* m, blasint* n, float* a, blasint* lda, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgetf2,SGETF2)))));
#else
void sgetf2(blasint* m, blasint* n, float* a, blasint* lda, blasint* ipiv, blasint* info){ FC_GLOBAL(sgetf2,SGETF2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgetf2_(void* m, void* n, void* a, void* lda, void* ipiv, void* info)
{
    ...
    if( hook_pos_sgetf2 < __flexiblas_hooks->sgetf2.nhook) {
        fn_hook = __flexiblas_hooks->sgetf2.f77_hook_function[hook_pos_sgetf2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info);
    } else {
        hook_pos_sgetf2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); 
