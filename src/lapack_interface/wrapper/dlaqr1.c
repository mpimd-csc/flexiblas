...
#ifndef __APPLE__
void FC_GLOBAL2(dlaqr1,DLAQR1)(blasint* n, double* h, blasint* ldh, double* sr1, double* si1, double* sr2, double* si2, double* v) __attribute__((alias(MTS(FC_GLOBAL(dlaqr1,DLAQR1)))));
void FC_GLOBAL3(dlaqr1,DLAQR1)(blasint* n, double* h, blasint* ldh, double* sr1, double* si1, double* sr2, double* si2, double* v) __attribute__((alias(MTS(FC_GLOBAL(dlaqr1,DLAQR1)))));
#else
void FC_GLOBAL2(dlaqr1,DLAQR1)(blasint* n, double* h, blasint* ldh, double* sr1, double* si1, double* sr2, double* si2, double* v){ FC_GLOBAL(dlaqr1,DLAQR1)((void*) n, (void*) h, (void*) ldh, (void*) sr1, (void*) si1, (void*) sr2, (void*) si2, (void*) v); }
void FC_GLOBAL3(dlaqr1,DLAQR1)(blasint* n, double* h, blasint* ldh, double* sr1, double* si1, double* sr2, double* si2, double* v){ FC_GLOBAL(dlaqr1,DLAQR1)((void*) n, (void*) h, (void*) ldh, (void*) sr1, (void*) si1, (void*) sr2, (void*) si2, (void*) v); }
#endif
