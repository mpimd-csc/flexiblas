...
void slaqp2rk_(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* kmax, float* abstol, float* reltol, blasint* kp1, float* maxc2nrm, float* a, blasint* lda, blasint* k, float* maxc2nrmk, float* relmaxc2nrmk, blasint* jpiv, float* tau, float* vn1, float* vn2, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(slaqp2rk,SLAQP2RK)))));
#else
#ifndef __APPLE__
void slaqp2rk(blasint* m, blasint* n, blasint* nrhs, blasint* ioffset, blasint* kmax, float* abstol, float* reltol, blasint* kp1, float* maxc2nrm, float* a, blasint* lda, blasint* k, float* maxc2nrmk, float* relmaxc2nrmk, blasint* jpiv, float* tau, float* vn1, float* vn2, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(slaqp2rk,SLAQP2RK)))));
#else
