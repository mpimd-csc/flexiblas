...
#endif
{
	...
	fn = current_backend->lapack.sgelq2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgelq2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgelq2_(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgelq2,SGELQ2)))));
#else
#ifndef __APPLE__
void sgelq2(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgelq2,SGELQ2)))));
#else
void sgelq2(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* info){ FC_GLOBAL(sgelq2,SGELQ2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgelq2_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_sgelq2 < __flexiblas_hooks->sgelq2.nhook) {
        fn_hook = __flexiblas_hooks->sgelq2.f77_hook_function[hook_pos_sgelq2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_sgelq2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); 
