...
#endif
{
	...
	fn = current_backend->lapack.cggrqf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cggrqf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cggrqf_(blasint* m, blasint* p, blasint* n, float complex* a, blasint* lda, float complex* taua, float complex* b, blasint* ldb, float complex* taub, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cggrqf,CGGRQF)))));
#else
#ifndef __APPLE__
void cggrqf(blasint* m, blasint* p, blasint* n, float complex* a, blasint* lda, float complex* taua, float complex* b, blasint* ldb, float complex* taub, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cggrqf,CGGRQF)))));
#else
void cggrqf(blasint* m, blasint* p, blasint* n, float complex* a, blasint* lda, float complex* taua, float complex* b, blasint* ldb, float complex* taub, float complex* work, blasint* lwork, blasint* info){ FC_GLOBAL(cggrqf,CGGRQF)((void*) m, (void*) p, (void*) n, (void*) a, (void*) lda, (void*) taua, (void*) b, (void*) ldb, (void*) taub, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cggrqf_(void* m, void* p, void* n, void* a, void* lda, void* taua, void* b, void* ldb, void* taub, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_cggrqf < __flexiblas_hooks->cggrqf.nhook) {
        fn_hook = __flexiblas_hooks->cggrqf.f77_hook_function[hook_pos_cggrqf];
        fn_hook((void*) m, (void*) p, (void*) n, (void*) a, (void*) lda, (void*) taua, (void*) b, (void*) ldb, (void*) taub, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_cggrqf = 0;
		fn((void*) m, (void*) p, (void*) n, (void*) a, (void*) lda, (void*) taua, (void*) b, (void*) ldb, (void*) taub, (void*) work, (void*) lwork, (void*) info); 
