...
#ifndef __APPLE__
void FC_GLOBAL2(dgeqrt2,DGEQRT2)(blasint* m, blasint* n, double* a, blasint* lda, double* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgeqrt2,DGEQRT2)))));
void FC_GLOBAL3(dgeqrt2,DGEQRT2)(blasint* m, blasint* n, double* a, blasint* lda, double* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dgeqrt2,DGEQRT2)))));
#else
void FC_GLOBAL2(dgeqrt2,DGEQRT2)(blasint* m, blasint* n, double* a, blasint* lda, double* t, blasint* ldt, blasint* info){ FC_GLOBAL(dgeqrt2,DGEQRT2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info); }
void FC_GLOBAL3(dgeqrt2,DGEQRT2)(blasint* m, blasint* n, double* a, blasint* lda, double* t, blasint* ldt, blasint* info){ FC_GLOBAL(dgeqrt2,DGEQRT2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info); }
#endif
