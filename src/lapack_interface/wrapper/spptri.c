...
void spptri_(char* uplo, blasint* n, float* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(spptri,SPPTRI)))));
#else
#ifndef __APPLE__
void spptri(char* uplo, blasint* n, float* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(spptri,SPPTRI)))));
#else
void spptri(char* uplo, blasint* n, float* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(spptri,SPPTRI)((void*) uplo, (void*) n, (void*) ap, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
