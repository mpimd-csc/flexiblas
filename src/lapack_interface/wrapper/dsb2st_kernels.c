...
#ifndef __APPLE__
void FC_GLOBAL2_(dsb2st_kernels,DSB2ST_KERNELS)(char* uplo, blaslogical* wantz, blasint* ttype, blasint* st, blasint* ed, blasint* sweep, blasint* n, blasint* nb, blasint* ib, double* a, blasint* lda, double* v, double* tau, blasint* ldvt, double* work, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(dsb2st_kernels,DSB2ST_KERNELS)))));
void FC_GLOBAL3_(dsb2st_kernels,DSB2ST_KERNELS)(char* uplo, blaslogical* wantz, blasint* ttype, blasint* st, blasint* ed, blasint* sweep, blasint* n, blasint* nb, blasint* ib, double* a, blasint* lda, double* v, double* tau, blasint* ldvt, double* work, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(dsb2st_kernels,DSB2ST_KERNELS)))));
#else
