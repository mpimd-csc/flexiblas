...
#ifndef __APPLE__
void FC_GLOBAL2(zlaev2,ZLAEV2)(double complex* a, double complex* b, double complex* c, double* rt1, double* rt2, double* cs1, double complex* sn1) __attribute__((alias(MTS(FC_GLOBAL(zlaev2,ZLAEV2)))));
void FC_GLOBAL3(zlaev2,ZLAEV2)(double complex* a, double complex* b, double complex* c, double* rt1, double* rt2, double* cs1, double complex* sn1) __attribute__((alias(MTS(FC_GLOBAL(zlaev2,ZLAEV2)))));
#else
void FC_GLOBAL2(zlaev2,ZLAEV2)(double complex* a, double complex* b, double complex* c, double* rt1, double* rt2, double* cs1, double complex* sn1){ FC_GLOBAL(zlaev2,ZLAEV2)((void*) a, (void*) b, (void*) c, (void*) rt1, (void*) rt2, (void*) cs1, (void*) sn1); }
void FC_GLOBAL3(zlaev2,ZLAEV2)(double complex* a, double complex* b, double complex* c, double* rt1, double* rt2, double* cs1, double complex* sn1){ FC_GLOBAL(zlaev2,ZLAEV2)((void*) a, (void*) b, (void*) c, (void*) rt1, (void*) rt2, (void*) cs1, (void*) sn1); }
#endif
