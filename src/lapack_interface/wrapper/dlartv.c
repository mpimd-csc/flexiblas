...
#ifndef __APPLE__
void FC_GLOBAL2(dlartv,DLARTV)(blasint* n, double* x, blasint* incx, double* y, blasint* incy, double* c, double* s, blasint* incc) __attribute__((alias(MTS(FC_GLOBAL(dlartv,DLARTV)))));
void FC_GLOBAL3(dlartv,DLARTV)(blasint* n, double* x, blasint* incx, double* y, blasint* incy, double* c, double* s, blasint* incc) __attribute__((alias(MTS(FC_GLOBAL(dlartv,DLARTV)))));
#else
void FC_GLOBAL2(dlartv,DLARTV)(blasint* n, double* x, blasint* incx, double* y, blasint* incy, double* c, double* s, blasint* incc){ FC_GLOBAL(dlartv,DLARTV)((void*) n, (void*) x, (void*) incx, (void*) y, (void*) incy, (void*) c, (void*) s, (void*) incc); }
void FC_GLOBAL3(dlartv,DLARTV)(blasint* n, double* x, blasint* incx, double* y, blasint* incy, double* c, double* s, blasint* incc){ FC_GLOBAL(dlartv,DLARTV)((void*) n, (void*) x, (void*) incx, (void*) y, (void*) incy, (void*) c, (void*) s, (void*) incc); }
#endif
