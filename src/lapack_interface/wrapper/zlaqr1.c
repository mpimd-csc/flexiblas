...
#ifndef __APPLE__
void FC_GLOBAL2(zlaqr1,ZLAQR1)(blasint* n, double complex* h, blasint* ldh, double complex* s1, double complex* s2, double complex* v) __attribute__((alias(MTS(FC_GLOBAL(zlaqr1,ZLAQR1)))));
void FC_GLOBAL3(zlaqr1,ZLAQR1)(blasint* n, double complex* h, blasint* ldh, double complex* s1, double complex* s2, double complex* v) __attribute__((alias(MTS(FC_GLOBAL(zlaqr1,ZLAQR1)))));
#else
void FC_GLOBAL2(zlaqr1,ZLAQR1)(blasint* n, double complex* h, blasint* ldh, double complex* s1, double complex* s2, double complex* v){ FC_GLOBAL(zlaqr1,ZLAQR1)((void*) n, (void*) h, (void*) ldh, (void*) s1, (void*) s2, (void*) v); }
void FC_GLOBAL3(zlaqr1,ZLAQR1)(blasint* n, double complex* h, blasint* ldh, double complex* s1, double complex* s2, double complex* v){ FC_GLOBAL(zlaqr1,ZLAQR1)((void*) n, (void*) h, (void*) ldh, (void*) s1, (void*) s2, (void*) v); }
#endif
