...
#endif
{
	...
	fn = current_backend->lapack.cpoequb.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cpoequb.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cpoequb_(blasint* n, float complex* a, blasint* lda, float* s, float* scond, float* amax, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cpoequb,CPOEQUB)))));
#else
#ifndef __APPLE__
void cpoequb(blasint* n, float complex* a, blasint* lda, float* s, float* scond, float* amax, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cpoequb,CPOEQUB)))));
#else
void cpoequb(blasint* n, float complex* a, blasint* lda, float* s, float* scond, float* amax, blasint* info){ FC_GLOBAL(cpoequb,CPOEQUB)((void*) n, (void*) a, (void*) lda, (void*) s, (void*) scond, (void*) amax, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cpoequb_(void* n, void* a, void* lda, void* s, void* scond, void* amax, void* info)
{
    ...
    if( hook_pos_cpoequb < __flexiblas_hooks->cpoequb.nhook) {
        fn_hook = __flexiblas_hooks->cpoequb.f77_hook_function[hook_pos_cpoequb];
        fn_hook((void*) n, (void*) a, (void*) lda, (void*) s, (void*) scond, (void*) amax, (void*) info);
    } else {
        hook_pos_cpoequb = 0;
		fn((void*) n, (void*) a, (void*) lda, (void*) s, (void*) scond, (void*) amax, (void*) info); 
