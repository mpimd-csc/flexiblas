...
#endif
{
	...
	fn = current_backend->lapack.sgelq.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgelq.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgelq_(blasint* m, blasint* n, float* a, blasint* lda, float* t, blasint* tsize, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgelq,SGELQ)))));
#else
#ifndef __APPLE__
void sgelq(blasint* m, blasint* n, float* a, blasint* lda, float* t, blasint* tsize, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgelq,SGELQ)))));
#else
void sgelq(blasint* m, blasint* n, float* a, blasint* lda, float* t, blasint* tsize, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sgelq,SGELQ)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) tsize, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgelq_(void* m, void* n, void* a, void* lda, void* t, void* tsize, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_sgelq < __flexiblas_hooks->sgelq.nhook) {
        fn_hook = __flexiblas_hooks->sgelq.f77_hook_function[hook_pos_sgelq];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) tsize, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_sgelq = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) tsize, (void*) work, (void*) lwork, (void*) info); 
