...
#ifndef __APPLE__
void FC_GLOBAL2(ztgex2,ZTGEX2)(blaslogical* wantq, blaslogical* wantz, blasint* n, double complex* a, blasint* lda, double complex* b, blasint* ldb, double complex* q, blasint* ldq, double complex* z, blasint* ldz, blasint* j1, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(ztgex2,ZTGEX2)))));
void FC_GLOBAL3(ztgex2,ZTGEX2)(blaslogical* wantq, blaslogical* wantz, blasint* n, double complex* a, blasint* lda, double complex* b, blasint* ldb, double complex* q, blasint* ldq, double complex* z, blasint* ldz, blasint* j1, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(ztgex2,ZTGEX2)))));
#else
void FC_GLOBAL2(ztgex2,ZTGEX2)(blaslogical* wantq, blaslogical* wantz, blasint* n, double complex* a, blasint* lda, double complex* b, blasint* ldb, double complex* q, blasint* ldq, double complex* z, blasint* ldz, blasint* j1, blasint* info){ FC_GLOBAL(ztgex2,ZTGEX2)((void*) wantq, (void*) wantz, (void*) n, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) q, (void*) ldq, (void*) z, (void*) ldz, (void*) j1, (void*) info); }
void FC_GLOBAL3(ztgex2,ZTGEX2)(blaslogical* wantq, blaslogical* wantz, blasint* n, double complex* a, blasint* lda, double complex* b, blasint* ldb, double complex* q, blasint* ldq, double complex* z, blasint* ldz, blasint* j1, blasint* info){ FC_GLOBAL(ztgex2,ZTGEX2)((void*) wantq, (void*) wantz, (void*) n, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) q, (void*) ldq, (void*) z, (void*) ldz, (void*) j1, (void*) info); }
#endif
