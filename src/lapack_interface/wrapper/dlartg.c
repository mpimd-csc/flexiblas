...
void dlartg_(float* f, float* g, float* c, float* s, float* r) __attribute__((alias(MTS(FC_GLOBAL(dlartg,DLARTG)))));
#else
#ifndef __APPLE__
void dlartg(float* f, float* g, float* c, float* s, float* r) __attribute__((alias(MTS(FC_GLOBAL(dlartg,DLARTG)))));
#else
void dlartg(float* f, float* g, float* c, float* s, float* r){ FC_GLOBAL(dlartg,DLARTG)((void*) f, (void*) g, (void*) c, (void*) s, (void*) r); }
#endif
#endif
