...
void slaset_(char* uplo, blasint* m, blasint* n, float* alpha, float* beta, float* a, blasint* lda, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(slaset,SLASET)))));
#else
#ifndef __APPLE__
void slaset(char* uplo, blasint* m, blasint* n, float* alpha, float* beta, float* a, blasint* lda, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(slaset,SLASET)))));
#else
void slaset(char* uplo, blasint* m, blasint* n, float* alpha, float* beta, float* a, blasint* lda, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(slaset,SLASET)((void*) uplo, (void*) m, (void*) n, (void*) alpha, (void*) beta, (void*) a, (void*) lda, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
