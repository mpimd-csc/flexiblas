...
void slacpy_(char* uplo, blasint* m, blasint* n, float* a, blasint* lda, float* b, blasint* ldb, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(slacpy,SLACPY)))));
#else
#ifndef __APPLE__
void slacpy(char* uplo, blasint* m, blasint* n, float* a, blasint* lda, float* b, blasint* ldb, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(slacpy,SLACPY)))));
#else
void slacpy(char* uplo, blasint* m, blasint* n, float* a, blasint* lda, float* b, blasint* ldb, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(slacpy,SLACPY)((void*) uplo, (void*) m, (void*) n, (void*) a, (void*) lda, (void*) b, (void*) ldb, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
