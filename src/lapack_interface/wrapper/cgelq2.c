...
#endif
{
	...
	fn = current_backend->lapack.cgelq2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgelq2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgelq2_(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgelq2,CGELQ2)))));
#else
#ifndef __APPLE__
void cgelq2(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgelq2,CGELQ2)))));
#else
void cgelq2(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info){ FC_GLOBAL(cgelq2,CGELQ2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgelq2_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_cgelq2 < __flexiblas_hooks->cgelq2.nhook) {
        fn_hook = __flexiblas_hooks->cgelq2.f77_hook_function[hook_pos_cgelq2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_cgelq2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); 
