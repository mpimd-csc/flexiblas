...
#endif 
{
	...
	fn = current_backend->lapack.dsbevd_2stage.call_fblas; 
	if ( __flexiblas_profile ) {
		...
		current_backend->lapack.dsbevd_2stage.timings[0] += (flexiblas_wtime() -ts);
		current_backend->lapack.dsbevd_2stage.calls[0]++;
	} else { 
		fn((void*) jobz, (void*) uplo, (void*) n, (void*) kd, (void*) ab, (void*) ldab, (void*) w, (void*) z, (void*) ldz, (void*) work, (void*) lwork, (void*) iwork, (void*) liwork, (void*) info); 
	} 
	return;
