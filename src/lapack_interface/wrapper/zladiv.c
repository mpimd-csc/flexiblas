...
#ifndef __APPLE__
double complex FC_GLOBAL2(zladiv,ZLADIV)(double complex* x, double complex* y) __attribute__((alias(MTS(FC_GLOBAL(zladiv,ZLADIV)))));
double complex FC_GLOBAL3(zladiv,ZLADIV)(double complex* x, double complex* y) __attribute__((alias(MTS(FC_GLOBAL(zladiv,ZLADIV)))));
#else
double complex FC_GLOBAL2(zladiv,ZLADIV)(double complex* x, double complex* y){ return FC_GLOBAL(zladiv,ZLADIV)((void*) x, (void*) y); }
double complex FC_GLOBAL3(zladiv,ZLADIV)(double complex* x, double complex* y){ return FC_GLOBAL(zladiv,ZLADIV)((void*) x, (void*) y); }
#endif
