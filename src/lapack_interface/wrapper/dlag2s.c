...
#else
void dlag2s(blasint* m, blasint* n, double* a, blasint* lda, float* sa, blasint* ldsa, blasint* info){ FC_GLOBAL(dlag2s,DLAG2S)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) sa, (void*) ldsa, (void*) info); }
#endif
#endif
