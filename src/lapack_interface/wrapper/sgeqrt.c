...
#endif
{
	...
	fn = current_backend->lapack.sgeqrt.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgeqrt.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgeqrt_(blasint* m, blasint* n, blasint* nb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqrt,SGEQRT)))));
#else
#ifndef __APPLE__
void sgeqrt(blasint* m, blasint* n, blasint* nb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqrt,SGEQRT)))));
#else
void sgeqrt(blasint* m, blasint* n, blasint* nb, float* a, blasint* lda, float* t, blasint* ldt, float* work, blasint* info){ FC_GLOBAL(sgeqrt,SGEQRT)((void*) m, (void*) n, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgeqrt_(void* m, void* n, void* nb, void* a, void* lda, void* t, void* ldt, void* work, void* info)
{
    ...
    if( hook_pos_sgeqrt < __flexiblas_hooks->sgeqrt.nhook) {
        fn_hook = __flexiblas_hooks->sgeqrt.f77_hook_function[hook_pos_sgeqrt];
        fn_hook((void*) m, (void*) n, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info);
    } else {
        hook_pos_sgeqrt = 0;
		fn((void*) m, (void*) n, (void*) nb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info); 
