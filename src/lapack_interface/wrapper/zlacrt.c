...
#ifndef __APPLE__
void FC_GLOBAL2(zlacrt,ZLACRT)(blasint* n, double complex* cx, blasint* incx, double complex* cy, blasint* incy, double complex* c, double complex* s) __attribute__((alias(MTS(FC_GLOBAL(zlacrt,ZLACRT)))));
void FC_GLOBAL3(zlacrt,ZLACRT)(blasint* n, double complex* cx, blasint* incx, double complex* cy, blasint* incy, double complex* c, double complex* s) __attribute__((alias(MTS(FC_GLOBAL(zlacrt,ZLACRT)))));
#else
void FC_GLOBAL2(zlacrt,ZLACRT)(blasint* n, double complex* cx, blasint* incx, double complex* cy, blasint* incy, double complex* c, double complex* s){ FC_GLOBAL(zlacrt,ZLACRT)((void*) n, (void*) cx, (void*) incx, (void*) cy, (void*) incy, (void*) c, (void*) s); }
void FC_GLOBAL3(zlacrt,ZLACRT)(blasint* n, double complex* cx, blasint* incx, double complex* cy, blasint* incy, double complex* c, double complex* s){ FC_GLOBAL(zlacrt,ZLACRT)((void*) n, (void*) cx, (void*) incx, (void*) cy, (void*) incy, (void*) c, (void*) s); }
#endif
