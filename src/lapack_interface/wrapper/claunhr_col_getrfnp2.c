...
#endif
{
	...
	fn = current_backend->lapack.claunhr_col_getrfnp2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->claunhr_col_getrfnp2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void claunhr_col_getrfnp2_(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* d, blasint* info) __attribute__((alias(MTS(FC_GLOBAL_(claunhr_col_getrfnp2,CLAUNHR_COL_GETRFNP2)))));
#else
#ifndef __APPLE__
void claunhr_col_getrfnp2(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* d, blasint* info) __attribute__((alias(MTS(FC_GLOBAL_(claunhr_col_getrfnp2,CLAUNHR_COL_GETRFNP2)))));
#else
void claunhr_col_getrfnp2(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* d, blasint* info){ FC_GLOBAL_(claunhr_col_getrfnp2,CLAUNHR_COL_GETRFNP2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) info); }
#endif
#endif
...
void flexiblas_chain_claunhr_col_getrfnp2_(void* m, void* n, void* a, void* lda, void* d, void* info)
{
    ...
    if( hook_pos_claunhr_col_getrfnp2 < __flexiblas_hooks->claunhr_col_getrfnp2.nhook) {
        fn_hook = __flexiblas_hooks->claunhr_col_getrfnp2.f77_hook_function[hook_pos_claunhr_col_getrfnp2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) info);
    } else {
        hook_pos_claunhr_col_getrfnp2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) d, (void*) info); 
