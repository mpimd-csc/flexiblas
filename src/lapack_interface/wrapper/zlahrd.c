...
#endif
{
    ...
    *(void **) & fn = current_backend->lapack.zlahrd.f77_blas_function;
    *(void **) & fn_hook = __flexiblas_hooks->zlahrd.f77_hook_function[0];
    if ( fn_hook == NULL ) {
...
#ifndef __APPLE__
void FC_GLOBAL2(zlahrd,ZLAHRD)(blasint* n, blasint* k, blasint* nb, double complex* a, blasint* lda, double complex* tau, double complex* t, blasint* ldt, double complex* y, blasint* ldy) __attribute__((alias(MTS(FC_GLOBAL(zlahrd,ZLAHRD)))));
void FC_GLOBAL3(zlahrd,ZLAHRD)(blasint* n, blasint* k, blasint* nb, double complex* a, blasint* lda, double complex* tau, double complex* t, blasint* ldt, double complex* y, blasint* ldy) __attribute__((alias(MTS(FC_GLOBAL(zlahrd,ZLAHRD)))));
#else
void FC_GLOBAL2(zlahrd,ZLAHRD)(blasint* n, blasint* k, blasint* nb, double complex* a, blasint* lda, double complex* tau, double complex* t, blasint* ldt, double complex* y, blasint* ldy){ FC_GLOBAL(zlahrd,ZLAHRD)((void*) n, (void*) k, (void*) nb, (void*) a, (void*) lda, (void*) tau, (void*) t, (void*) ldt, (void*) y, (void*) ldy); }
void FC_GLOBAL3(zlahrd,ZLAHRD)(blasint* n, blasint* k, blasint* nb, double complex* a, blasint* lda, double complex* tau, double complex* t, blasint* ldt, double complex* y, blasint* ldy){ FC_GLOBAL(zlahrd,ZLAHRD)((void*) n, (void*) k, (void*) nb, (void*) a, (void*) lda, (void*) tau, (void*) t, (void*) ldt, (void*) y, (void*) ldy); }
#endif
...
void flexiblas_chain_zlahrd_(void* n, void* k, void* nb, void* a, void* lda, void* tau, void* t, void* ldt, void* y, void* ldy)
{
    ...
    *(void **) &fn      = current_backend->lapack.zlahrd.f77_blas_function;
    ...
    if( hook_pos_zlahrd < __flexiblas_hooks->zlahrd.nhook) {
        *(void **) &fn_hook = __flexiblas_hooks->zlahrd.f77_hook_function[hook_pos_zlahrd];
        fn_hook((void*) n, (void*) k, (void*) nb, (void*) a, (void*) lda, (void*) tau, (void*) t, (void*) ldt, (void*) y, (void*) ldy);
    } else {
        hook_pos_zlahrd = 0;
        fn((void*) n, (void*) k, (void*) nb, (void*) a, (void*) lda, (void*) tau, (void*) t, (void*) ldt, (void*) y, (void*) ldy);
