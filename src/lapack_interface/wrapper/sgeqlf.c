...
#endif
{
	...
	fn = current_backend->lapack.sgeqlf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgeqlf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgeqlf_(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqlf,SGEQLF)))));
#else
#ifndef __APPLE__
void sgeqlf(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqlf,SGEQLF)))));
#else
void sgeqlf(blasint* m, blasint* n, float* a, blasint* lda, float* tau, float* work, blasint* lwork, blasint* info){ FC_GLOBAL(sgeqlf,SGEQLF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgeqlf_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_sgeqlf < __flexiblas_hooks->sgeqlf.nhook) {
        fn_hook = __flexiblas_hooks->sgeqlf.f77_hook_function[hook_pos_sgeqlf];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_sgeqlf = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) lwork, (void*) info); 
