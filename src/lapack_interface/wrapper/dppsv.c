...
#endif
{
	...
	fn = current_backend->lapack.dppsv.f77_blas_function; 
	fn_hook = __flexiblas_hooks->dppsv.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void flexiblas_chain_dppsv_(void* uplo, void* n, void* nrhs, void* ap, void* b, void* ldb, void* info)
{
    ...
    if( hook_pos_dppsv < __flexiblas_hooks->dppsv.nhook) {
        fn_hook = __flexiblas_hooks->dppsv.f77_hook_function[hook_pos_dppsv];
        fn_hook((void*) uplo, (void*) n, (void*) nrhs, (void*) ap, (void*) b, (void*) ldb, (void*) info);
    } else {
        hook_pos_dppsv = 0;
		fn((void*) uplo, (void*) n, (void*) nrhs, (void*) ap, (void*) b, (void*) ldb, (void*) info); 
