...
#endif
{
	...
	fn = current_backend->lapack.cgetsqrhrt.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgetsqrhrt.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgetsqrhrt_(blasint* m, blasint* n, blasint* mb1, blasint* nb1, blasint* nb2, float complex* a, blasint* lda, float complex* t, blasint* ldt, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgetsqrhrt,CGETSQRHRT)))));
#else
#ifndef __APPLE__
void cgetsqrhrt(blasint* m, blasint* n, blasint* mb1, blasint* nb1, blasint* nb2, float complex* a, blasint* lda, float complex* t, blasint* ldt, float complex* work, blasint* lwork, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgetsqrhrt,CGETSQRHRT)))));
#else
void cgetsqrhrt(blasint* m, blasint* n, blasint* mb1, blasint* nb1, blasint* nb2, float complex* a, blasint* lda, float complex* t, blasint* ldt, float complex* work, blasint* lwork, blasint* info){ FC_GLOBAL(cgetsqrhrt,CGETSQRHRT)((void*) m, (void*) n, (void*) mb1, (void*) nb1, (void*) nb2, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgetsqrhrt_(void* m, void* n, void* mb1, void* nb1, void* nb2, void* a, void* lda, void* t, void* ldt, void* work, void* lwork, void* info)
{
    ...
    if( hook_pos_cgetsqrhrt < __flexiblas_hooks->cgetsqrhrt.nhook) {
        fn_hook = __flexiblas_hooks->cgetsqrhrt.f77_hook_function[hook_pos_cgetsqrhrt];
        fn_hook((void*) m, (void*) n, (void*) mb1, (void*) nb1, (void*) nb2, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info);
    } else {
        hook_pos_cgetsqrhrt = 0;
		fn((void*) m, (void*) n, (void*) mb1, (void*) nb1, (void*) nb2, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) lwork, (void*) info); 
