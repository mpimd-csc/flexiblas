...
void zlassq_(blasint* n, float complex* x, blasint* incx, float* scale, float* sumsq) __attribute__((alias(MTS(FC_GLOBAL(zlassq,ZLASSQ)))));
#else
#ifndef __APPLE__
void zlassq(blasint* n, float complex* x, blasint* incx, float* scale, float* sumsq) __attribute__((alias(MTS(FC_GLOBAL(zlassq,ZLASSQ)))));
#else
void zlassq(blasint* n, float complex* x, blasint* incx, float* scale, float* sumsq){ FC_GLOBAL(zlassq,ZLASSQ)((void*) n, (void*) x, (void*) incx, (void*) scale, (void*) sumsq); }
#endif
#endif
