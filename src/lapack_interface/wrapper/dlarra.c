...
static TLS_STORE uint8_t hook_pos_dlarra = 0;
...
#ifndef __APPLE__
void FC_GLOBAL2(dlarra,DLARRA)(blasint* n, double* d, double* e, double* e2, double* spltol, double* tnrm, blasint* nsplit, blasint* isplit, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dlarra,DLARRA)))));
void FC_GLOBAL3(dlarra,DLARRA)(blasint* n, double* d, double* e, double* e2, double* spltol, double* tnrm, blasint* nsplit, blasint* isplit, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(dlarra,DLARRA)))));
#else
void FC_GLOBAL2(dlarra,DLARRA)(blasint* n, double* d, double* e, double* e2, double* spltol, double* tnrm, blasint* nsplit, blasint* isplit, blasint* info){ FC_GLOBAL(dlarra,DLARRA)((void*) n, (void*) d, (void*) e, (void*) e2, (void*) spltol, (void*) tnrm, (void*) nsplit, (void*) isplit, (void*) info); }
void FC_GLOBAL3(dlarra,DLARRA)(blasint* n, double* d, double* e, double* e2, double* spltol, double* tnrm, blasint* nsplit, blasint* isplit, blasint* info){ FC_GLOBAL(dlarra,DLARRA)((void*) n, (void*) d, (void*) e, (void*) e2, (void*) spltol, (void*) tnrm, (void*) nsplit, (void*) isplit, (void*) info); }
#endif
