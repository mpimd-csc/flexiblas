...
#ifndef __APPLE__
void FC_GLOBAL2(zpptrf,ZPPTRF)(char* uplo, blasint* n, double complex* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(zpptrf,ZPPTRF)))));
void FC_GLOBAL3(zpptrf,ZPPTRF)(char* uplo, blasint* n, double complex* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(zpptrf,ZPPTRF)))));
#else
void FC_GLOBAL2(zpptrf,ZPPTRF)(char* uplo, blasint* n, double complex* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(zpptrf,ZPPTRF)((void*) uplo, (void*) n, (void*) ap, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
void FC_GLOBAL3(zpptrf,ZPPTRF)(char* uplo, blasint* n, double complex* ap, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(zpptrf,ZPPTRF)((void*) uplo, (void*) n, (void*) ap, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
