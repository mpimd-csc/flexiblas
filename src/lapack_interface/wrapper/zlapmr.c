...
#ifndef __APPLE__
void FC_GLOBAL2(zlapmr,ZLAPMR)(blaslogical* forwrd, blasint* m, blasint* n, double complex* x, blasint* ldx, blasint* k) __attribute__((alias(MTS(FC_GLOBAL(zlapmr,ZLAPMR)))));
void FC_GLOBAL3(zlapmr,ZLAPMR)(blaslogical* forwrd, blasint* m, blasint* n, double complex* x, blasint* ldx, blasint* k) __attribute__((alias(MTS(FC_GLOBAL(zlapmr,ZLAPMR)))));
#else
void FC_GLOBAL2(zlapmr,ZLAPMR)(blaslogical* forwrd, blasint* m, blasint* n, double complex* x, blasint* ldx, blasint* k){ FC_GLOBAL(zlapmr,ZLAPMR)((void*) forwrd, (void*) m, (void*) n, (void*) x, (void*) ldx, (void*) k); }
void FC_GLOBAL3(zlapmr,ZLAPMR)(blaslogical* forwrd, blasint* m, blasint* n, double complex* x, blasint* ldx, blasint* k){ FC_GLOBAL(zlapmr,ZLAPMR)((void*) forwrd, (void*) m, (void*) n, (void*) x, (void*) ldx, (void*) k); }
#endif
