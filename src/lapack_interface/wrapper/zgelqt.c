...
#ifndef __APPLE__
void FC_GLOBAL2(zgelqt,ZGELQT)(blasint* m, blasint* n, blasint* mb, double complex* a, blasint* lda, double complex* t, blasint* ldt, double complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgelqt,ZGELQT)))));
void FC_GLOBAL3(zgelqt,ZGELQT)(blasint* m, blasint* n, blasint* mb, double complex* a, blasint* lda, double complex* t, blasint* ldt, double complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgelqt,ZGELQT)))));
#else
void FC_GLOBAL2(zgelqt,ZGELQT)(blasint* m, blasint* n, blasint* mb, double complex* a, blasint* lda, double complex* t, blasint* ldt, double complex* work, blasint* info){ FC_GLOBAL(zgelqt,ZGELQT)((void*) m, (void*) n, (void*) mb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info); }
void FC_GLOBAL3(zgelqt,ZGELQT)(blasint* m, blasint* n, blasint* mb, double complex* a, blasint* lda, double complex* t, blasint* ldt, double complex* work, blasint* info){ FC_GLOBAL(zgelqt,ZGELQT)((void*) m, (void*) n, (void*) mb, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) work, (void*) info); }
#endif
