...
#endif
{
	...
	fn = current_backend->lapack.sgeqrt3.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgeqrt3.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgeqrt3_(blasint* m, blasint* n, float* a, blasint* lda, float* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqrt3,SGEQRT3)))));
#else
#ifndef __APPLE__
void sgeqrt3(blasint* m, blasint* n, float* a, blasint* lda, float* t, blasint* ldt, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgeqrt3,SGEQRT3)))));
#else
void sgeqrt3(blasint* m, blasint* n, float* a, blasint* lda, float* t, blasint* ldt, blasint* info){ FC_GLOBAL(sgeqrt3,SGEQRT3)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgeqrt3_(void* m, void* n, void* a, void* lda, void* t, void* ldt, void* info)
{
    ...
    if( hook_pos_sgeqrt3 < __flexiblas_hooks->sgeqrt3.nhook) {
        fn_hook = __flexiblas_hooks->sgeqrt3.f77_hook_function[hook_pos_sgeqrt3];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info);
    } else {
        hook_pos_sgeqrt3 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) t, (void*) ldt, (void*) info); 
