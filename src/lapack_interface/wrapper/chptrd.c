...
void chptrd_(char* uplo, blasint* n, float complex* ap, float* d, float* e, float complex* tau, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(chptrd,CHPTRD)))));
#else
#ifndef __APPLE__
void chptrd(char* uplo, blasint* n, float complex* ap, float* d, float* e, float complex* tau, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL(chptrd,CHPTRD)))));
#else
void chptrd(char* uplo, blasint* n, float complex* ap, float* d, float* e, float complex* tau, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL(chptrd,CHPTRD)((void*) uplo, (void*) n, (void*) ap, (void*) d, (void*) e, (void*) tau, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
