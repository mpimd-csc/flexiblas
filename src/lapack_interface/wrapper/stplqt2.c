...
#endif
{
	...
	fn = current_backend->lapack.stplqt2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->stplqt2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
#else
void stplqt2(blasint* m, blasint* n, blasint* l, float* a, blasint* lda, float* b, blasint* ldb, float* t, blasint* ldt, blasint* info){ FC_GLOBAL(stplqt2,STPLQT2)((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) info); }
#endif
#endif
...
void flexiblas_chain_stplqt2_(void* m, void* n, void* l, void* a, void* lda, void* b, void* ldb, void* t, void* ldt, void* info)
{
    ...
    if( hook_pos_stplqt2 < __flexiblas_hooks->stplqt2.nhook) {
        fn_hook = __flexiblas_hooks->stplqt2.f77_hook_function[hook_pos_stplqt2];
        fn_hook((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) info);
    } else {
        hook_pos_stplqt2 = 0;
		fn((void*) m, (void*) n, (void*) l, (void*) a, (void*) lda, (void*) b, (void*) ldb, (void*) t, (void*) ldt, (void*) info); 
