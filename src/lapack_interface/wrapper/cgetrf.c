...
#endif
{
	...
	fn = current_backend->lapack.cgetrf.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgetrf.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgetrf_(blasint* m, blasint* n, float complex* a, blasint* lda, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgetrf,CGETRF)))));
#else
#ifndef __APPLE__
void cgetrf(blasint* m, blasint* n, float complex* a, blasint* lda, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgetrf,CGETRF)))));
#else
void cgetrf(blasint* m, blasint* n, float complex* a, blasint* lda, blasint* ipiv, blasint* info){ FC_GLOBAL(cgetrf,CGETRF)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgetrf_(void* m, void* n, void* a, void* lda, void* ipiv, void* info)
{
    ...
    if( hook_pos_cgetrf < __flexiblas_hooks->cgetrf.nhook) {
        fn_hook = __flexiblas_hooks->cgetrf.f77_hook_function[hook_pos_cgetrf];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info);
    } else {
        hook_pos_cgetrf = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) info); 
