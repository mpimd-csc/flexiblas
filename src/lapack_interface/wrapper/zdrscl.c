...
#ifndef __APPLE__
void FC_GLOBAL2(zdrscl,ZDRSCL)(blasint* n, double* sa, double complex* sx, blasint* incx) __attribute__((alias(MTS(FC_GLOBAL(zdrscl,ZDRSCL)))));
void FC_GLOBAL3(zdrscl,ZDRSCL)(blasint* n, double* sa, double complex* sx, blasint* incx) __attribute__((alias(MTS(FC_GLOBAL(zdrscl,ZDRSCL)))));
#else
void FC_GLOBAL2(zdrscl,ZDRSCL)(blasint* n, double* sa, double complex* sx, blasint* incx){ FC_GLOBAL(zdrscl,ZDRSCL)((void*) n, (void*) sa, (void*) sx, (void*) incx); }
void FC_GLOBAL3(zdrscl,ZDRSCL)(blasint* n, double* sa, double complex* sx, blasint* incx){ FC_GLOBAL(zdrscl,ZDRSCL)((void*) n, (void*) sa, (void*) sx, (void*) incx); }
#endif
