...
#ifndef __APPLE__
void FC_GLOBAL2(zptts2,ZPTTS2)(blasint* iuplo, blasint* n, blasint* nrhs, double* d, double complex* e, double complex* b, blasint* ldb) __attribute__((alias(MTS(FC_GLOBAL(zptts2,ZPTTS2)))));
void FC_GLOBAL3(zptts2,ZPTTS2)(blasint* iuplo, blasint* n, blasint* nrhs, double* d, double complex* e, double complex* b, blasint* ldb) __attribute__((alias(MTS(FC_GLOBAL(zptts2,ZPTTS2)))));
#else
void FC_GLOBAL2(zptts2,ZPTTS2)(blasint* iuplo, blasint* n, blasint* nrhs, double* d, double complex* e, double complex* b, blasint* ldb){ FC_GLOBAL(zptts2,ZPTTS2)((void*) iuplo, (void*) n, (void*) nrhs, (void*) d, (void*) e, (void*) b, (void*) ldb); }
void FC_GLOBAL3(zptts2,ZPTTS2)(blasint* iuplo, blasint* n, blasint* nrhs, double* d, double complex* e, double complex* b, blasint* ldb){ FC_GLOBAL(zptts2,ZPTTS2)((void*) iuplo, (void*) n, (void*) nrhs, (void*) d, (void*) e, (void*) b, (void*) ldb); }
#endif
