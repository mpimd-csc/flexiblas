...
#endif 
{
	...
	fn = current_backend->lapack.chesv_rook.call_fblas; 
	if ( __flexiblas_profile ) {
		ts = flexiblas_wtime(); 
		fn((void*) uplo, (void*) n, (void*) nrhs, (void*) a, (void*) lda, (void*) ipiv, (void*) b, (void*) ldb, (void*) work, (void*) lwork, (void*) info); 
		current_backend->lapack.chesv_rook.timings[0] += (flexiblas_wtime() -ts);
		current_backend->lapack.chesv_rook.calls[0]++;
	} else { 
		fn((void*) uplo, (void*) n, (void*) nrhs, (void*) a, (void*) lda, (void*) ipiv, (void*) b, (void*) ldb, (void*) work, (void*) lwork, (void*) info); 
	} 
	return;
