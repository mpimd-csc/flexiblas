...
#endif
{
	...
	fn = current_backend->lapack.cgerq2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->cgerq2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void cgerq2_(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgerq2,CGERQ2)))));
#else
#ifndef __APPLE__
void cgerq2(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(cgerq2,CGERQ2)))));
#else
void cgerq2(blasint* m, blasint* n, float complex* a, blasint* lda, float complex* tau, float complex* work, blasint* info){ FC_GLOBAL(cgerq2,CGERQ2)((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_cgerq2_(void* m, void* n, void* a, void* lda, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_cgerq2 < __flexiblas_hooks->cgerq2.nhook) {
        fn_hook = __flexiblas_hooks->cgerq2.f77_hook_function[hook_pos_cgerq2];
        fn_hook((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_cgerq2 = 0;
		fn((void*) m, (void*) n, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); 
