...
void ssytri_rook_(char* uplo, blasint* n, float* a, blasint* lda, blasint* ipiv, float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(ssytri_rook,SSYTRI_ROOK)))));
#else
#ifndef __APPLE__
void ssytri_rook(char* uplo, blasint* n, float* a, blasint* lda, blasint* ipiv, float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo) __attribute__((alias(MTS(FC_GLOBAL_(ssytri_rook,SSYTRI_ROOK)))));
#else
void ssytri_rook(char* uplo, blasint* n, float* a, blasint* lda, blasint* ipiv, float* work, blasint* info, flexiblas_fortran_charlen_t len_uplo){ FC_GLOBAL_(ssytri_rook,SSYTRI_ROOK)((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) work, (void*) info, (flexiblas_fortran_charlen_t) len_uplo); }
#endif
#endif
