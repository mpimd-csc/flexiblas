...
#endif 
{
	...
	fn = current_backend->lapack.ssytri_rook.call_fblas; 
	if ( __flexiblas_profile ) {
		ts = flexiblas_wtime(); 
		fn((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) work, (void*) info); 
		current_backend->lapack.ssytri_rook.timings[0] += (flexiblas_wtime() -ts);
		current_backend->lapack.ssytri_rook.calls[0]++;
	} else { 
		fn((void*) uplo, (void*) n, (void*) a, (void*) lda, (void*) ipiv, (void*) work, (void*) info); 
	} 
	return;
