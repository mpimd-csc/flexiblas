...
#ifndef __APPLE__
void FC_GLOBAL2(zgttrf,ZGTTRF)(blasint* n, double complex* dl, double complex* d, double complex* du, double complex* du2, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgttrf,ZGTTRF)))));
void FC_GLOBAL3(zgttrf,ZGTTRF)(blasint* n, double complex* dl, double complex* d, double complex* du, double complex* du2, blasint* ipiv, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(zgttrf,ZGTTRF)))));
#else
void FC_GLOBAL2(zgttrf,ZGTTRF)(blasint* n, double complex* dl, double complex* d, double complex* du, double complex* du2, blasint* ipiv, blasint* info){ FC_GLOBAL(zgttrf,ZGTTRF)((void*) n, (void*) dl, (void*) d, (void*) du, (void*) du2, (void*) ipiv, (void*) info); }
void FC_GLOBAL3(zgttrf,ZGTTRF)(blasint* n, double complex* dl, double complex* d, double complex* du, double complex* du2, blasint* ipiv, blasint* info){ FC_GLOBAL(zgttrf,ZGTTRF)((void*) n, (void*) dl, (void*) d, (void*) du, (void*) du2, (void*) ipiv, (void*) info); }
#endif
