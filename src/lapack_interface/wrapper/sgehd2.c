...
#endif
{
	...
	fn = current_backend->lapack.sgehd2.f77_blas_function; 
	fn_hook = __flexiblas_hooks->sgehd2.f77_hook_function[0]; 
	if ( fn_hook == NULL ) { 
...
void sgehd2_(blasint* n, blasint* ilo, blasint* ihi, float* a, blasint* lda, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgehd2,SGEHD2)))));
#else
#ifndef __APPLE__
void sgehd2(blasint* n, blasint* ilo, blasint* ihi, float* a, blasint* lda, float* tau, float* work, blasint* info) __attribute__((alias(MTS(FC_GLOBAL(sgehd2,SGEHD2)))));
#else
void sgehd2(blasint* n, blasint* ilo, blasint* ihi, float* a, blasint* lda, float* tau, float* work, blasint* info){ FC_GLOBAL(sgehd2,SGEHD2)((void*) n, (void*) ilo, (void*) ihi, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); }
#endif
#endif
...
void flexiblas_chain_sgehd2_(void* n, void* ilo, void* ihi, void* a, void* lda, void* tau, void* work, void* info)
{
    ...
    if( hook_pos_sgehd2 < __flexiblas_hooks->sgehd2.nhook) {
        fn_hook = __flexiblas_hooks->sgehd2.f77_hook_function[hook_pos_sgehd2];
        fn_hook((void*) n, (void*) ilo, (void*) ihi, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info);
    } else {
        hook_pos_sgehd2 = 0;
		fn((void*) n, (void*) ilo, (void*) ihi, (void*) a, (void*) lda, (void*) tau, (void*) work, (void*) info); 
