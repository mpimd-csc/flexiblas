...
HIDDEN int __flexiblas_load_flapack ( flexiblas_backend_t *handle, int *loaded, int *failed )  {
	...
	LOAD_FLAPACK(handle,lapack.cgedmd,cgedmd);
	LOAD_FLAPACK(handle,lapack.cgedmdq,cgedmdq);
	...
	LOAD_FLAPACK(handle,lapack.cgelqs,cgelqs);
	...
	LOAD_FLAPACK(handle,lapack.cgeqp3rk,cgeqp3rk);
	...
	LOAD_FLAPACK(handle,lapack.cgeqrs,cgeqrs);
	...
	LOAD_FLAPACK(handle,lapack.claqp2rk,claqp2rk);
	LOAD_FLAPACK(handle,lapack.claqp3rk,claqp3rk);
	...
	LOAD_FLAPACK(handle,lapack.crscl,crscl);
	...
	LOAD_FLAPACK(handle,lapack.dgedmd,dgedmd);
	LOAD_FLAPACK(handle,lapack.dgedmdq,dgedmdq);
	...
	LOAD_FLAPACK(handle,lapack.dgelqs,dgelqs);
	...
	LOAD_FLAPACK(handle,lapack.dgeqp3rk,dgeqp3rk);
	...
	LOAD_FLAPACK(handle,lapack.dgeqrs,dgeqrs);
	...
	LOAD_FLAPACK(handle,lapack.dlaqp2rk,dlaqp2rk);
	LOAD_FLAPACK(handle,lapack.dlaqp3rk,dlaqp3rk);
	...
	LOAD_FLAPACK(handle,lapack.sgedmd,sgedmd);
	LOAD_FLAPACK(handle,lapack.sgedmdq,sgedmdq);
	...
	LOAD_FLAPACK(handle,lapack.sgelqs,sgelqs);
	...
	LOAD_FLAPACK(handle,lapack.sgeqp3rk,sgeqp3rk);
	...
	LOAD_FLAPACK(handle,lapack.sgeqrs,sgeqrs);
	...
	LOAD_FLAPACK(handle,lapack.slaqp2rk,slaqp2rk);
	LOAD_FLAPACK(handle,lapack.slaqp3rk,slaqp3rk);
	...
	LOAD_FLAPACK(handle,lapack.xerbla,xerbla);
	...
	LOAD_FLAPACK(handle,lapack.zgedmd,zgedmd);
	LOAD_FLAPACK(handle,lapack.zgedmdq,zgedmdq);
	...
	LOAD_FLAPACK(handle,lapack.zgelqs,zgelqs);
	...
	LOAD_FLAPACK(handle,lapack.zgeqp3rk,zgeqp3rk);
	...
	LOAD_FLAPACK(handle,lapack.zgeqrs,zgeqrs);
	...
	LOAD_FLAPACK(handle,lapack.zlaqp2rk,zlaqp2rk);
	LOAD_FLAPACK(handle,lapack.zlaqp3rk,zlaqp3rk);
	...
	LOAD_FLAPACK(handle,lapack.zrscl,zrscl);
