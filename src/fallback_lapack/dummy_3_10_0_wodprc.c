...
#include "lapack_3_10_0_wodprc_gnu.h"
#else
#include "lapack_3_10_0_wodprc_intel.h"
#endif
...
HIDDEN void flexiblas_lapack_dummy_function_not_called(void) {
    ...
    __flexiblas_lapack_addr[k++] = (void *)((size_t) &(FC_GLOBAL(dcombssq,DCOMBSSQ)));
    ...
    __flexiblas_lapack_addr[k++] = (void *)((size_t) &(FC_GLOBAL(scombssq,SCOMBSSQ)));
