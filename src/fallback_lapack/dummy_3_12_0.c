...
void FC_GLOBAL(cgedmd,CGEDMD)(void);
void FC_GLOBAL(cgedmdq,CGEDMDQ)(void);
...
void FC_GLOBAL(cgegs,CGEGS)(void);
void FC_GLOBAL(cgegv,CGEGV)(void);
...
void FC_GLOBAL(cgelqs,CGELQS)(void);
...
void FC_GLOBAL(cgelsx,CGELSX)(void);
...
void FC_GLOBAL(cgeqp3rk,CGEQP3RK)(void);
void FC_GLOBAL(cgeqpf,CGEQPF)(void);
...
void FC_GLOBAL(cgeqrs,CGEQRS)(void);
...
void FC_GLOBAL(cggsvd,CGGSVD)(void);
void FC_GLOBAL(cggsvd3,CGGSVD3)(void);
void FC_GLOBAL(cggsvp,CGGSVP)(void);
...
void FC_GLOBAL(clahrd,CLAHRD)(void);
...
void FC_GLOBAL(claqp2rk,CLAQP2RK)(void);
void FC_GLOBAL(claqp3rk,CLAQP3RK)(void);
...
void FC_GLOBAL(clatzm,CLATZM)(void);
...
void FC_GLOBAL(crscl,CRSCL)(void);
...
void FC_GLOBAL(ctzrqf,CTZRQF)(void);
...
void FC_GLOBAL(dgedmd,DGEDMD)(void);
void FC_GLOBAL(dgedmdq,DGEDMDQ)(void);
...
void FC_GLOBAL(dgegs,DGEGS)(void);
void FC_GLOBAL(dgegv,DGEGV)(void);
...
void FC_GLOBAL(dgelqs,DGELQS)(void);
...
void FC_GLOBAL(dgelsx,DGELSX)(void);
...
void FC_GLOBAL(dgeqp3rk,DGEQP3RK)(void);
void FC_GLOBAL(dgeqpf,DGEQPF)(void);
...
void FC_GLOBAL(dgeqrs,DGEQRS)(void);
...
void FC_GLOBAL(dggsvd,DGGSVD)(void);
void FC_GLOBAL(dggsvd3,DGGSVD3)(void);
void FC_GLOBAL(dggsvp,DGGSVP)(void);
...
void FC_GLOBAL(dlahrd,DLAHRD)(void);
...
void FC_GLOBAL(dlaqp2rk,DLAQP2RK)(void);
void FC_GLOBAL(dlaqp3rk,DLAQP3RK)(void);
...
void FC_GLOBAL(dlatzm,DLATZM)(void);
...
void FC_GLOBAL(dtzrqf,DTZRQF)(void);
...
void FC_GLOBAL(sgedmd,SGEDMD)(void);
void FC_GLOBAL(sgedmdq,SGEDMDQ)(void);
...
void FC_GLOBAL(sgegs,SGEGS)(void);
void FC_GLOBAL(sgegv,SGEGV)(void);
...
void FC_GLOBAL(sgelqs,SGELQS)(void);
...
void FC_GLOBAL(sgelsx,SGELSX)(void);
...
void FC_GLOBAL(sgeqp3rk,SGEQP3RK)(void);
void FC_GLOBAL(sgeqpf,SGEQPF)(void);
...
void FC_GLOBAL(sgeqrs,SGEQRS)(void);
...
void FC_GLOBAL(sggsvd,SGGSVD)(void);
void FC_GLOBAL(sggsvd3,SGGSVD3)(void);
void FC_GLOBAL(sggsvp,SGGSVP)(void);
...
void FC_GLOBAL(slahrd,SLAHRD)(void);
...
void FC_GLOBAL(slaqp2rk,SLAQP2RK)(void);
void FC_GLOBAL(slaqp3rk,SLAQP3RK)(void);
...
void FC_GLOBAL(slatzm,SLATZM)(void);
...
void FC_GLOBAL(stzrqf,STZRQF)(void);
void FC_GLOBAL(stzrzf,STZRZF)(void);
void FC_GLOBAL(xerbla,XERBLA)(void);
...
void FC_GLOBAL(zgedmd,ZGEDMD)(void);
void FC_GLOBAL(zgedmdq,ZGEDMDQ)(void);
...
void FC_GLOBAL(zgegs,ZGEGS)(void);
void FC_GLOBAL(zgegv,ZGEGV)(void);
...
void FC_GLOBAL(zgelqs,ZGELQS)(void);
...
void FC_GLOBAL(zgelsx,ZGELSX)(void);
...
void FC_GLOBAL(zgeqp3rk,ZGEQP3RK)(void);
void FC_GLOBAL(zgeqpf,ZGEQPF)(void);
...
void FC_GLOBAL(zgeqrs,ZGEQRS)(void);
...
void FC_GLOBAL(zggsvd,ZGGSVD)(void);
void FC_GLOBAL(zggsvd3,ZGGSVD3)(void);
void FC_GLOBAL(zggsvp,ZGGSVP)(void);
...
void FC_GLOBAL(zlahrd,ZLAHRD)(void);
...
void FC_GLOBAL(zlaqp2rk,ZLAQP2RK)(void);
void FC_GLOBAL(zlaqp3rk,ZLAQP3RK)(void);
...
void FC_GLOBAL(zlatzm,ZLATZM)(void);
...
void FC_GLOBAL(zrscl,ZRSCL)(void);
...
void FC_GLOBAL(ztzrqf,ZTZRQF)(void);
...
HIDDEN void flexiblas_lapack_dummy_function_not_called(void)
{
    ...
    FC_GLOBAL(stzrqf,STZRQF)();
    FC_GLOBAL(stzrzf,STZRZF)();
    FC_GLOBAL(xerbla,XERBLA)();
