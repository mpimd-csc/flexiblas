...
extern "C" { 
    ...
    typedef enum {
        ...
        FLEXIBLAS_DEFAULT = 3       /**<  The compiled in default, only used with properties. */    
    ...
    typedef enum {
        ...
        FLEXIBLAS_PROP_PROFILE = 1,     /**< Enable/Disable the profiling, The value is a standart C \b int.  */ 
        FLEXIBLAS_PROP_PROFILE_FILE = 2 /**< Set the output for the profiling process. The value is a string. */  
