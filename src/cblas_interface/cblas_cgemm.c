...
static TLS_STORE uint8_t hook_cblas_cgemm_pos = 0;
...
#define F77_ldc ldc
    ...
    if ( current_backend->blas.cgemm.cblas_function != NULL ) {
        void (*fn)
            (const CBLAS_LAYOUT layout, const CBLAS_TRANSPOSE TransA,
             const CBLAS_TRANSPOSE TransB, const CBLAS_INT M, const CBLAS_INT N,
             const CBLAS_INT K, const void *alpha, const void  *A,
             const CBLAS_INT lda, const void  *B, const CBLAS_INT ldb,
             const void *beta, void  *C, const CBLAS_INT ldc);
        *(void **) & fn = current_backend->blas.cgemm.cblas_function;
        fn(layout,TransA,TransB,M,N,K,alpha,A,lda,B,ldb,beta,C,ldc);
    } else {
        ...
        if( layout == CblasColMajor )
        {
            ...
            FC_GLOBAL(cgemm,CGEMM)(F77_TA, F77_TB, (blasint *)(uintptr_t)&F77_M, (blasint *)(uintptr_t)&F77_N, (blasint *)(uintptr_t)&F77_K, (void *)(uintptr_t) alpha, (void *)(uintptr_t) A,
        ...
        } else if (layout == CblasRowMajor)
        {
            ...
            FC_GLOBAL(cgemm,CGEMM)(F77_TA, F77_TB, (blasint *)(uintptr_t)&F77_N, (blasint *)(uintptr_t)&F77_M, (blasint *)(uintptr_t)&F77_K, (void *)(uintptr_t) alpha, (void *)(uintptr_t) B,
