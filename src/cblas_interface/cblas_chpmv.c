    ...
    if ( current_backend->blas.chpmv.cblas_function != NULL ) {
        void (*fn)
            (const CBLAS_LAYOUT layout,
             ...
             const void  *X, const CBLAS_INT incX, const void *beta,
             void  *Y, const CBLAS_INT incY);
        *(void **) &fn = current_backend->blas.chpmv.cblas_function;
        fn(layout,Uplo,N,alpha,AP,X,incX,beta,Y,incY);
    } else {
        CBLAS_INT n, i=0;
        ...
        float *x, *xx, *y=(float *)(uintptr_t)Y, *st=0, *tx;
        ...
        if (layout == CblasColMajor)
        {
            ...
            F77_UL = C2F_CHAR(&UL);
#endif
            FC_GLOBAL(chpmv,CHPMV)(F77_UL, (blasint *)(uintptr_t)&F77_N, (void *)(uintptr_t) alpha, (void *)(uintptr_t) AP, (void *)(uintptr_t) X,
        ...
        else if (layout == CblasRowMajor)
        {
            ...
            FC_GLOBAL(chpmv,CHPMV)(F77_UL, (blasint *)(uintptr_t)&F77_N, (void *)(uintptr_t) ALPHA,
