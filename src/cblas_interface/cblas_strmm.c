    ...
    if ( current_backend->blas.strmm.cblas_function != NULL ) {
        ...
        *(void **) & fn = current_backend->blas.strmm.cblas_function;
        ...
        if( layout == CblasColMajor )
        {
            ...
            FC_GLOBAL(strmm,STRMM)(F77_SD, F77_UL, F77_TA, F77_DI, (blasint *)(uintptr_t)&F77_M, (blasint *)(uintptr_t)&F77_N, (float *)(uintptr_t) &alpha, (float *)(uintptr_t) A, (blasint *)(uintptr_t)&F77_lda, B, (blasint *)(uintptr_t)&F77_ldb, 1, 1,1 ,1);
        } else if (layout == CblasRowMajor)
        {
            ...
            FC_GLOBAL(strmm,STRMM)(F77_SD, F77_UL, F77_TA, F77_DI, (blasint *)(uintptr_t)&F77_N, (blasint *)(uintptr_t)&F77_M, (float *)(uintptr_t) &alpha, (float *)(uintptr_t) A, (blasint *)(uintptr_t)&F77_lda, B, (blasint *)(uintptr_t)&F77_ldb, 1, 1, 1, 1);
        }
