...
CBLAS_INDEX cblas_izamax( const int N, const void *X, const int incX)
{
    ...
    CBLAS_INDEX (*fn) ( const int N, const void *X, const int incX);
    CBLAS_BACKEND_INIT();
...
#define F77_incX incX
    ...
    if ( current_backend->blas.izamax.cblas_function != NULL ) {
        CBLAS_INDEX (*fn) ( const int N, const void *X, const int incX)  = current_backend->blas.izamax.cblas_function;
        iamax = fn(N,X,incX);
