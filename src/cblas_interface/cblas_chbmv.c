    ...
    if ( current_backend->blas.chbmv.cblas_function != NULL ) {
        ...
        *(void **) &fn = current_backend->blas.chbmv.cblas_function;
        ...
        if (layout == CblasColMajor)
        {
            ...
            F77_UL = C2F_CHAR(&UL);
#endif
            FC_GLOBAL(chbmv,CHBMV)(F77_UL, (blasint *)(uintptr_t)&F77_N, (blasint *)(uintptr_t)&F77_K, (void *)(uintptr_t) alpha, (void *)(uintptr_t) A, (blasint *)(uintptr_t)&F77_lda, (void *)(uintptr_t) X,
        ...
        else if (layout == CblasRowMajor)
        {
            ...
            F77_UL = C2F_CHAR(&UL);
#endif
            FC_GLOBAL(chbmv,CHBMV)(F77_UL, (blasint *)(uintptr_t)&F77_N, (blasint *)(uintptr_t)&F77_K, (void *)(uintptr_t) ALPHA,
