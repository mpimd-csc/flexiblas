...
#define F77_lda lda
    ...
    if ( current_backend->blas.cgeru.cblas_function != NULL ) {
        ...
        *(void **) &fn = current_backend->blas.cgeru.cblas_function;
        ...
        {
            FC_GLOBAL(cgeru,CGERU)( (blasint *)(uintptr_t)&F77_M, (blasint *)(uintptr_t)&F77_N, (void *)(uintptr_t) alpha, (void *)(uintptr_t) X, (blasint *)(uintptr_t)&F77_incX, (void *)(uintptr_t) Y, (blasint *)(uintptr_t)&F77_incY, A,
