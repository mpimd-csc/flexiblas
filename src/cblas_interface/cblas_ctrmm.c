...
static TLS_STORE uint8_t hook_cblas_ctrmm_pos = 0;
...
#define F77_ldb ldb
    ...
    if ( current_backend->blas.ctrmm.cblas_function != NULL ) {
        ...
        void (*fn)
            (const CBLAS_LAYOUT layout, const CBLAS_SIDE Side,
             ...
             const void *alpha, const void  *A, const CBLAS_INT lda,
             void  *B, const CBLAS_INT ldb);
        *(void **) & fn = current_backend->blas.ctrmm.cblas_function;
        fn(layout,Side,Uplo,TransA,Diag,M,N,alpha,A,lda,B,ldb);
    } else {
        ...
        if( layout == CblasColMajor )
        {
            ...
            FC_GLOBAL(ctrmm,CTRMM)(F77_SD, F77_UL, F77_TA, F77_DI, (blasint *)(uintptr_t)&F77_M, (blasint *)(uintptr_t)&F77_N, (void *)(uintptr_t) alpha, (void *)(uintptr_t) A, (blasint *)(uintptr_t)&F77_lda, B, (blasint *)(uintptr_t)&F77_ldb, 1, 1, 1, 1);
        } else if (layout == CblasRowMajor)
        {
            ...
            FC_GLOBAL(ctrmm,CTRMM)(F77_SD, F77_UL, F77_TA, F77_DI, (blasint *)(uintptr_t)&F77_N, (blasint *)(uintptr_t)&F77_M, (void *)(uintptr_t) alpha, (void *)(uintptr_t) A, (blasint *)(uintptr_t)&F77_lda, B, (blasint *)(uintptr_t)&F77_ldb, 1,1, 1, 1);
        }
