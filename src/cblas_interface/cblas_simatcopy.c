...
void cblas_simatcopy(const CBLAS_ORDER CORDER, const CBLAS_TRANSPOSE CTRANS,
		     ...
		     const int cldb)
{
	   void (*fn)(const CBLAS_ORDER, const CBLAS_TRANSPOSE, const int, const int, const float, float *, const int, const int);
	   CBLAS_BACKEND_INIT();
...
void flexiblas_chain_cblas_simatcopy(const CBLAS_ORDER CORDER, const CBLAS_TRANSPOSE CTRANS,
		     ...
		     const int cldb)
{
	   void (*fn)(const CBLAS_ORDER, const CBLAS_TRANSPOSE, const int, const int, const float, float *, const int, const int) = current_backend->blas.simatcopy.cblas_function;
