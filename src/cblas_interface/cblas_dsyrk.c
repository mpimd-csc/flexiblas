...
static TLS_STORE uint8_t hook_cblas_dsyrk_pos = 0;
...
#define F77_ldc ldc
#endif
    if ( current_backend->blas.dsyrk.cblas_function != NULL ) {
        void (*fn)
            (const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo,
             const CBLAS_TRANSPOSE Trans, const CBLAS_INT N, const CBLAS_INT K,
             const double alpha, const double  *A, const CBLAS_INT lda,
        ...
        *(void **) &fn = current_backend->blas.dsyrk.cblas_function;
        ...
        if( layout == CblasColMajor )
        {
            ...
            FC_GLOBAL(dsyrk,DSYRK)(F77_UL, F77_TR, (blasint *)(uintptr_t)&F77_N, (blasint *)(uintptr_t)&F77_K, (double *)(uintptr_t)&alpha, (double *)(uintptr_t)A, (blasint *)(uintptr_t)&F77_lda, (double *)(uintptr_t)&beta, C, (blasint *)(uintptr_t)&F77_ldc, 1, 1);
