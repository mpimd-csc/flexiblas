	...
	fn	(layout,Uplo,N,alpha,X,incX,Y,incY,A);
	   ...
	   if (layout == CblasColMajor)
	   {
		 ...
		 F77_UL = C2F_CHAR(&UL);
	      ...
	      FC_GLOBAL(dspr2,DSPR2)(F77_UL, (blasint *)(uintptr_t)&F77_N, (double *)(uintptr_t)&alpha, (double *)(uintptr_t)X, (blasint *)(uintptr_t)&F77_incX, (double *)(uintptr_t)Y, (blasint *)(uintptr_t)&F77_incY, A, 1);
