...
static TLS_STORE uint8_t hook_cblas_chemm_pos = 0;
...
#define F77_ldc ldc
    ...
    if ( current_backend->blas.chemm.cblas_function != NULL ) {
        void (*fn)
            (const CBLAS_LAYOUT layout, const  CBLAS_SIDE Side,
             const CBLAS_UPLO Uplo, const CBLAS_INT M, const CBLAS_INT N,
             const void *alpha, const void *A, const CBLAS_INT lda,
             const void *B, const CBLAS_INT ldb, const void *beta,
             void *C, const CBLAS_INT ldc);
        *(void **) &fn = current_backend->blas.chemm.cblas_function;
        fn(layout,Side,Uplo,M,N,alpha,A,lda,B,ldb,beta,C,ldc);
    } else {
        ...
        if( layout == CblasColMajor )
        {
            ...
            FC_GLOBAL(chemm,CHEMM)(F77_SD, F77_UL, (blasint *)(uintptr_t)&F77_M, (blasint *)(uintptr_t)&F77_N, (void *)(uintptr_t) alpha, (void *)(uintptr_t) A, (blasint *)(uintptr_t)&F77_lda,
        ...
        } else if (layout == CblasRowMajor)
        {
            ...
            FC_GLOBAL(chemm,CHEMM)(F77_SD, F77_UL, (blasint *)(uintptr_t)&F77_N, (blasint *)(uintptr_t)&F77_M, (void *)(uintptr_t) alpha, (void *)(uintptr_t) A,
