...
static TLS_STORE uint8_t hook_cblas_dsymm_pos = 0;
...
#define F77_ldc ldc
#endif
    if ( current_backend->blas.dsymm.cblas_function != NULL ) {
        void (*fn)
            (const CBLAS_LAYOUT layout, const CBLAS_SIDE Side,
             const CBLAS_UPLO Uplo, const CBLAS_INT M, const CBLAS_INT N,
             const double alpha, const double  *A, const CBLAS_INT lda,
        ...
        *(void **) &fn = current_backend->blas.dsymm.cblas_function;
        ...
        if( layout == CblasColMajor )
        {
            ...
            FC_GLOBAL(dsymm,DSYMM)(F77_SD, F77_UL, (blasint *)(uintptr_t)&F77_M, (blasint *)(uintptr_t)&F77_N, (double *)(uintptr_t)&alpha, (double *)(uintptr_t)A, (blasint *)(uintptr_t)&F77_lda, (double *)(uintptr_t)B, (blasint *)(uintptr_t)&F77_ldb, (double *)(uintptr_t)&beta, C, (blasint *)(uintptr_t)&F77_ldc, 1, 1);
        } else if (layout == CblasRowMajor)
        {
            ...
            FC_GLOBAL(dsymm,DSYMM)(F77_SD, F77_UL, (blasint *)(uintptr_t)&F77_N, (blasint *)(uintptr_t)&F77_M, (double *)(uintptr_t)&alpha, (double *)(uintptr_t)A, (blasint *)(uintptr_t)&F77_lda, (double *)(uintptr_t)B, (blasint *)(uintptr_t)&F77_ldb, (double *)(uintptr_t)&beta, C, (blasint *)(uintptr_t)&F77_ldc, 1, 1);
        }
