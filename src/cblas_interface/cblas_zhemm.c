    ...
    if ( current_backend->blas.zhemm.cblas_function != NULL ) {
        void (*fn)
            (const CBLAS_LAYOUT layout, const  CBLAS_SIDE Side,
             ...
             const void *B, const CBLAS_INT ldb, const void *beta,
             void *C, const CBLAS_INT ldc);
        *(void **) & fn = current_backend->blas.zhemm.cblas_function;
        fn(layout,Side,Uplo,M,N,alpha,A,lda,B,ldb,beta,C,ldc);
    } else {
        ...
        if( layout == CblasColMajor )
        {
            ...
            FC_GLOBAL(zhemm,ZHEMM)(F77_SD, F77_UL, (blasint *)(uintptr_t)&F77_M, (blasint *)(uintptr_t)&F77_N, (void *)(uintptr_t) alpha, (void *)(uintptr_t) A, (blasint *)(uintptr_t)&F77_lda,
        ...
        } else if (layout == CblasRowMajor)
        {
            ...
            FC_GLOBAL(zhemm,ZHEMM)(F77_SD, F77_UL, (blasint *)(uintptr_t)&F77_N, (blasint *)(uintptr_t)&F77_M, (void *)(uintptr_t) alpha, (void *)(uintptr_t) A,
