    ...
    if ( current_backend->blas.dsbmv.cblas_function != NULL ) {
        void (*fn)
            (const CBLAS_LAYOUT layout,
             ...
             const double  *X, const CBLAS_INT incX, const double beta,
             double  *Y, const CBLAS_INT incY);
        *(void **) &fn = current_backend->blas.dsbmv.cblas_function;
        fn(layout,Uplo,N,K,alpha,A,lda,X,incX,beta,Y,incY);
    } else {
        ...
        if (layout == CblasColMajor)
        {
            ...
            FC_GLOBAL(dsbmv,DSBMV)(F77_UL, (blasint *)(uintptr_t)&F77_N, (blasint *)(uintptr_t)&F77_K, (double *)(uintptr_t)&alpha, (double *)(uintptr_t)A, (blasint *)(uintptr_t)&F77_lda, (double *)(uintptr_t)X, (blasint *)(uintptr_t)&F77_incX, (double *)(uintptr_t)&beta, Y, (blasint *)(uintptr_t)&F77_incY, 1);
        }
