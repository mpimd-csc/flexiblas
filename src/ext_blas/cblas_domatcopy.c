		     ...
		     double *b, const int cldb)
{
   ...
   if ( current_backend->blas.domatcopy.call_cblas != NULL ) {
	   void (*fn)(const CBLAS_ORDER, const CBLAS_TRANSPOSE, const int, const int, const double, const double *, const int, double *, const int) = current_backend->blas.domatcopy.call_cblas;
   ...
   current_backend->blas.domatcopy.calls[POS_CBLAS] ++;
}
