                       ...
                       const int incX, const float beta, float *Y, const int incY)
{
   ...
   if ( current_backend->blas.saxpby.call_cblas != NULL ) {
	   void (*fn)(const int , const float , const float *, const int,const float ,  const float *Y, const int ) = current_backend->blas.saxpby.call_cblas;
