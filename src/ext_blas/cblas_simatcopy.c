		     ...
		     const int cldb)
{
   ...
   if ( current_backend->extblas.simatcopy.call_cblas != NULL ) {
	   ...
	   void (*fn)(const enum CBLAS_ORDER, const enum CBLAS_TRANSPOSE, const int, const int, const float, float *, const int, const int) = current_backend->extblas.simatcopy.call_cblas;
