                       ...
                       const int incX, const double beta, double *Y, const int incY)
{
   ...
   if ( current_backend->blas.daxpby.call_cblas != NULL ) {
	   void (*fn)(const int , const double , const double *, const int, const double, const double *Y, const int ) = current_backend->blas.daxpby.call_cblas;
