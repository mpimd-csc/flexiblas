...
#include "flexiblas_fortran_mangle.h"
    ...
    void FC_GLOBAL(cgelst,CGELST)(char *trans, blasint *m, blasint *n, blasint *nrhs, lapack_complex_float *a, blasint *lda, lapack_complex_float *b, blasint *ldb, lapack_complex_float *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t trans_len);

    void FC_GLOBAL(cgelsx,CGELSX)(blasint *m, blasint *n, blasint *nrhs, lapack_complex_float *a, blasint *lda, lapack_complex_float *b, blasint *ldb, blasint *jpvt, float *rcond, blasint *rank, lapack_complex_float *work, float *rwork, blasint *info);
    ...
    void FC_GLOBAL(cggsvd,CGGSVD)(char *jobu, char *jobv, char *jobq, blasint *m, blasint *n, blasint *p, blasint *k, blasint *l, lapack_complex_float *a, blasint *lda, lapack_complex_float *b, blasint *ldb, float *alpha, float *beta, lapack_complex_float *u, blasint *ldu, lapack_complex_float *v, blasint *ldv, lapack_complex_float *q, blasint *ldq, lapack_complex_float *work, float *rwork, blasint *iwork, blasint *info, flexiblas_fortran_charlen_t jobu_len, flexiblas_fortran_charlen_t jobv_len, flexiblas_fortran_charlen_t jobq_len);
    ...
    void FC_GLOBAL(chesv_aa_2stage,CHESV_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, lapack_complex_float *a, blasint *lda, lapack_complex_float *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_float *b, blasint *ldb, lapack_complex_float *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(chetrf_aa_2stage,CHETRF_AA_2STAGE)(char *uplo, blasint *n, lapack_complex_float *a, blasint *lda, lapack_complex_float *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_float *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(chetrs_aa_2stage,CHETRS_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, lapack_complex_float *a, blasint *lda, lapack_complex_float *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_float *b, blasint *ldb, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(cladiv,CLADIV)(lapack_complex_float *ret, lapack_complex_float *x, lapack_complex_float *y);
    ...
    void FC_GLOBAL(clahef_aa,CLAHEF_AA)(char *uplo, blasint *j1, blasint *m, blasint *nb, lapack_complex_float *a, blasint *lda, blasint *ipiv, lapack_complex_float *h, blasint *ldh, lapack_complex_float *work, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(clarf1f,CLARF1F)(char *side, blasint *m, blasint *n, lapack_complex_float *v, blasint *incv, lapack_complex_float *tau, lapack_complex_float *c, blasint *ldc, lapack_complex_float *work, flexiblas_fortran_charlen_t side_len);

    void FC_GLOBAL(clarf1l,CLARF1L)(char *side, blasint *m, blasint *n, lapack_complex_float *v, blasint *incv, lapack_complex_float *tau, lapack_complex_float *c, blasint *ldc, lapack_complex_float *work, flexiblas_fortran_charlen_t side_len);
    ...
    void FC_GLOBAL(clarfb_gett,CLARFB_GETT)(char *ident, blasint *m, blasint *n, blasint *k, lapack_complex_float *t, blasint *ldt, lapack_complex_float *a, blasint *lda, lapack_complex_float *b, blasint *ldb, lapack_complex_float *work, blasint *ldwork, flexiblas_fortran_charlen_t ident_len);
    ...
    void FC_GLOBAL(clasyf_aa,CLASYF_AA)(char *uplo, blasint *j1, blasint *m, blasint *nb, lapack_complex_float *a, blasint *lda, blasint *ipiv, lapack_complex_float *h, blasint *ldh, lapack_complex_float *work, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(clatzm,CLATZM)(char *side, blasint *m, blasint *n, lapack_complex_float *v, blasint *incv, lapack_complex_float *tau, lapack_complex_float *c1, lapack_complex_float *c2, blasint *ldc, lapack_complex_float *work, flexiblas_fortran_charlen_t side_len);

    void FC_GLOBAL(claunhr_col_getrfnp,CLAUNHR_COL_GETRFNP)(blasint *m, blasint *n, lapack_complex_float *a, blasint *lda, lapack_complex_float *d, blasint *info);

    void FC_GLOBAL(claunhr_col_getrfnp2,CLAUNHR_COL_GETRFNP2)(blasint *m, blasint *n, lapack_complex_float *a, blasint *lda, lapack_complex_float *d, blasint *info);
    ...
    void FC_GLOBAL(csysv_aa_2stage,CSYSV_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, lapack_complex_float *a, blasint *lda, lapack_complex_float *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_float *b, blasint *ldb, lapack_complex_float *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(csytrf_aa_2stage,CSYTRF_AA_2STAGE)(char *uplo, blasint *n, lapack_complex_float *a, blasint *lda, lapack_complex_float *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_float *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(csytrs_aa_2stage,CSYTRS_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, lapack_complex_float *a, blasint *lda, lapack_complex_float *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_float *b, blasint *ldb, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(cungtsqr_row,CUNGTSQR_ROW)(blasint *m, blasint *n, blasint *mb, blasint *nb, lapack_complex_float *a, blasint *lda, lapack_complex_float *t, blasint *ldt, lapack_complex_float *work, blasint *lwork, blasint *info);

    void FC_GLOBAL(cunhr_col,CUNHR_COL)(blasint *m, blasint *n, blasint *nb, lapack_complex_float *a, blasint *lda, lapack_complex_float *t, blasint *ldt, lapack_complex_float *d, blasint *info);
    ...
    void FC_GLOBAL(dgedmd,DGEDMD)(char *jobs, char *jobz, char *jobr, char *jobf, blasint *whtsvd, blasint *m, blasint *n, double *x, blasint *ldx, double *y, blasint *ldy, blasint *nrnk, double *tol, blasint *k, double *reig, double *imeig, double *z, blasint *ldz, double *res, double *b, blasint *ldb, double *w, blasint *ldw, double *s, blasint *lds, double *work, blasint *lwork, blasint *iwork, blasint *liwork, blasint *info, flexiblas_fortran_charlen_t jobs_len, flexiblas_fortran_charlen_t jobz_len, flexiblas_fortran_charlen_t jobr_len, flexiblas_fortran_charlen_t jobf_len);

    void FC_GLOBAL(dgedmdq,DGEDMDQ)(char *jobs, char *jobz, char *jobr, char *jobq, char *jobt, char *jobf, blasint *whtsvd, blasint *m, blasint *n, double *f, blasint *ldf, double *x, blasint *ldx, double *y, blasint *ldy, blasint *nrnk, double *tol, blasint *k, double *reig, double *imeig, double *z, blasint *ldz, double *res, double *b, blasint *ldb, double *v, blasint *ldv, double *s, blasint *lds, double *work, blasint *lwork, blasint *iwork, blasint *liwork, blasint *info, flexiblas_fortran_charlen_t jobs_len, flexiblas_fortran_charlen_t jobz_len, flexiblas_fortran_charlen_t jobr_len, flexiblas_fortran_charlen_t jobq_len, flexiblas_fortran_charlen_t jobt_len, flexiblas_fortran_charlen_t jobf_len);
    ...
    void FC_GLOBAL(dgegs,DGEGS)(char *jobvsl, char *jobvsr, blasint *n, double *a, blasint *lda, double *b, blasint *ldb, double *alphar, double *alphai, double *beta, double *vsl, blasint *ldvsl, double *vsr, blasint *ldvsr, double *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t jobvsl_len, flexiblas_fortran_charlen_t jobvsr_len);

    void FC_GLOBAL(dgegv,DGEGV)(char *jobvl, char *jobvr, blasint *n, double *a, blasint *lda, double *b, blasint *ldb, double *alphar, double *alphai, double *beta, double *vl, blasint *ldvl, double *vr, blasint *ldvr, double *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t jobvl_len, flexiblas_fortran_charlen_t jobvr_len);
    ...
    void FC_GLOBAL(dgelst,DGELST)(char *trans, blasint *m, blasint *n, blasint *nrhs, double *a, blasint *lda, double *b, blasint *ldb, double *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t trans_len);

    void FC_GLOBAL(dgelsx,DGELSX)(blasint *m, blasint *n, blasint *nrhs, double *a, blasint *lda, double *b, blasint *ldb, blasint *jpvt, double *rcond, blasint *rank, double *work, blasint *info);
    ...
    void FC_GLOBAL(dggsvd,DGGSVD)(char *jobu, char *jobv, char *jobq, blasint *m, blasint *n, blasint *p, blasint *k, blasint *l, double *a, blasint *lda, double *b, blasint *ldb, double *alpha, double *beta, double *u, blasint *ldu, double *v, blasint *ldv, double *q, blasint *ldq, double *work, blasint *iwork, blasint *info, flexiblas_fortran_charlen_t jobu_len, flexiblas_fortran_charlen_t jobv_len, flexiblas_fortran_charlen_t jobq_len);
    ...
    void FC_GLOBAL(dlaorhr_col_getrfnp,DLAORHR_COL_GETRFNP)(blasint *m, blasint *n, double *a, blasint *lda, double *d, blasint *info);

    void FC_GLOBAL(dlaorhr_col_getrfnp2,DLAORHR_COL_GETRFNP2)(blasint *m, blasint *n, double *a, blasint *lda, double *d, blasint *info);
    ...
    void FC_GLOBAL(dlarf1f,DLARF1F)(char *side, blasint *m, blasint *n, double *v, blasint *incv, double *tau, double *c, blasint *ldc, double *work, flexiblas_fortran_charlen_t side_len);

    void FC_GLOBAL(dlarf1l,DLARF1L)(char *side, blasint *m, blasint *n, double *v, blasint *incv, double *tau, double *c, blasint *ldc, double *work, flexiblas_fortran_charlen_t side_len);
    ...
    void FC_GLOBAL(dlarfb_gett,DLARFB_GETT)(char *ident, blasint *m, blasint *n, blasint *k, double *t, blasint *ldt, double *a, blasint *lda, double *b, blasint *ldb, double *work, blasint *ldwork, flexiblas_fortran_charlen_t ident_len);
    ...
    void FC_GLOBAL(dlartg,DLARTG)(double *f, double *g, double *c, double *s, double *r);
    ...
    void FC_GLOBAL(dlasyf_aa,DLASYF_AA)(char *uplo, blasint *j1, blasint *m, blasint *nb, double *a, blasint *lda, blasint *ipiv, double *h, blasint *ldh, double *work, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(dlatrs3,DLATRS3)(char *uplo, char *trans, char *diag, char *normin, blasint *n, blasint *nrhs, double *a, blasint *lda, double *x, blasint *ldx, double *scale, double *cnorm, double *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len, flexiblas_fortran_charlen_t trans_len, flexiblas_fortran_charlen_t diag_len, flexiblas_fortran_charlen_t normin_len);
    ...
    void FC_GLOBAL(dlatzm,DLATZM)(char *side, blasint *m, blasint *n, double *v, blasint *incv, double *tau, double *c1, double *c2, blasint *ldc, double *work, flexiblas_fortran_charlen_t side_len);
    ...
    void FC_GLOBAL(dorgtsqr_row,DORGTSQR_ROW)(blasint *m, blasint *n, blasint *mb, blasint *nb, double *a, blasint *lda, double *t, blasint *ldt, double *work, blasint *lwork, blasint *info);

    void FC_GLOBAL(dorhr_col,DORHR_COL)(blasint *m, blasint *n, blasint *nb, double *a, blasint *lda, double *t, blasint *ldt, double *d, blasint *info);
    ...
    double FC_GLOBAL(droundup_lwork,DROUNDUP_LWORK)(blasint *lwork);
    ...
    void FC_GLOBAL(dsysv_aa_2stage,DSYSV_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, double *a, blasint *lda, double *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, double *b, blasint *ldb, double *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(dsytrf_aa_2stage,DSYTRF_AA_2STAGE)(char *uplo, blasint *n, double *a, blasint *lda, double *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, double *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(dsytrs_aa_2stage,DSYTRS_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, double *a, blasint *lda, double *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, double *b, blasint *ldb, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    blasint FC_GLOBAL(ilaenv2stage,ILAENV2STAGE)(blasint *ispec, char *name, char *opts, blasint *n1, blasint *n2, blasint *n3, blasint *n4, flexiblas_fortran_charlen_t name_len, flexiblas_fortran_charlen_t opts_len);
    ...
    void FC_GLOBAL(sgegs,SGEGS)(char *jobvsl, char *jobvsr, blasint *n, float *a, blasint *lda, float *b, blasint *ldb, float *alphar, float *alphai, float *beta, float *vsl, blasint *ldvsl, float *vsr, blasint *ldvsr, float *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t jobvsl_len, flexiblas_fortran_charlen_t jobvsr_len);

    void FC_GLOBAL(sgegv,SGEGV)(char *jobvl, char *jobvr, blasint *n, float *a, blasint *lda, float *b, blasint *ldb, float *alphar, float *alphai, float *beta, float *vl, blasint *ldvl, float *vr, blasint *ldvr, float *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t jobvl_len, flexiblas_fortran_charlen_t jobvr_len);
    ...
    void FC_GLOBAL(sgelst,SGELST)(char *trans, blasint *m, blasint *n, blasint *nrhs, float *a, blasint *lda, float *b, blasint *ldb, float *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t trans_len);

    void FC_GLOBAL(sgelsx,SGELSX)(blasint *m, blasint *n, blasint *nrhs, float *a, blasint *lda, float *b, blasint *ldb, blasint *jpvt, float *rcond, blasint *rank, float *work, blasint *info);
    ...
    void FC_GLOBAL(slaorhr_col_getrfnp,SLAORHR_COL_GETRFNP)(blasint *m, blasint *n, float *a, blasint *lda, float *d, blasint *info);

    void FC_GLOBAL(slaorhr_col_getrfnp2,SLAORHR_COL_GETRFNP2)(blasint *m, blasint *n, float *a, blasint *lda, float *d, blasint *info);
    ...
    void FC_GLOBAL(slarf1f,SLARF1F)(char *side, blasint *m, blasint *n, float *v, blasint *incv, float *tau, float *c, blasint *ldc, float *work, flexiblas_fortran_charlen_t side_len);

    void FC_GLOBAL(slarf1l,SLARF1L)(char *side, blasint *m, blasint *n, float *v, blasint *incv, float *tau, float *c, blasint *ldc, float *work, flexiblas_fortran_charlen_t side_len);
    ...
    void FC_GLOBAL(slarfb_gett,SLARFB_GETT)(char *ident, blasint *m, blasint *n, blasint *k, float *t, blasint *ldt, float *a, blasint *lda, float *b, blasint *ldb, float *work, blasint *ldwork, flexiblas_fortran_charlen_t ident_len);
    ...
    void FC_GLOBAL(slasyf_aa,SLASYF_AA)(char *uplo, blasint *j1, blasint *m, blasint *nb, float *a, blasint *lda, blasint *ipiv, float *h, blasint *ldh, float *work, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(slatzm,SLATZM)(char *side, blasint *m, blasint *n, float *v, blasint *incv, float *tau, float *c1, float *c2, blasint *ldc, float *work, flexiblas_fortran_charlen_t side_len);
    ...
    void FC_GLOBAL(sorgtsqr_row,SORGTSQR_ROW)(blasint *m, blasint *n, blasint *mb, blasint *nb, float *a, blasint *lda, float *t, blasint *ldt, float *work, blasint *lwork, blasint *info);

    void FC_GLOBAL(sorhr_col,SORHR_COL)(blasint *m, blasint *n, blasint *nb, float *a, blasint *lda, float *t, blasint *ldt, float *d, blasint *info);
    ...
    float FC_GLOBAL(sroundup_lwork,SROUNDUP_LWORK)(blasint *lwork);
    ...
    void FC_GLOBAL(ssysv_aa_2stage,SSYSV_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, float *a, blasint *lda, float *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, float *b, blasint *ldb, float *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(ssytrf_aa_2stage,SSYTRF_AA_2STAGE)(char *uplo, blasint *n, float *a, blasint *lda, float *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, float *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(ssytrs_aa_2stage,SSYTRS_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, float *a, blasint *lda, float *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, float *b, blasint *ldb, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(zgedmd,ZGEDMD)(char *jobs, char *jobz, char *jobr, char *jobf, blasint *whtsvd, blasint *m, blasint *n, lapack_complex_double *x, blasint *ldx, lapack_complex_double *y, blasint *ldy, blasint *nrnk, double *tol, blasint *k, lapack_complex_double *eigs, lapack_complex_double *z, blasint *ldz, double *res, lapack_complex_double *b, blasint *ldb, lapack_complex_double *w, blasint *ldw, lapack_complex_double *s, blasint *lds, lapack_complex_double *zwork, blasint *lzwork, double *rwork, blasint *lrwork, blasint *iwork, blasint *liwork, blasint *info, flexiblas_fortran_charlen_t jobs_len, flexiblas_fortran_charlen_t jobz_len, flexiblas_fortran_charlen_t jobr_len, flexiblas_fortran_charlen_t jobf_len);

    void FC_GLOBAL(zgedmdq,ZGEDMDQ)(char *jobs, char *jobz, char *jobr, char *jobq, char *jobt, char *jobf, blasint *whtsvd, blasint *m, blasint *n, lapack_complex_double *f, blasint *ldf, lapack_complex_double *x, blasint *ldx, lapack_complex_double *y, blasint *ldy, blasint *nrnk, double *tol, blasint *k, lapack_complex_double *eigs, lapack_complex_double *z, blasint *ldz, double *res, lapack_complex_double *b, blasint *ldb, lapack_complex_double *v, blasint *ldv, lapack_complex_double *s, blasint *lds, lapack_complex_double *zwork, blasint *lzwork, double *work, blasint *lwork, blasint *iwork, blasint *liwork, blasint *info, flexiblas_fortran_charlen_t jobs_len, flexiblas_fortran_charlen_t jobz_len, flexiblas_fortran_charlen_t jobr_len, flexiblas_fortran_charlen_t jobq_len, flexiblas_fortran_charlen_t jobt_len, flexiblas_fortran_charlen_t jobf_len);
    ...
    void FC_GLOBAL(zgelst,ZGELST)(char *trans, blasint *m, blasint *n, blasint *nrhs, lapack_complex_double *a, blasint *lda, lapack_complex_double *b, blasint *ldb, lapack_complex_double *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t trans_len);

    void FC_GLOBAL(zgelsx,ZGELSX)(blasint *m, blasint *n, blasint *nrhs, lapack_complex_double *a, blasint *lda, lapack_complex_double *b, blasint *ldb, blasint *jpvt, double *rcond, blasint *rank, lapack_complex_double *work, double *rwork, blasint *info);
    ...
    void FC_GLOBAL(zhesv_aa_2stage,ZHESV_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, lapack_complex_double *a, blasint *lda, lapack_complex_double *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_double *b, blasint *ldb, lapack_complex_double *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(zhetrf_aa_2stage,ZHETRF_AA_2STAGE)(char *uplo, blasint *n, lapack_complex_double *a, blasint *lda, lapack_complex_double *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_double *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(zhetrs_aa_2stage,ZHETRS_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, lapack_complex_double *a, blasint *lda, lapack_complex_double *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_double *b, blasint *ldb, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(zladiv,ZLADIV)(lapack_complex_double *ret, lapack_complex_double *x, lapack_complex_double *y);
    ...
    void FC_GLOBAL(zlahef_aa,ZLAHEF_AA)(char *uplo, blasint *j1, blasint *m, blasint *nb, lapack_complex_double *a, blasint *lda, blasint *ipiv, lapack_complex_double *h, blasint *ldh, lapack_complex_double *work, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(zlarf1f,ZLARF1F)(char *side, blasint *m, blasint *n, lapack_complex_double *v, blasint *incv, lapack_complex_double *tau, lapack_complex_double *c, blasint *ldc, lapack_complex_double *work, flexiblas_fortran_charlen_t side_len);

    void FC_GLOBAL(zlarf1l,ZLARF1L)(char *side, blasint *m, blasint *n, lapack_complex_double *v, blasint *incv, lapack_complex_double *tau, lapack_complex_double *c, blasint *ldc, lapack_complex_double *work, flexiblas_fortran_charlen_t side_len);
    ...
    void FC_GLOBAL(zlarfb_gett,ZLARFB_GETT)(char *ident, blasint *m, blasint *n, blasint *k, lapack_complex_double *t, blasint *ldt, lapack_complex_double *a, blasint *lda, lapack_complex_double *b, blasint *ldb, lapack_complex_double *work, blasint *ldwork, flexiblas_fortran_charlen_t ident_len);
    ...
    void FC_GLOBAL(zlartg,ZLARTG)(lapack_complex_double *f, lapack_complex_double *g, double *c, lapack_complex_double *s, lapack_complex_double *r);
    ...
    void FC_GLOBAL(zlasyf_aa,ZLASYF_AA)(char *uplo, blasint *j1, blasint *m, blasint *nb, lapack_complex_double *a, blasint *lda, blasint *ipiv, lapack_complex_double *h, blasint *ldh, lapack_complex_double *work, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(zlatzm,ZLATZM)(char *side, blasint *m, blasint *n, lapack_complex_double *v, blasint *incv, lapack_complex_double *tau, lapack_complex_double *c1, lapack_complex_double *c2, blasint *ldc, lapack_complex_double *work, flexiblas_fortran_charlen_t side_len);

    void FC_GLOBAL(zlaunhr_col_getrfnp,ZLAUNHR_COL_GETRFNP)(blasint *m, blasint *n, lapack_complex_double *a, blasint *lda, lapack_complex_double *d, blasint *info);

    void FC_GLOBAL(zlaunhr_col_getrfnp2,ZLAUNHR_COL_GETRFNP2)(blasint *m, blasint *n, lapack_complex_double *a, blasint *lda, lapack_complex_double *d, blasint *info);
    ...
    void FC_GLOBAL(zsysv_aa_2stage,ZSYSV_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, lapack_complex_double *a, blasint *lda, lapack_complex_double *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_double *b, blasint *ldb, lapack_complex_double *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(zsytrf_aa_2stage,ZSYTRF_AA_2STAGE)(char *uplo, blasint *n, lapack_complex_double *a, blasint *lda, lapack_complex_double *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_double *work, blasint *lwork, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(zsytrs_aa_2stage,ZSYTRS_AA_2STAGE)(char *uplo, blasint *n, blasint *nrhs, lapack_complex_double *a, blasint *lda, lapack_complex_double *tb, blasint *ltb, blasint *ipiv, blasint *ipiv2, lapack_complex_double *b, blasint *ldb, blasint *info, flexiblas_fortran_charlen_t uplo_len);
    ...
    void FC_GLOBAL(zungtsqr_row,ZUNGTSQR_ROW)(blasint *m, blasint *n, blasint *mb, blasint *nb, lapack_complex_double *a, blasint *lda, lapack_complex_double *t, blasint *ldt, lapack_complex_double *work, blasint *lwork, blasint *info);

    void FC_GLOBAL(zunhr_col,ZUNHR_COL)(blasint *m, blasint *n, blasint *nb, lapack_complex_double *a, blasint *lda, lapack_complex_double *t, blasint *ldt, lapack_complex_double *d, blasint *info);
