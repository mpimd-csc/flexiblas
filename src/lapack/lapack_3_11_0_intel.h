...
#include "flexiblas_fortran_mangle.h"
    ...
    void FC_GLOBAL(dlassq,DLASSQ)(blasint *n, double *x, blasint *incx, double *scl, double *sumsq);
    ...
    void FC_GLOBAL(zlassq,ZLASSQ)(blasint *n, lapack_complex_double *x, blasint *incx, double *scl, double *sumsq);
